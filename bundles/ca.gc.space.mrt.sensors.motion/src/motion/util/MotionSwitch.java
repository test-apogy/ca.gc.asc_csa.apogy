...
public class MotionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MotionPackage.ANGULAR_VELOCITY_SENSOR: {
			...
			case MotionPackage.LINEAR_ACCELERATION_SENSOR: {
			...
			case MotionPackage.LINEAR_VELOCITY_SENSOR: {
			...
			case MotionPackage.SELF_MOTION_SENSOR: {
