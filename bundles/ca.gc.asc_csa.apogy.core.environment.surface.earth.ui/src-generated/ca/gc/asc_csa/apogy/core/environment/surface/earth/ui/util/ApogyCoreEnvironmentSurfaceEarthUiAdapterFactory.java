...
public class ApogyCoreEnvironmentSurfaceEarthUiAdapterFactory extends AdapterFactoryImpl {
	...
	protected ApogyCoreEnvironmentSurfaceEarthUiSwitch<Adapter> modelSwitch =
		new ApogyCoreEnvironmentSurfaceEarthUiSwitch<Adapter>() {
			@Override
			public Adapter caseApogyCoreEnvironmentSurfaceEarthUiFacade(ApogyCoreEnvironmentSurfaceEarthUiFacade object) {
				return createApogyCoreEnvironmentSurfaceEarthUiFacadeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.apogy.core.environment.surface.earth.ui.ApogyCoreEnvironmentSurfaceEarthUiFacade <em>Facade</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createApogyCoreEnvironmentSurfaceEarthUiFacadeAdapter() {
		return null;
	}
