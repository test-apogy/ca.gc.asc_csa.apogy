...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.earth.surface.EarthSky} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EarthSkyItemProvider extends SkyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EarthSky_sunHorizontalCoordinates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EarthSky_sunHorizontalCoordinates_feature", "_UI_EarthSky_type"),
				 ApogyEarthSurfaceEnvironmentPackage.Literals.EARTH_SKY__SUN_HORIZONTAL_COORDINATES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyEarthSurfaceEnvironmentPackage.Literals.EARTH_SKY__MOON,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyEarthSurfaceEnvironmentPackage.Literals.EARTH_SKY__MOON_HORIZONTAL_COORDINATES,
				 true,
				 false,
				 true,
				 null,
