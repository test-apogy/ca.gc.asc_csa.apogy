...
import ca.gc.asc_csa.apogy.core.environment.surface.provider.SurfaceWorksiteNodeItemProvider;
...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.earth.surface.EarthSurfaceWorksiteNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EarthSurfaceWorksiteNodeItemProvider extends SurfaceWorksiteNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyEarthSurfaceEnvironmentPackage.Literals.EARTH_SURFACE_WORKSITE_NODE__SKY_TRANSFORM_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EarthSurfaceWorksiteNode)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_EarthSurfaceWorksiteNode_type") :
			getString("_UI_EarthSurfaceWorksiteNode_type") + " " + label;
	}
