...
import ca.gc.asc_csa.symphony.core.ui.actions.ClearTrajectoryDataAction;
import ca.gc.asc_csa.symphony.core.ui.actions.PinTrajectoryViewAction;
import ca.gc.asc_csa.symphony.core.ui.composites.TrajectoryComposite;

public class MovableTrajectoryView extends ViewPart implements ISelectionListener
{
	public static final String ID = "ca.gc.asc_csa.symphony.core.ui.views.MovableTrajectoryView"; //$NON-NLS-1$
