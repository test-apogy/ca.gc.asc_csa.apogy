 ...
 */
package ca.gc.asc_csa.symphony.core.ui.util;
...
public class SymphonyCoreUiAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.SymphonyCoreUiFacade <em>Facade</em>}'.
	 * <!-- begin-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.SymphonyResourceSettings <em>Symphony Resource Settings</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createSymphonyResourceSettingsAdapter() {
		...
		/**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.NewSymphonyProjectSettings <em>New Symphony Project Settings</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createNewSymphonyProjectSettingsAdapter() {
		...
		/**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.NewSymphonySessionSettings <em>New Symphony Session Settings</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.NewSymphonySystemSettings <em>New Symphony System Settings</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createNewSymphonySystemSettingsAdapter() {
		...
		/**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.core.ui.ResultNodePresentation <em>Result Node Presentation</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
