...
public class TimedStampedPVACoordinatesImpl extends PVACoordinatesImpl implements TimedStampedPVACoordinates {
	...
	protected EClass eStaticClass() {
		return Symphony__CoreEnvironmentOrbitPackage.Literals.TIMED_STAMPED_PVA_COORDINATES;
	}
	...
	public void setTime(Date newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreEnvironmentOrbitPackage.TIMED_STAMPED_PVA_COORDINATES__TIME, oldTime, time));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (derivedFeatureID) {
				case Symphony__CoreEnvironmentOrbitPackage.TIMED_STAMPED_PVA_COORDINATES__TIME: return Symphony__CommonEMFPackage.TIMED__TIME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (baseFeatureID) {
				case Symphony__CommonEMFPackage.TIMED__TIME: return Symphony__CoreEnvironmentOrbitPackage.TIMED_STAMPED_PVA_COORDINATES__TIME;
				default: return -1;
			}
		}
