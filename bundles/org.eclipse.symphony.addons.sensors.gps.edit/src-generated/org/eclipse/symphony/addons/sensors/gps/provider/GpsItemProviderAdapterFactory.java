...
import org.eclipse.symphony.addons.sensors.gps.util.GpsAdapterFactory;
 ...
 * @generated
 */
public class GpsItemProviderAdapterFactory extends GpsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(GpsEditPlugin.INSTANCE, GpsPackage.eNS_URI);
		...
		protected static class CreationSwitch extends TopologySwitch<Object> {
			...
			public <T> Object caseContentNode(ContentNode<T> object) {
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 GpsFactory.eINSTANCE.createGPS()));
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 GpsFactory.eINSTANCE.createGPSFacade()));
