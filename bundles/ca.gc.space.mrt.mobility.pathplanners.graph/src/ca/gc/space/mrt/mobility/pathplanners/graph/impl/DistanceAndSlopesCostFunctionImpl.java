 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndSlopesCostFunctionImpl#getUpSlopeCostFactor <em>Up Slope Cost Factor</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndSlopesCostFunctionImpl#getDownSlopeCostFactor <em>Down Slope Cost Factor</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndSlopesCostFunctionImpl#getGravityAxis <em>Gravity Axis</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndSlopesCostFunctionImpl#getMaximumUpSlope <em>Maximum Up Slope</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndSlopesCostFunctionImpl#getMaximumDownSlope <em>Maximum Down Slope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
