 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndRoverFootprintCostFunctionImpl#getRoverFootPrintRadius <em>Rover Foot Print Radius</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndRoverFootprintCostFunctionImpl#getMaximumRoughness <em>Maximum Roughness</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.pathplanners.graph.impl.DistanceAndRoverFootprintCostFunctionImpl#getMaximumCrossSlope <em>Maximum Cross Slope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DistanceAndRoverFootprintCostFunctionImpl extends DistanceAndSlopesCostFunctionImpl implements DistanceAndRoverFootprintCostFunction
{
	...
	{
		return PathplannersGraphPackage.Literals.DISTANCE_AND_ROVER_FOOTPRINT_COST_FUNCTION;
	}
	...
	public void setRoverFootPrintRadius(double newRoverFootPrintRadius)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathplannersGraphPackage.DISTANCE_AND_ROVER_FOOTPRINT_COST_FUNCTION__ROVER_FOOT_PRINT_RADIUS, oldRoverFootPrintRadius, roverFootPrintRadius));
	}
	...
	public void setMaximumRoughness(double newMaximumRoughness)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathplannersGraphPackage.DISTANCE_AND_ROVER_FOOTPRINT_COST_FUNCTION__MAXIMUM_ROUGHNESS, oldMaximumRoughness, maximumRoughness));
	}
	...
	public void setMaximumCrossSlope(double newMaximumCrossSlope)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PathplannersGraphPackage.DISTANCE_AND_ROVER_FOOTPRINT_COST_FUNCTION__MAXIMUM_CROSS_SLOPE, oldMaximumCrossSlope, maximumCrossSlope));
	}
