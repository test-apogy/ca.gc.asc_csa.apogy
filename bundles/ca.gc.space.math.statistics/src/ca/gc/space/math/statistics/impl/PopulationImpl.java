 ...
 * <ul>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getData <em>Data</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getAverage <em>Average</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getSum <em>Sum</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getMedian <em>Median</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getSumSquared <em>Sum Squared</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getVariance <em>Variance</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getMin <em>Min</em>}</li>
 *   <li>{@link ca.gc.space.math.statistics.impl.PopulationImpl#getMax <em>Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
