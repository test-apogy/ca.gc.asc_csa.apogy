 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.VoxelBased3DPointCloudResamplerImpl#getResolutionX <em>Resolution X</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.VoxelBased3DPointCloudResamplerImpl#getResolutionY <em>Resolution Y</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.VoxelBased3DPointCloudResamplerImpl#getResolutionZ <em>Resolution Z</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.VoxelBased3DPointCloudResamplerImpl#getMinimumNumberOfPointPerVoxel <em>Minimum Number Of Point Per Voxel</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.VoxelBased3DPointCloudResamplerImpl#getTileResolution <em>Tile Resolution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VoxelBased3DPointCloudResamplerImpl extends ProcessorImpl<CartesianCoordinatesSet, CartesianCoordinatesSet> implements VoxelBased3DPointCloudResampler {
	...
	protected EClass eStaticClass() {
		return Data3dPackage.Literals.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER;
	}
	...
	public void setResolutionX(double newResolutionX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER__RESOLUTION_X, oldResolutionX, resolutionX));
	}
	...
	public void setResolutionY(double newResolutionY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER__RESOLUTION_Y, oldResolutionY, resolutionY));
	}
	...
	public void setResolutionZ(double newResolutionZ) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER__RESOLUTION_Z, oldResolutionZ, resolutionZ));
	}
	...
	public void setMinimumNumberOfPointPerVoxel(int newMinimumNumberOfPointPerVoxel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER__MINIMUM_NUMBER_OF_POINT_PER_VOXEL, oldMinimumNumberOfPointPerVoxel, minimumNumberOfPointPerVoxel));
	}
	...
	public void setTileResolution(double newTileResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.VOXEL_BASED3_DPOINT_CLOUD_RESAMPLER__TILE_RESOLUTION, oldTileResolution, tileResolution));
	}
	...
	private CartesianCoordinatesSet resample(double resolutionx,
		...
		CartesianCoordinatesSet outputPointCloud = Data3dFactory.eINSTANCE
