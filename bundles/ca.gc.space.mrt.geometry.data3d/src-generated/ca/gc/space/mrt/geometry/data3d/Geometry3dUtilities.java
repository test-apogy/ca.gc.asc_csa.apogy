...
public class Geometry3dUtilities
{
	...
	public static SphericalCoordinates getSphericalCoordinates(CartesianPositionCoordinates cartesianCoordinates)
	{
		...
		return data3dFacade.createSphericalCoordinates(phi, theta, r);
	}
	...
	public static CartesianPositionCoordinates getCartesianPositionCoordinates(SphericalCoordinates sphericalCoordinates)
	{
		...
		return data3dFacade.createCartesianPositionCoordinates(x, y, z);
	}
	...
	public static CartesianPositionCoordinates getFlattenCoordinate(final CartesianPlane plane, final CartesianPositionCoordinates point)
	{
		...
		return data3dFacade.createCartesianPositionCoordinates(flattenPoint.x, flattenPoint.y, flattenPoint.z);		
	}
	...
	public static CartesianPositionCoordinates getProjectionInPolygonPlane(CartesianPositionCoordinates point, CartesianPolygon polygon)
	{
		if (polygon.getVertices().size() == 3)
		{
			...
			CartesianPositionCoordinates projection = data3dFacade.createCartesianPositionCoordinates(Qprime.x, Qprime.y, Qprime.z);
	...
	public static CartesianPositionCoordinates getProjectionAlongAxisOnToPolygon(CartesianAxis axis, Point3d point, CartesianPolygon polygon)
	{
		if (polygon.getVertices().size() == 3)
		{
			...
			{			
				return data3dFacade.createCartesianPositionCoordinates(lineOrigin.x, lineOrigin.y, lineOrigin.z);
			}
			else
			{
				return null;
	...
	public static CartesianPositionCoordinates getProjectionOfPointOntoLine(final CartesianPositionCoordinates point, final CartesianPositionCoordinates p1, final CartesianPositionCoordinates p2 )
	{
		...
		return data3dFacade.createCartesianPositionCoordinates(q.x, q.y, q.z);
	}
	...
	public static Point3d getLineAndPolygonIntersectionPoint(final Vector3d u, final Vector3d v, final CartesianPolygon polygon)
	{
		...
		{			
			...
			CartesianPositionCoordinates p = Data3dFacade.INSTANCE.createCartesianPositionCoordinates(intersection.x, intersection.y, intersection.z);
	...
	public static CartesianPositionCoordinates getProjection(CartesianPositionCoordinates point, CartesianPositionCoordinates u1, CartesianPositionCoordinates u2)
	{
		...
		return data3dFacade.createCartesianPositionCoordinates(projOnu1u2.x, projOnu1u2.y, projOnu1u2.z);
	}
	...
	public static CartesianPositionCoordinates getMaximumPosition(CartesianAxis axis, List<CartesianPositionCoordinates> points, final IProgressMonitor monitor)
	{
		...
		CartesianPositionCoordinates coord = data3dFacade.createCartesianPositionCoordinates(0, 0, 0);
	...
	public static List<CartesianPositionCoordinates> getCartesianCoordinatesWithinRadius(CartesianPositionCoordinates centerPoint, double radius, List<CartesianPositionCoordinates> points)
	{
		...
		if (points.size() > 0)
		{
			...
			// inserted.
			CartesianPositionCoordinates pointOnSurface = data3dFacade.createCartesianPositionCoordinates(centerPoint.getX() + radius, centerPoint.getY(), centerPoint.getZ());
	...
	{
		CartesianCoordinatesMesh newMesh = data3dFacade.createCartesianCoordinatesMesh(mesh);
		...
		while (itDuplicateLists.hasNext())
		{
			...
			CartesianPositionCoordinates goodIncarnation = data3dFacade.createCartesianPositionCoordinates(duplicates.get(0));
	...
	public static List<CartesianPositionCoordinates> getCartesianPositionCoordinates(List<Point3d> points)
	{
		...
		{
			Point3d p = it.next();
			CartesianPositionCoordinates point = data3dFacade.createCartesianPositionCoordinates(p.x, p.y, p.z);
			pointList.add(point);
		}
    ...
    public static CartesianPolygon createNormalizedPolygonOfPlane(CartesianPlane plane)
    {
		...
		CartesianPositionCoordinates vO = data3d.createCartesianPositionCoordinates(0, 0, 0);
		CartesianPositionCoordinates vX = data3d.createCartesianPositionCoordinates(1, 0, 0);
		CartesianPositionCoordinates vY = data3d.createCartesianPositionCoordinates(0, 1, 0);
		CartesianPositionCoordinates vZ = data3d.createCartesianPositionCoordinates(0, 0, 1);
		
		CartesianPolygon polygon = null;
		
		switch (axis) 
		{
			case X: polygon=data3d.createCartesianPolygon(vO, vY, vZ); break;	
			case Y: polygon=data3d.createCartesianPolygon(vO, vZ, vX); break;	
			case Z: polygon=data3d.createCartesianPolygon(vO, vX, vY); break;
			default: break;
		}
