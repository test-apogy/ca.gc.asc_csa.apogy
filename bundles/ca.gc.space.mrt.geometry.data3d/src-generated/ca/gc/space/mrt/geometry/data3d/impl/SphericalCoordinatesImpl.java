 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.SphericalCoordinatesImpl#getPhi <em>Phi</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.SphericalCoordinatesImpl#getTheta <em>Theta</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.impl.SphericalCoordinatesImpl#getR <em>R</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SphericalCoordinatesImpl extends CoordinatesImpl implements SphericalCoordinates {
	...
	protected EClass eStaticClass() {
		return Data3dPackage.Literals.SPHERICAL_COORDINATES;
	}
	...
	public void setPhi(double newPhi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.SPHERICAL_COORDINATES__PHI, oldPhi, phi));
	}
	...
	public void setTheta(double newTheta) {
		...
		theta = newTheta;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.SPHERICAL_COORDINATES__THETA, oldTheta, theta));
	}
	...
	public void setR(double newR) {
		...
		r = newR;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3dPackage.SPHERICAL_COORDINATES__R, oldR, r));
	}
