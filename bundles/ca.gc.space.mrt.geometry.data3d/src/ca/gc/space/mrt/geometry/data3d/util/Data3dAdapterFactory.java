 ...
 *
 * $Id: Data3dAdapterFactory.java,v 1.6.4.4 2015/09/22 19:39:41 rlarcheveque Exp $
 */
...
public class Data3dAdapterFactory extends AdapterFactoryImpl {
	...
	protected Data3dSwitch<Adapter> modelSwitch =
		new Data3dSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSpericalCoordinatesMesh(SpericalCoordinatesMesh object) {
				return createSpericalCoordinatesMeshAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseMeshLocaliser(MeshLocaliser object) {
				return createMeshLocaliserAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTriangularMesh2NormalPointCloud(TriangularMesh2NormalPointCloud object) {
				return createTriangularMesh2NormalPointCloudAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTriangleEdgeLenghtTriangularMeshFilter(TriangleEdgeLenghtTriangularMeshFilter object) {
				return createTriangleEdgeLenghtTriangularMeshFilterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.geometry.data3d.SpericalCoordinatesMesh <em>Sperical Coordinates Mesh</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.geometry.data3d.MeshLocaliser <em>Mesh Localiser</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.geometry.data3d.TriangularMesh2NormalPointCloud <em>Triangular Mesh2 Normal Point Cloud</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.geometry.data3d.TriangleEdgeLenghtTriangularMeshFilter <em>Triangle Edge Lenght Triangular Mesh Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
