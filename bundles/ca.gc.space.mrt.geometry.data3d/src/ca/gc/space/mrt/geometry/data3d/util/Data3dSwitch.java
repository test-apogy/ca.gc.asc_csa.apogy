 ...
 *
 * $Id: Data3dSwitch.java,v 1.7.4.4 2015/09/22 19:39:41 rlarcheveque Exp $
 */
...
public class Data3dSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Data3dPackage.SPERICAL_COORDINATES_MESH: {
				SpericalCoordinatesMesh spericalCoordinatesMesh = (SpericalCoordinatesMesh)theEObject;
				T1 result = caseSpericalCoordinatesMesh(spericalCoordinatesMesh);
				if (result == null) result = caseMesh(spericalCoordinatesMesh);
				if (result == null) result = caseSphericalCoordinatesSet(spericalCoordinatesMesh);
				if (result == null) result = caseCoordinatesSet(spericalCoordinatesMesh);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Data3dPackage.MESH_LOCALISER: {
				MeshLocaliser meshLocaliser = (MeshLocaliser)theEObject;
				T1 result = caseMeshLocaliser(meshLocaliser);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Data3dPackage.TRIANGULAR_MESH2_NORMAL_POINT_CLOUD: {
				TriangularMesh2NormalPointCloud triangularMesh2NormalPointCloud = (TriangularMesh2NormalPointCloud)theEObject;
				T1 result = caseTriangularMesh2NormalPointCloud(triangularMesh2NormalPointCloud);
				if (result == null) result = caseProcessor(triangularMesh2NormalPointCloud);
				if (result == null) result = caseMonitorable(triangularMesh2NormalPointCloud);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Data3dPackage.TRIANGLE_EDGE_LENGHT_TRIANGULAR_MESH_FILTER: {
				TriangleEdgeLenghtTriangularMeshFilter triangleEdgeLenghtTriangularMeshFilter = (TriangleEdgeLenghtTriangularMeshFilter)theEObject;
				T1 result = caseTriangleEdgeLenghtTriangularMeshFilter(triangleEdgeLenghtTriangularMeshFilter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sperical Coordinates Mesh</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sperical Coordinates Mesh</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseSpericalCoordinatesMesh(SpericalCoordinatesMesh object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mesh Localiser</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mesh Localiser</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseMeshLocaliser(MeshLocaliser object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Triangular Mesh2 Normal Point Cloud</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Triangular Mesh2 Normal Point Cloud</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseTriangularMesh2NormalPointCloud(TriangularMesh2NormalPointCloud object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Triangle Edge Lenght Triangular Mesh Filter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Triangle Edge Lenght Triangular Mesh Filter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseTriangleEdgeLenghtTriangularMeshFilter(TriangleEdgeLenghtTriangularMeshFilter object) {
		return null;
	}
