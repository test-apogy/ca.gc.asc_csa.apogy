...
{
	public ca.gc.space.math.Tuple3d tuple3d;
	...
	public ca.gc.space.math.Tuple3d getTuple3d() {
		return tuple3d;
	}

	public void setTuple3d(ca.gc.space.math.Tuple3d newTuple3d) {
		setTuple3d(newTuple3d, true);
	}

	public void setTuple3d(ca.gc.space.math.Tuple3d newTuple3d, boolean update) {
		tuple3d = newTuple3d;
		if (update) 
		{
			if (m_bindingContext != null) 
