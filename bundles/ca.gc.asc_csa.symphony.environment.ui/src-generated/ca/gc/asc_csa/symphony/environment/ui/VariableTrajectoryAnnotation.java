 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.VariableTrajectoryAnnotation#getTrajectoryProvider <em>Trajectory Provider</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getVariableTrajectoryAnnotation()
 * @model
 * @generated
 */
public interface VariableTrajectoryAnnotation extends AbstractVariableAnnotation, TrajectoryProvider
{
  /**
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.environment.ui.VariableTrajectoryProvider#getVariableAnnotation <em>Variable Annotation</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getVariableTrajectoryAnnotation_TrajectoryProvider()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.VariableTrajectoryAnnotation#getTrajectoryProvider <em>Trajectory Provider</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
