...
import ca.gc.asc_csa.symphony.environment.ui.EarthSurfaceWorksiteSceneObject;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#isAxisVisible <em>Axis Visible</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#getAxisLength <em>Axis Length</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#isAzimuthVisible <em>Azimuth Visible</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#isElevationLinesVisible <em>Elevation Lines Visible</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#isAzimuthLinesVisible <em>Azimuth Lines Visible</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#isPlaneVisible <em>Plane Visible</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#getPlaneGridSize <em>Plane Grid Size</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.EarthSurfaceWorksitePresentationImpl#getPlaneSize <em>Plane Size</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
