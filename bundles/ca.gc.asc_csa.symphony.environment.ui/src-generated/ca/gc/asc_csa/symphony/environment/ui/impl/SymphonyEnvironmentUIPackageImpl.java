 ...
 * @generated
 */
public class SymphonyEnvironmentUIPackageImpl extends EPackageImpl implements SymphonyEnvironmentUIPackage
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  private SymphonyEnvironmentUIPackageImpl()
  {
		super(eNS_URI, SymphonyEnvironmentUIFactory.eINSTANCE);
	}
  ...
  /**
	 ...
	 * 
	 * <p>This method is used to initialize {@link SymphonyEnvironmentUIPackage#eINSTANCE} when that field is accessed.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static SymphonyEnvironmentUIPackage init()
  {
		if (isInited) return (SymphonyEnvironmentUIPackage)EPackage.Registry.INSTANCE.getEPackage(SymphonyEnvironmentUIPackage.eNS_URI);

		// Obtain or create and register package
		SymphonyEnvironmentUIPackageImpl theSymphonyEnvironmentUIPackage = (SymphonyEnvironmentUIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SymphonyEnvironmentUIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SymphonyEnvironmentUIPackageImpl());
		...
		theSymphonyEnvironmentUIPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSymphonyEnvironmentUIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SymphonyEnvironmentUIPackage.eNS_URI, theSymphonyEnvironmentUIPackage);
		return theSymphonyEnvironmentUIPackage;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public SymphonyEnvironmentUIFactory getSymphonyEnvironmentUIFactory()
  {
		return (SymphonyEnvironmentUIFactory)getEFactoryInstance();
	}
  ...
  public void initializePackageContents()
  {
		...
		starFieldPresentationEClass.getESuperTypes().add(theTopologyUIPackage.getNodePresentation());
		sunPresentationEClass.getESuperTypes().add(theTopologyUIPackage.getNodePresentation());
		earthSurfaceWorksitePresentationEClass.getESuperTypes().add(theTopologyUIPackage.getNodePresentation());
		earthSkyPresentationEClass.getESuperTypes().add(theTopologyUIPackage.getNodePresentation());
		...
		featuresOfInterestMapLayerPresentationEClass.getESuperTypes().add(theSymphonyEnvironmentPackage.getRectangularRegionProvider());
		...
		addEParameter(op, theSymphonyEnvironmentPackage.getStar(), "star", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		EGenericType g2 = createEGenericType(theSymphonyEnvironmentPackage.getRectangularRegionProvider());
		...
		g2 = createEGenericType(theSymphonyCorePackage.getFeatureOfInterestList());
		g1.getETypeArguments().add(g2);
		initEOperation(op, g1);
		...
		initEReference(getMapViewConfiguration_MapLayers(), theSymphonyEnvironmentPackage.getImageMapLayerPresentation(), null, "mapLayers", null, 0, -1, MapViewConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFeaturesOfInterestMapLayerPresentation_FeaturesOfInterestMapLayer(), theSymphonyEnvironmentPackage.getFeaturesOfInterestMapLayer(), null, "featuresOfInterestMapLayer", null, 0, 1, FeaturesOfInterestMapLayerPresentation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getVariableTrajectoryProvider_PoseProvider(), theSymphonyCorePackage.getPoseProvider(), null, "poseProvider", null, 1, 1, VariableTrajectoryProvider.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAbstractVariableAnnotation_Variable(), theEMFEcoreInvocatorPackage.getVariable(), null, "variable", null, 1, 1, AbstractVariableAnnotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
  ...
  protected void createGenModelAnnotations()
  {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "SymphonyEnvironmentUI",
			 "childCreationExtenders", "true",
			 "extensibleProviderFactory", "true",
			 "multipleEditorPages", "false",
			 "copyrightText", "Agence spatiale canadienne / Canadian Space Agency 2013 Copyrights (c)",
			 "modelName", "SymphonyEnvironmentUI",
			 "complianceLevel", "6.0",
			 "suppressGenModelAnnotations", "false",
			 "modelDirectory", "/ca.gc.asc_csa.symphony.environment.ui/src-generated",
			 "editDirectory", "/ca.gc.asc_csa.symphony.environment.ui.edit/src-generated",
			 "basePackage", "ca.gc.asc_csa.symphony.environment"
		   });	
		addAnnotation
		...
		addAnnotation
		  ((getEnvironmentUiUtilities__GetSunLightColor__double()).getEParameters().get(0), 
		   source, 
		   new String[] {
			 "documentation", "The altitude above the horizon, in radians."
		   });	
		addAnnotation
		  (getEnvironmentUiUtilities__GetSkyTransparency__double(), 
		   source, 
		   new String[] {
			 "documentation", "Return the transparency value (between no transparency 0 and full transparency 1.0) to be used for the blus sky as a function of the sun altitude angle."
		   });	
		addAnnotation
		...
		addAnnotation
		  (getMapViewConfiguration_Extent(), 
		   source, 
		   new String[] {
			 "documentation", " The rectangular region covered by the map (typically larger than mapImageRectangularRegion and contains mapImageRectangularRegion).",
			 "children", "false",
			 "notify", "true",
			 "property", "Readonly"
		   });	
...
} //SymphonyEnvironmentUIPackageImpl
