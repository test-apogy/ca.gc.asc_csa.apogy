 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getLatestPosition <em>Latest Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getAzimuthAngle <em>Azimuth Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getTrajectoryLength <em>Trajectory Length</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getTrajectoryColor <em>Trajectory Color</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getTrajectoryProvider()
 * @model abstract="true"
 * @generated
 */
public interface TrajectoryProvider extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getTrajectoryProvider_LatestPosition()
	 * @model unique="false" dataType="ca.gc.asc_csa.symphony.environment.ui.XYDataItem" transient="true"
	 * @generated
	 */
  XYDataItem getLatestPosition();

  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getLatestPosition <em>Latest Position</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getTrajectoryProvider_AzimuthAngle()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getAzimuthAngle <em>Azimuth Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getTrajectoryProvider_TrajectoryLength()
	 * @model default="0.0" unique="false" transient="true"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getTrajectoryLength <em>Trajectory Length</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getTrajectoryProvider_TrajectoryColor()
	 * @model default="0.0,1.0,0.0" unique="false" dataType="ca.gc.asc_csa.symphony.environment.ui.Color3f"
	 * @generated
	 */
  Color3f getTrajectoryColor();

  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.TrajectoryProvider#getTrajectoryColor <em>Trajectory Color</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.ui.List<ca.gc.asc_csa.symphony.environment.ui.Point2d>" unique="false" many="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model kind="operation" dataType="ca.gc.asc_csa.symphony.environment.ui.XYSeries" unique="false"
