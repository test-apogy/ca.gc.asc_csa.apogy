 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getMapLayers <em>Map Layers</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getMapAnnotations <em>Map Annotations</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getDefaultRectangularRegion <em>Default Rectangular Region</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getMapImage <em>Map Image</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getMapImageRectangularRegion <em>Map Image Rectangular Region</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.impl.MapViewConfigurationImpl#getExtent <em>Extent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
