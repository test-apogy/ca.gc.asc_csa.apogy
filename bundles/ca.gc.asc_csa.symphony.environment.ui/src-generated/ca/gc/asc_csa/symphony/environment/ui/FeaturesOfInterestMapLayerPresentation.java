 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeaturesOfInterestMapLayer <em>Features Of Interest Map Layer</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeatureOfInterestRadius <em>Feature Of Interest Radius</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeatureOfInterestColor <em>Feature Of Interest Color</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getFeaturesOfInterestMapLayerPresentation()
 * @model
 * @generated
 */
public interface FeaturesOfInterestMapLayerPresentation extends MapAnnotation, RectangularRegionProvider {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getFeaturesOfInterestMapLayerPresentation_FeaturesOfInterestMapLayer()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeaturesOfInterestMapLayer <em>Features Of Interest Map Layer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getFeaturesOfInterestMapLayerPresentation_FeatureOfInterestRadius()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeatureOfInterestRadius <em>Feature Of Interest Radius</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.ui.SymphonyEnvironmentUIPackage#getFeaturesOfInterestMapLayerPresentation_FeatureOfInterestColor()
	 * @model default="0.0,0.0,1.0" unique="false" dataType="ca.gc.asc_csa.symphony.environment.ui.Color3f"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ui.FeaturesOfInterestMapLayerPresentation#getFeatureOfInterestColor <em>Feature Of Interest Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
