...
import ca.gc.asc_csa.symphony.environment.ui.views.CoordinateConversionView;

public class ToggleCoordinateConversionViewSelectionEnabledCommand extends AbstractHandler
{
	private static final String COORD_CONVERSION_VIEW_ID = "ca.gc.asc_csa.symphony.environment.ui.views.CoordinateConversionView";
