 ...
 * @generated
 */
public class AbstractFeatureListNodeItemProvider
  extends AbstractFeatureNodeItemProvider
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public AbstractFeatureListNodeItemProvider(AdapterFactory adapterFactory)
  {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 org.eclipse.symphony.common.emf.EMFEcorePackage.Literals.ABSTRACT_FEATURE_LIST_NODE__PARENT,
				 false,
				 false,
				 true,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(org.eclipse.symphony.common.emf.EMFEcorePackage.Literals.ABSTRACT_FEATURE_LIST_NODE__CHILD);
		}
  ...
  {
		return getString("_UI_AbstractFeatureListNode_type");
	}
  ...
  public void notifyChanged(Notification notification)
  {
		...
		switch (notification.getFeatureID(AbstractFeatureListNode.class)) {
			case org.eclipse.symphony.common.emf.EMFEcorePackage.ABSTRACT_FEATURE_LIST_NODE__CHILD:
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
	  ...
	  if(object instanceof ListRootNode)
	  {
	  ...
	  else if(object instanceof ListFeatureNode)
	  {
		  ...
		  EStructuralFeature eStructuralFeature = listFeatureNode.getStructuralFeature();
