 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.controllers.impl.CustomInputConditioningPointImpl#getInputValue <em>Input Value</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.controllers.impl.CustomInputConditioningPointImpl#getOutputValue <em>Output Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CustomInputConditioningPointImpl extends MinimalEObjectImpl.Container implements CustomInputConditioningPoint {
	...
	protected EClass eStaticClass() {
		return EMFEcoreControllersPackage.Literals.CUSTOM_INPUT_CONDITIONING_POINT;
	}
	...
	public void setInputValue(double newInputValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFEcoreControllersPackage.CUSTOM_INPUT_CONDITIONING_POINT__INPUT_VALUE, oldInputValue, inputValue));
	}
	...
	public void setOutputValue(double newOutputValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFEcoreControllersPackage.CUSTOM_INPUT_CONDITIONING_POINT__OUTPUT_VALUE, oldOutputValue, outputValue));
	}
