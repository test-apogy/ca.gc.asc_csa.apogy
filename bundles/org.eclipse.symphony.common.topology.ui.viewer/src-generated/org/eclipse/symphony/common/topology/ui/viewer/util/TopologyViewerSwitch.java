 ...
 * @generated
 */
public class TopologyViewerSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TopologyViewerPackage.TOPOLOGY_VIEWER_REGISTRY: {
	 ...
	 * @generated
	 */
	public T caseTopologyViewerRegistry(TopologyViewerRegistry object) {
		return null;
	}
