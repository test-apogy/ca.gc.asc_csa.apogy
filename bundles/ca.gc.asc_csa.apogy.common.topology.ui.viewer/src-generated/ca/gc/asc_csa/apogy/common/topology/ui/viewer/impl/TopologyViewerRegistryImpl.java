 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.common.topology.ui.viewer.impl.TopologyViewerRegistryImpl#isVerbose <em>Verbose</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.common.topology.ui.viewer.impl.TopologyViewerRegistryImpl#getITopologyViewers <em>ITopology Viewers</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.common.topology.ui.viewer.impl.TopologyViewerRegistryImpl#getLatestNodeSelection <em>Latest Node Selection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopologyViewerRegistryImpl extends MinimalEObjectImpl.Container implements TopologyViewerRegistry 
{
	...
	public void setVerbose(boolean newVerbose) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY__VERBOSE, oldVerbose, verbose));
	}
	...
	public EList<ITopologyViewer> getITopologyViewers() {
		if (iTopologyViewers == null) {
			iTopologyViewers = new EDataTypeEList<ITopologyViewer>(ITopologyViewer.class, this, ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY__ITOPOLOGY_VIEWERS);
		}
	...
	public NodeSelection getLatestNodeSelection() {
		if (latestNodeSelection != null && latestNodeSelection.eIsProxy()) {
			...
			if (latestNodeSelection != oldLatestNodeSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY__LATEST_NODE_SELECTION, oldLatestNodeSelection, latestNodeSelection));
			}
		}
	...
	public void setLatestNodeSelection(NodeSelection newLatestNodeSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY__LATEST_NODE_SELECTION, oldLatestNodeSelection, latestNodeSelection));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY___REGISTER_ITOPOLOGY_VIEWER__ITOPOLOGYVIEWER:
				registerITopologyViewer((ITopologyViewer)arguments.get(0));
				return null;
			case ApogyCommonTopologyUIViewerPackage.TOPOLOGY_VIEWER_REGISTRY___UN_REGISTER_ITOPOLOGY_VIEWER__ITOPOLOGYVIEWER:
