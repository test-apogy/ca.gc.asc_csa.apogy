 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.symphony.addons.vehicle.SymphonyToolsVehiclePackage
 * @generated
 */
public class SymphonyToolsVehicleSwitch<T> extends Switch<T>
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public SymphonyToolsVehicleSwitch()
  {
  ...
  {
		switch (classifierID) {
			case SymphonyToolsVehiclePackage.VEHICLE_POSE_CORRECTOR: {
			...
			case SymphonyToolsVehiclePackage.THRUSTER_BINDING: {
			...
			case SymphonyToolsVehiclePackage.WHEEL_CONTACT_PROVIDER: {
			...
			case SymphonyToolsVehiclePackage.LANDER_SPHERICAL_FOOT: {
			...
			case SymphonyToolsVehiclePackage.LANDER_SPHERICAL_FOOT_CONTACT_PROVIDER: {
			...
			case SymphonyToolsVehiclePackage.WHEEL_VEHICLE_UTILITIES: {
			...
			case SymphonyToolsVehiclePackage.MESH_EXTENT2_D: {
				MeshExtent2D meshExtent2D = (MeshExtent2D)theEObject;
				T result = caseMeshExtent2D(meshExtent2D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SymphonyToolsVehiclePackage.PATH_PLANNER_TOOL: {
			...
			case SymphonyToolsVehiclePackage.VEHICLE_PATH_PLANNER_TOOL: {
