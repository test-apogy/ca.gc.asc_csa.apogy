 ...
 */
package ca.gc.space.mrt.geometry.data25d.ui.util;
 ...
 * <!-- end-user-doc -->
 * @see ca.gc.space.mrt.geometry.data25d.ui.Data25DUIPackage
 * @generated
 */
public class Data25DUISwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Data25DUIPackage.VOLUMETRIC_COORDINATES_SET25_DPRESENTATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Volumetric Coordinates Set25 DPresentation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Volumetric Coordinates Set25 DPresentation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVolumetricCoordinatesSet25DPresentation(VolumetricCoordinatesSet25DPresentation object) {
		return null;
	}
