...
public class ApogyWorkspaceUiSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApogyWorkspaceUiPackage.APOGY_WORKSPACE_UI_FACADE: {
				ApogyWorkspaceUiFacade apogyWorkspaceUiFacade = (ApogyWorkspaceUiFacade)theEObject;
				T result = caseApogyWorkspaceUiFacade(apogyWorkspaceUiFacade);
