...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.common.topology.bindings.BindingsList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BindingsListItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public BindingsListItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApogyCommonTopologyBindingsPackage.Literals.BINDINGS_LIST__BINDINGS);
		}
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BindingsList"));
	}
  ...
  {
	  BindingsList list = (BindingsList) object;
	  
	  String label = getString("_UI_BindingsList_type");
	  
	  if(list.getBindings() != null && list.getBindings().size() > 0)
	  {
		  label += " [" + list.getBindings().size() + "]";
	  }
