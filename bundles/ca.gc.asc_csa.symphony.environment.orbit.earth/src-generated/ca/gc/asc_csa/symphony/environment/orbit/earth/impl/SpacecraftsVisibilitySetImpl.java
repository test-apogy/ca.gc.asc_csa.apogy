 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#isUpdating <em>Updating</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#isAutoUpdateEnabled <em>Auto Update Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getOrbitModels <em>Orbit Models</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getGroundStations <em>Ground Stations</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getPasses <em>Passes</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftsVisibilitySetImpl#getGroundStationToVisibilityMap <em>Ground Station To Visibility Map</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
