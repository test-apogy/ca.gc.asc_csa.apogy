 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#isUpdating <em>Updating</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#isAutoUpdateEnabled <em>Auto Update Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getEndTime <em>End Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getTimeInterval <em>Time Interval</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getOrbitModel <em>Orbit Model</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getLeftSwathAngle <em>Left Swath Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getRightSwathAngle <em>Right Swath Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.SpacecraftSwathCorridorImpl#getCorridor <em>Corridor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
		...
		try
		{
			...
			{						
				...
				for(SpacecraftSwathCorridorImpl.CorridorPoint point : corridorHandler.getCorridor())
				{
					...
					ca.gc.asc_csa.symphony.environment.orbit.earth.CorridorPoint newPoint = SymphonyEarthOrbitEnvironmentFactory.eINSTANCE.createCorridorPoint();
