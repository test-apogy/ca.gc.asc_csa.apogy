 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.CartesianEarthOrbitImpl#getPvaCoordinates <em>Pva Coordinates</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CartesianEarthOrbitImpl extends EarthOrbitImpl implements CartesianEarthOrbit {
	...
	protected EClass eStaticClass() {
		return SymphonyEarthOrbitEnvironmentPackage.Literals.CARTESIAN_EARTH_ORBIT;
	}
	...
	public NotificationChain basicSetPvaCoordinates(TimedStampedPVACoordinates newPvaCoordinates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SymphonyEarthOrbitEnvironmentPackage.CARTESIAN_EARTH_ORBIT__PVA_COORDINATES, oldPvaCoordinates, newPvaCoordinates);
	...
	public void setPvaCoordinates(TimedStampedPVACoordinates newPvaCoordinates) {
		if (newPvaCoordinates != pvaCoordinates) {
			...
			if (pvaCoordinates != null)
				msgs = ((InternalEObject)pvaCoordinates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SymphonyEarthOrbitEnvironmentPackage.CARTESIAN_EARTH_ORBIT__PVA_COORDINATES, null, msgs);
			if (newPvaCoordinates != null)
				msgs = ((InternalEObject)newPvaCoordinates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SymphonyEarthOrbitEnvironmentPackage.CARTESIAN_EARTH_ORBIT__PVA_COORDINATES, null, msgs);
			msgs = basicSetPvaCoordinates(newPvaCoordinates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyEarthOrbitEnvironmentPackage.CARTESIAN_EARTH_ORBIT__PVA_COORDINATES, newPvaCoordinates, newPvaCoordinates));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SymphonyEarthOrbitEnvironmentPackage.CARTESIAN_EARTH_ORBIT___GET_ORE_KIT_CARTESIAN_ORBIT:
