 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.CorridorImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.CorridorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.impl.CorridorImpl#getPoints <em>Points</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CorridorImpl extends MinimalEObjectImpl.Container implements Corridor {
	 ...
	 * @ordered
	 */
	protected EList<CorridorPoint> points;
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (derivedFeatureID) {
				case SymphonyEarthOrbitEnvironmentPackage.CORRIDOR__DESCRIPTION: return EMFEcorePackage.DESCRIBED__DESCRIPTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (baseFeatureID) {
				case EMFEcorePackage.DESCRIBED__DESCRIPTION: return SymphonyEarthOrbitEnvironmentPackage.CORRIDOR__DESCRIPTION;
				default: return -1;
			}
		}
