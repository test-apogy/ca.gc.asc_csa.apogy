 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.imaging.Zoomable#getCurrentZoom <em>Current Zoom</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.imaging.Zoomable#getCommandedZoom <em>Commanded Zoom</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.imaging.MRTSensorsImagingPackage#getZoomable()
 * @model abstract="true"
 * @generated
 */
public interface Zoomable extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.imaging.MRTSensorsImagingPackage#getZoomable_CurrentZoom()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.imaging.Zoomable#getCurrentZoom <em>Current Zoom</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.imaging.MRTSensorsImagingPackage#getZoomable_CommandedZoom()
	 * @model default="1.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='ZOOMABLE_PROPERTIES'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.imaging.Zoomable#getCommandedZoom <em>Commanded Zoom</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
