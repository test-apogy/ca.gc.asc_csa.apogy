 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.imaging.AbstractCamera#getLatestImageSnapshot <em>Latest Image Snapshot</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.imaging.MRTSensorsImagingPackage#getAbstractCamera()
 * @model abstract="true"
 * @generated
 */
public interface AbstractCamera extends Sensor, Named
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.imaging.MRTSensorsImagingPackage#getAbstractCamera_LatestImageSnapshot()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.imaging.AbstractCamera#getLatestImageSnapshot <em>Latest Image Snapshot</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
