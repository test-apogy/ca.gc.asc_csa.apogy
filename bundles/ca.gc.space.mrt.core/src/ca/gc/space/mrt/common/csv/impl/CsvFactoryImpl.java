 ...
 *
 * $Id: CsvFactoryImpl.java,v 1.3.4.2 2015/05/21 15:51:13 pallard Exp $
 */
...
public class CsvFactoryImpl extends EFactoryImpl implements CsvFactory {
	...
	public static CsvFactory init() {
		try {
			CsvFactory theCsvFactory = (CsvFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ca/gc/space/mrt/common/model/csv.ecore"); 
