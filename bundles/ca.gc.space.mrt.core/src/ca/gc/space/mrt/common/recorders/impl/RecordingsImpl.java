 ...
 *
 * $Id: RecordingsImpl.java,v 1.3.4.2 2015/05/21 15:51:13 pallard Exp $
 */
 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.common.recorders.impl.RecordingsImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ca.gc.space.mrt.common.recorders.impl.RecordingsImpl#getRecords <em>Records</em>}</li>
 *   <li>{@link ca.gc.space.mrt.common.recorders.impl.RecordingsImpl#getTracks <em>Tracks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RecordingsImpl extends EObjectImpl implements Recordings {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public EList<String> getTracks() {
		if (tracks == null) {
			tracks = new EDataTypeUniqueEList<String>(String.class, this, RecordersPackage.RECORDINGS__TRACKS);
		}
		return tracks;
	}
