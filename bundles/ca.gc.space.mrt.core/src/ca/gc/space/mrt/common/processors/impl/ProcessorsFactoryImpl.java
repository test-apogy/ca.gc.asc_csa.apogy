 ...
 *
 * $Id: ProcessorsFactoryImpl.java,v 1.3.4.2 2015/05/21 15:51:12 pallard Exp $
 */
...
public class ProcessorsFactoryImpl extends EFactoryImpl implements ProcessorsFactory {
	...
	public static ProcessorsFactory init() {
		try {
			ProcessorsFactory theProcessorsFactory = (ProcessorsFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ca/gc/space/mrt/common/model/processors.ecore"); 
	 ...
	 * @generated
	 */
	public ProcessorsChain createProcessorsChain() {
		ProcessorsChainImpl processorsChain = new ProcessorsChainImpl();
