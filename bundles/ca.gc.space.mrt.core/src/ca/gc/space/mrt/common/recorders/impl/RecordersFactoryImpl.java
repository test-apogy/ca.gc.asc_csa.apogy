 ...
 *
 * $Id: RecordersFactoryImpl.java,v 1.3.4.2 2015/05/21 15:51:13 pallard Exp $
 */
...
public class RecordersFactoryImpl extends EFactoryImpl implements RecordersFactory {
	...
	public static RecordersFactory init() {
		try {
			RecordersFactory theRecordersFactory = (RecordersFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ca/gc/space/mrt/common/model/recorders.ecore"); 
