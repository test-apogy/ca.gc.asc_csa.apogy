 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.symphony.common.io.jinput.JInputPackage
 * @generated
 */
public class JInputSwitch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JInputPackage.ECOMPONENT_QUALIFIER: {
			...
			case JInputPackage.EVIRTUAL_COMPONENT: {
