...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.environment.StarField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StarFieldItemProvider
  extends NodeItemProvider
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public StarFieldItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
		if (itemPropertyDescriptors == null) {
			...
			addStarFieldFileNamePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

  /**
	 * This adds a property descriptor for the Star Field File Name feature.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected void addStarFieldFileNamePropertyDescriptor(Object object)
  {
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StarField"));
	}
  ...
  {
	  StarField starField = (StarField) object;
	  
	  String label = null;
	  if(starField.getStars().size() > 0)
	  {
		  label = "[" + starField.getStars().size() + "]";
	  }
	      
	  return label == null || label.length() == 0 ?
      getString("_UI_StarField_type") :
      getString("_UI_StarField_type") + " " + label;
  }
