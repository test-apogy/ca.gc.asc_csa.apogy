package ca.gc.asc_csa.eclipse.ui.properties.sections;
...
public abstract class AbstractExtendedPropertySection extends AbstractPropertySection {
	...
	protected void refreshContributions() {
		...
		evaluationService
				.requestEvaluation("ca.gc.asc_csa.eclipse.ui.expressions.TabbedPropertySheetPropertyTester.activeSection");
