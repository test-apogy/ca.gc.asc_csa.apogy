 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.impl.EllipseShapeImageLayerImpl#getEllipseWidth <em>Ellipse Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.impl.EllipseShapeImageLayerImpl#getEllipseHeight <em>Ellipse Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.impl.EllipseShapeImageLayerImpl#isShowCenterLines <em>Show Center Lines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EllipseShapeImageLayerImpl extends AbstractShapeImageLayerImpl implements EllipseShapeImageLayer {
	...
	protected EClass eStaticClass() {
		return ApogyCoreEnvironmentPackage.Literals.ELLIPSE_SHAPE_IMAGE_LAYER;
	}
	...
	public void setEllipseWidth(double newEllipseWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentPackage.ELLIPSE_SHAPE_IMAGE_LAYER__ELLIPSE_WIDTH, oldEllipseWidth, ellipseWidth));
	}
	...
	public void setEllipseHeight(double newEllipseHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentPackage.ELLIPSE_SHAPE_IMAGE_LAYER__ELLIPSE_HEIGHT, oldEllipseHeight, ellipseHeight));
	}
	...
	public void setShowCenterLines(boolean newShowCenterLines) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentPackage.ELLIPSE_SHAPE_IMAGE_LAYER__SHOW_CENTER_LINES, oldShowCenterLines, showCenterLines));
	}
