...
public class GeographicCoordinatesComposite extends Composite 
{
	...
	protected DataBindingContext custom_initDataBindings() 
	{
		...
		IObservableValue xObserveValue = (editingDomain == null ? 
				EMFProperties.value(ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__LONGITUDE).observe(geographicCoordinates):
				EMFEditProperties.value(editingDomain, ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__LONGITUDE).observe(geographicCoordinates));
		...
		IObservableValue yObserveValue = (editingDomain == null ? 
				EMFProperties.value(ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__LATITUDE).observe(geographicCoordinates):
				EMFEditProperties.value(editingDomain, ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__LATITUDE).observe(geographicCoordinates));
		...
		IObservableValue zObserveValue = (editingDomain == null ? 
				EMFProperties.value(ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__ELEVATION).observe(geographicCoordinates):
				EMFEditProperties.value(editingDomain, ApogyEarthEnvironmentPackage.Literals.GEOGRAPHIC_COORDINATES__ELEVATION).observe(geographicCoordinates));
