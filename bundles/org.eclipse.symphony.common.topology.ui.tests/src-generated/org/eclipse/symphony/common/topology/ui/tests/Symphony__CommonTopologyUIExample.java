 ...
 * @generated
 */
public class Symphony__CommonTopologyUIExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.symphony__commontopologyui"));
...
} //Symphony__CommonTopologyUIExample
