...
public class PointLightImpl extends LightImpl implements PointLight {
	...
	protected EClass eStaticClass() {
		return Symphony__CommonTopologyAddonsPrimitivesPackage.Literals.POINT_LIGHT;
	}
	...
	public NotificationChain basicSetPosition(Tuple3d newPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__POSITION, oldPosition, newPosition);
	...
	public void setPosition(Tuple3d newPosition) {
		if (newPosition != position) {
			...
			if (position != null)
				msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__POSITION, null, msgs);
			if (newPosition != null)
				msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__POSITION, null, msgs);
			msgs = basicSetPosition(newPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__POSITION, newPosition, newPosition));
	}
	...
	public NotificationChain basicSetAttenuation(Tuple3d newAttenuation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__ATTENUATION, oldAttenuation, newAttenuation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAttenuation(Tuple3d newAttenuation) {
		if (newAttenuation != attenuation) {
			NotificationChain msgs = null;
			if (attenuation != null)
				msgs = ((InternalEObject)attenuation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__ATTENUATION, null, msgs);
			if (newAttenuation != null)
				msgs = ((InternalEObject)newAttenuation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__ATTENUATION, null, msgs);
			msgs = basicSetAttenuation(newAttenuation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsPrimitivesPackage.POINT_LIGHT__ATTENUATION, newAttenuation, newAttenuation));
	}
