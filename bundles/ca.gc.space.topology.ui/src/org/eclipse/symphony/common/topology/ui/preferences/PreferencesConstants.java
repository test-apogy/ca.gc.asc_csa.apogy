...
public class PreferencesConstants 
{
	...
	public static final String DEFAULT_POSITION_NODE_AXIS_LENGHT_ID = "DEFAULT_POSITION_NODE_AXIS_LENGHT_ID";	
	public static final Double DEFAULT_POSITION_NODE_AXIS_LENGHT = new Double(1.0);	
	...
	public static final String DEFAULT_ROTATION_NODE_AXIS_LENGHT_ID = "DEFAULT_ROTATION_NODE_AXIS_LENGHT_ID";	
	public static final Double DEFAULT_ROTATION_NODE_AXIS_LENGHT = new Double(1.0);	
	...
	public static final String DEFAULT_TRANSFORM_NODE_AXIS_LENGHT_ID = "DEFAULT_TRANSFORM_NODE_AXIS_LENGHT";	
	public static final Double DEFAULT_TRANSFORM_NODE_AXIS_LENGHT = new Double(1.0);	
	...
	public static final String DEFAULT_URL_NODE_AXIS_LENGHT_ID = "DEFAULT_URL_NODE_AXIS_LENGHT_ID";	
	public static final Double DEFAULT_URL_NODE_AXIS_LENGHT = new Double(0.5);	
