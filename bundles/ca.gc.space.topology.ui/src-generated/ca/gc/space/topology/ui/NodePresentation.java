 ...
 * <ul>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getTopologyPresentationSet <em>Topology Presentation Set</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getNode <em>Node</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getColor <em>Color</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#isVisible <em>Visible</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getShadowMode <em>Shadow Mode</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#isUseInBoundingCalculation <em>Use In Bounding Calculation</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getCentroid <em>Centroid</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getMin <em>Min</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getMax <em>Max</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getXRange <em>XRange</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getYRange <em>YRange</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getZRange <em>ZRange</em>}</li>
 *   <li>{@link ca.gc.space.topology.ui.NodePresentation#getSceneObject <em>Scene Object</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation()
 * @model
 * @generated
 */
public interface NodePresentation extends EObject {
	 ...
	 * The list contents are of type {@link ca.gc.space.topology.ui.TopologyPresentationSet}.
	 * It is bidirectional and its opposite is '{@link ca.gc.space.topology.ui.TopologyPresentationSet#getNodePresentationList <em>Node Presentation List</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * *
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_TopologyPresentationSet()
	 ...
	 * @see #setNode(Node)
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Node()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#getNode <em>Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setColor(RGB)
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Color()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#getColor <em>Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Visible()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#isVisible <em>Visible</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_UseInBoundingCalculation()
	 * @model default="true" unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#isUseInBoundingCalculation <em>Use In Bounding Calculation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Centroid()
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Min()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' property='Readonly' propertyCategory='BOUNDING_VOLUME_INFORMATION'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_Max()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' property='Readonly' propertyCategory='BOUNDING_VOLUME_INFORMATION'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_XRange()
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_YRange()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' property='Readonly' propertyCategory='BOUNDING_VOLUME_INFORMATION'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_ZRange()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' property='Readonly' propertyCategory='BOUNDING_VOLUME_INFORMATION'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_SceneObject()
	 * @model unique="false" dataType="ca.gc.space.topology.ui.SceneObject" transient="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#getSceneObject <em>Scene Object</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ca.gc.space.topology.ui.ShadowMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#getNodePresentation_ShadowMode()
	 * @model unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.topology.ui.NodePresentation#getShadowMode <em>Shadow Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
