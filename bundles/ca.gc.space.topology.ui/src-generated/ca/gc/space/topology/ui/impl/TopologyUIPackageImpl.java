 ...
 * @generated
 */
public class TopologyUIPackageImpl extends EPackageImpl implements TopologyUIPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ca.gc.space.topology.ui.TopologyUIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TopologyUIPackageImpl() {
		super(eNS_URI, TopologyUIFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TopologyUIPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TopologyUIPackage init() {
		if (isInited) return (TopologyUIPackage)EPackage.Registry.INSTANCE.getEPackage(TopologyUIPackage.eNS_URI);

		// Obtain or create and register package
		TopologyUIPackageImpl theTopologyUIPackage = (TopologyUIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TopologyUIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TopologyUIPackageImpl());
		...
		theTopologyUIPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTopologyUIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TopologyUIPackage.eNS_URI, theTopologyUIPackage);
		return theTopologyUIPackage;
	}
	 ...
	 * @generated
	 */
	public TopologyUIFactory getTopologyUIFactory() {
		return (TopologyUIFactory)getEFactoryInstance();
	}
