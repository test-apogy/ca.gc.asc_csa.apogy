...
public class TreeFeatureNodeImpl extends AbstractFeatureTreeNodeImpl implements TreeFeatureNode
{
  ...
  {
		return EMFEcorePackage.Literals.TREE_FEATURE_NODE;
	}
		...
		if (structuralFeature != null && structuralFeature.eIsProxy()) {
			...
			if (structuralFeature != oldStructuralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EMFEcorePackage.TREE_FEATURE_NODE__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
			}
		}
  ...
  public void setStructuralFeature(EStructuralFeature newStructuralFeature)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFEcorePackage.TREE_FEATURE_NODE__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
	}
  ...
  public void setIndex(int newIndex)
  {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFEcorePackage.TREE_FEATURE_NODE__INDEX, oldIndex, index));
	}
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
		if (baseClass == AbstractFeatureSpecifier.class) {
			switch (derivedFeatureID) {
				case EMFEcorePackage.TREE_FEATURE_NODE__STRUCTURAL_FEATURE: return EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__STRUCTURAL_FEATURE;
				case EMFEcorePackage.TREE_FEATURE_NODE__MULTI_VALUED: return EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__MULTI_VALUED;
				case EMFEcorePackage.TREE_FEATURE_NODE__INDEX: return EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__INDEX;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
		if (baseClass == AbstractFeatureSpecifier.class) {
			switch (baseFeatureID) {
				case EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__STRUCTURAL_FEATURE: return EMFEcorePackage.TREE_FEATURE_NODE__STRUCTURAL_FEATURE;
				case EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__MULTI_VALUED: return EMFEcorePackage.TREE_FEATURE_NODE__MULTI_VALUED;
				case EMFEcorePackage.ABSTRACT_FEATURE_SPECIFIER__INDEX: return EMFEcorePackage.TREE_FEATURE_NODE__INDEX;
				default: return -1;
			}
		}
