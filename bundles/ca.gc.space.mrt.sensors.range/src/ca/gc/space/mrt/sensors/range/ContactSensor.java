 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.range.ContactSensor#isContacted <em>Contacted</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.range.RangePackage#getContactSensor()
 * @model
 * @generated
 */
public interface ContactSensor extends RangeSensor
{
	 ...
	 * @see ca.gc.space.mrt.sensors.range.RangePackage#getContactSensor_Contacted()
	 * @model required="true"
	 * @generated
	 */
	boolean isContacted();
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.range.ContactSensor#isContacted <em>Contacted</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
