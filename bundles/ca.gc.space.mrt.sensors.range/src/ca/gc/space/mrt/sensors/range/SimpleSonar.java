 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.range.SimpleSonar#isEchoDetected <em>Echo Detected</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.range.RangePackage#getSimpleSonar()
 * @model
 * @generated
 */
public interface SimpleSonar extends SimpleRangeSensor
{
	 ...
	 * @see ca.gc.space.mrt.sensors.range.RangePackage#getSimpleSonar_EchoDetected()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.range.SimpleSonar#isEchoDetected <em>Echo Detected</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
