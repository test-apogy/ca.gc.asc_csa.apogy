 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.range.impl.LineRangeScannerImpl#getAngularResolution <em>Angular Resolution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineRangeScannerImpl extends RangeSensorImpl implements LineRangeScanner
{
	...
	{
		return RangePackage.Literals.LINE_RANGE_SCANNER;
	}
	...
	public synchronized CircularSectorFieldOfView getFieldOfView()
	{
		if(fov == null)
		{
	    	...
	    	if(fov == null)
	    	{
	    		fov = FovFactory.eINSTANCE.createCircularSectorFieldOfView();	
	    		getChildren().add(fov);
	    	}
		}
	...
	public void setAngularResolution(int newAngularResolution)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RangePackage.LINE_RANGE_SCANNER__ANGULAR_RESOLUTION, oldAngularResolution, angularResolution));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RangePackage.LINE_RANGE_SCANNER___GET_FIELD_OF_VIEW:
