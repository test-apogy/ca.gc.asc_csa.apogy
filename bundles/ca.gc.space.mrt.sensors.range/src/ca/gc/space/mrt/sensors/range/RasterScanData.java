 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.range.RasterScanData#getRasterScanSettings <em>Raster Scan Settings</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.range.RasterScanData#getScanData <em>Scan Data</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.range.RangePackage#getRasterScanData()
 * @model
 * @generated
 */
public interface RasterScanData extends AggregateGroupNode, TimeTaggedElement
{
	 ...
	 * @see ca.gc.space.mrt.sensors.range.RangePackage#getRasterScanData_RasterScanSettings()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.range.RasterScanData#getRasterScanSettings <em>Raster Scan Settings</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.range.RangePackage#getRasterScanData_ScanData()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.range.RasterScanData#getScanData <em>Scan Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
