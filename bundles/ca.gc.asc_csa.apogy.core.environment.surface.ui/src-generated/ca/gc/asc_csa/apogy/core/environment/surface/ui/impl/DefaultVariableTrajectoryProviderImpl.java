 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.impl.DefaultVariableTrajectoryProviderImpl#getDistanceThreshold <em>Distance Threshold</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.impl.DefaultVariableTrajectoryProviderImpl#getAzimuthThreshold <em>Azimuth Threshold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultVariableTrajectoryProviderImpl extends VariableTrajectoryProviderImpl implements DefaultVariableTrajectoryProvider 
{
	...
	public void setDistanceThreshold(double newDistanceThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentUIPackage.DEFAULT_VARIABLE_TRAJECTORY_PROVIDER__DISTANCE_THRESHOLD, oldDistanceThreshold, distanceThreshold));
	}
	...
	public void setAzimuthThreshold(double newAzimuthThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentUIPackage.DEFAULT_VARIABLE_TRAJECTORY_PROVIDER__AZIMUTH_THRESHOLD, oldAzimuthThreshold, azimuthThreshold));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentUIPackage.DEFAULT_VARIABLE_TRAJECTORY_PROVIDER__DISTANCE_THRESHOLD:
				return getDistanceThreshold();
			case ApogySurfaceEnvironmentUIPackage.DEFAULT_VARIABLE_TRAJECTORY_PROVIDER__AZIMUTH_THRESHOLD:
