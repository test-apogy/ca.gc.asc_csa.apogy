 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#getVectorlength <em>Vectorlength</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#getVectorColor <em>Vector Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#isShowPose <em>Show Pose</em>}</li>
 * </ul>
 *
 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getPoseVariableAnnotation()
 * @model
 * @generated
 */
public interface PoseVariableAnnotation extends AbstractVariableAnnotation {
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getPoseVariableAnnotation_Vectorlength()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#getVectorlength <em>Vectorlength</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getPoseVariableAnnotation_VectorColor()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#getVectorColor <em>Vector Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getPoseVariableAnnotation_ShowPose()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation#isShowPose <em>Show Pose</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
