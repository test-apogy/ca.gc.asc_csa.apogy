 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getMapLayers <em>Map Layers</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getMapAnnotations <em>Map Annotations</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getDefaultRectangularRegion <em>Default Rectangular Region</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getMapImage <em>Map Image</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getMapImageRectangularRegion <em>Map Image Rectangular Region</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getExtent <em>Extent</em>}</li>
 * </ul>
 *
 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration()
 * @model
 * @generated
 */
public interface MapViewConfiguration extends Named, Described {
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.apogy.core.environment.surface.ImageMapLayerPresentation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_MapLayers()
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_BackgroundColor()
	 * @model default="1.0,1.0,1.0" unique="false" dataType="ca.gc.asc_csa.apogy.core.environment.surface.ui.Color3f"
	 * @generated
	 */
	Color3f getBackgroundColor();

	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getBackgroundColor <em>Background Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapAnnotation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_MapAnnotations()
	 * @model containment="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='true' notify='true' property='None'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_DefaultRectangularRegion()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getDefaultRectangularRegion <em>Default Rectangular Region</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_MapImage()
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_MapImageRectangularRegion()
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ui.ApogySurfaceEnvironmentUIPackage#getMapViewConfiguration_Extent()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.MapViewConfiguration#getExtent <em>Extent</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
