...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.surface.ui.PoseVariableAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PoseVariableAnnotationItemProvider extends AbstractVariableAnnotationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.POSE_VARIABLE_ANNOTATION__VECTORLENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.POSE_VARIABLE_ANNOTATION__VECTOR_COLOR,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.POSE_VARIABLE_ANNOTATION__SHOW_POSE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_PoseVariableAnnotation_type") + " " + poseVariableAnnotation.isVisible();
	}
