 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.ui.impl.MapViewItemPresentationImpl#isVisible <em>Visible</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MapViewItemPresentationImpl extends MinimalEObjectImpl.Container implements MapViewItemPresentation {
	...
	protected EClass eStaticClass() {
		return ApogySurfaceEnvironmentUIPackage.Literals.MAP_VIEW_ITEM_PRESENTATION;
	}
	...
	public void setVisible(boolean newVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentUIPackage.MAP_VIEW_ITEM_PRESENTATION__VISIBLE, oldVisible, visible));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentUIPackage.MAP_VIEW_ITEM_PRESENTATION__VISIBLE:
				return isVisible();
		}
