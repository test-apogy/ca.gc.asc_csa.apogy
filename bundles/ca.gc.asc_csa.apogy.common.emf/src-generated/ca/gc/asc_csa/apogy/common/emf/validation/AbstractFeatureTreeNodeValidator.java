 ...
 */
public interface AbstractFeatureTreeNodeValidator {
	boolean validate();

	boolean validateParent(AbstractFeatureTreeNode value);
	boolean validateChildren(EList<AbstractFeatureTreeNode> value);
}
