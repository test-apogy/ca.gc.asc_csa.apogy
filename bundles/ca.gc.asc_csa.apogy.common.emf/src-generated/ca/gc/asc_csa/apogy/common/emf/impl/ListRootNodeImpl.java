 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.common.emf.impl.ListRootNodeImpl#getSourceClass <em>Source Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListRootNodeImpl extends AbstractFeatureListNodeImpl implements ListRootNode
{
  ...
  {
		return ApogyCommonEMFPackage.Literals.LIST_ROOT_NODE;
	}
		...
		if (sourceClass != null && sourceClass.eIsProxy()) {
			...
			if (sourceClass != oldSourceClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyCommonEMFPackage.LIST_ROOT_NODE__SOURCE_CLASS, oldSourceClass, sourceClass));
			}
		}
		return sourceClass;
	}
  ...
  public void setSourceClass(EClass newSourceClass)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCommonEMFPackage.LIST_ROOT_NODE__SOURCE_CLASS, oldSourceClass, sourceClass));
	}
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
		if (baseClass == AbstractRootNode.class) {
			switch (derivedFeatureID) {
				case ApogyCommonEMFPackage.LIST_ROOT_NODE__SOURCE_CLASS: return ApogyCommonEMFPackage.ABSTRACT_ROOT_NODE__SOURCE_CLASS;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
		if (baseClass == AbstractRootNode.class) {
			switch (baseFeatureID) {
				case ApogyCommonEMFPackage.ABSTRACT_ROOT_NODE__SOURCE_CLASS: return ApogyCommonEMFPackage.LIST_ROOT_NODE__SOURCE_CLASS;
				default: return -1;
			}
		}
