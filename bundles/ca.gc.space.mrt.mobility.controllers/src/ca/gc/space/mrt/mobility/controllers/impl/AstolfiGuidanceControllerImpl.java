 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getCurrentWayPoint <em>Current Way Point</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getPreviousWayPoint <em>Previous Way Point</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getCurrentPoseInGuidanceReferenceFrame <em>Current Pose In Guidance Reference Frame</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getRho <em>Rho</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getPhi <em>Phi</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getYaw <em>Yaw</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getNu <em>Nu</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getOmega <em>Omega</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getKrho <em>Krho</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getKphi <em>Kphi</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getKalpha <em>Kalpha</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getDestinationDistanceThreshold <em>Destination Distance Threshold</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getWayPointDistanceThreshold <em>Way Point Distance Threshold</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getKHill <em>KHill</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getHillThreshold <em>Hill Threshold</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getPhiThresholdForReducedVelocity <em>Phi Threshold For Reduced Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#getAlphaThresholdForReducedVelocity <em>Alpha Threshold For Reduced Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.AstolfiGuidanceControllerImpl#isSmoothPathEnabled <em>Smooth Path Enabled</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AstolfiGuidanceControllerImpl extends SkidSteeredPlatformPathFollowerImpl<SkidSteeredMobilePlateform, WayPointPath> implements AstolfiGuidanceController 
{
		...
		if (currentWayPoint != null && currentWayPoint.eIsProxy()) {
			...
			if (currentWayPoint != oldCurrentWayPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__CURRENT_WAY_POINT, oldCurrentWayPoint, currentWayPoint));
			}
		}
	...
	public void setCurrentWayPoint(CartesianPositionCoordinates newCurrentWayPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__CURRENT_WAY_POINT, oldCurrentWayPoint, currentWayPoint));
	}
	...
	public CartesianPositionCoordinates getPreviousWayPoint() {
		if (previousWayPoint != null && previousWayPoint.eIsProxy()) {
			...
			if (previousWayPoint != oldPreviousWayPoint) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__PREVIOUS_WAY_POINT, oldPreviousWayPoint, previousWayPoint));
			}
		}
	...
	public void setPreviousWayPoint(CartesianPositionCoordinates newPreviousWayPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__PREVIOUS_WAY_POINT, oldPreviousWayPoint, previousWayPoint));
	}
	...
	public Pose getCurrentPoseInGuidanceReferenceFrame() {
		if (currentPoseInGuidanceReferenceFrame != null && currentPoseInGuidanceReferenceFrame.eIsProxy()) {
			...
			if (currentPoseInGuidanceReferenceFrame != oldCurrentPoseInGuidanceReferenceFrame) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__CURRENT_POSE_IN_GUIDANCE_REFERENCE_FRAME, oldCurrentPoseInGuidanceReferenceFrame, currentPoseInGuidanceReferenceFrame));
			}
		}
...
//			nu = nu / 5.0;
	...
	public void setKrho(double newKrho) {
		...
		krho = newKrho;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__KRHO, oldKrho, krho));
	}
	...
	public void setKphi(double newKphi) {
		...
		kphi = newKphi;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__KPHI, oldKphi, kphi));
	}
	...
	public void setKalpha(double newKalpha) {
		...
		kalpha = newKalpha;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__KALPHA, oldKalpha, kalpha));
	}
	...
	public void setDestinationDistanceThreshold(double newDestinationDistanceThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__DESTINATION_DISTANCE_THRESHOLD, oldDestinationDistanceThreshold, destinationDistanceThreshold));
	}
	...
	public void setWayPointDistanceThreshold(double newWayPointDistanceThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__WAY_POINT_DISTANCE_THRESHOLD, oldWayPointDistanceThreshold, wayPointDistanceThreshold));
	}
	...
	public void setKHill(double newKHill) {
		...
		kHill = newKHill;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__KHILL, oldKHill, kHill));
	}
	...
	public void setHillThreshold(double newHillThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__HILL_THRESHOLD, oldHillThreshold, hillThreshold));
	}
	...
	public void setPhiThresholdForReducedVelocity(double newPhiThresholdForReducedVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__PHI_THRESHOLD_FOR_REDUCED_VELOCITY, oldPhiThresholdForReducedVelocity, phiThresholdForReducedVelocity));
	}
	...
	public void setAlphaThresholdForReducedVelocity(double newAlphaThresholdForReducedVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__ALPHA_THRESHOLD_FOR_REDUCED_VELOCITY, oldAlphaThresholdForReducedVelocity, alphaThresholdForReducedVelocity));
	}
	...
	public void setSmoothPathEnabled(boolean newSmoothPathEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__SMOOTH_PATH_ENABLED, oldSmoothPathEnabled, smoothPathEnabled));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__CURRENT_WAY_POINT:
				if (resolve) return getCurrentWayPoint();
				return basicGetCurrentWayPoint();
			case ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__PREVIOUS_WAY_POINT:
				if (resolve) return getPreviousWayPoint();
				return basicGetPreviousWayPoint();
			case ControllersPackage.ASTOLFI_GUIDANCE_CONTROLLER__CURRENT_POSE_IN_GUIDANCE_REFERENCE_FRAME:
	...
	private void createSmoothedPath() throws Exception {
		...
		if (getPath().getPoints().size() > 2) {
			CatmullRomWayPointPathInterpolator interpolator = PathsFactory.eINSTANCE
