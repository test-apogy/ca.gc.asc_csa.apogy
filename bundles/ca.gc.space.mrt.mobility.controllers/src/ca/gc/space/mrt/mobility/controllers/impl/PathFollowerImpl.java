 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathFollowerImpl#getPath <em>Path</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathFollowerImpl#getPlatform <em>Platform</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathFollowerImpl#getPoseSensor <em>Pose Sensor</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathFollowerImpl#isDestinationReached <em>Destination Reached</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathFollowerImpl#getPathFollowerState <em>Path Follower State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{	
	...
	{
		if(plateformAdapter == null)
		{
			plateformAdapter = new AdapterImpl()
			{
				@Override
				public void notifyChanged(Notification msg)
				{
					if(msg.getFeatureID(MobilePlateform.class) == MobilityPackage.MOBILE_PLATEFORM_STATUS)
					{
						if(msg.getNewValue() == MobilePlateformStatus.FAILED)
						{
							if(isTransitionValid(PathFollowerState.PAUSED))
							{
								pause();
						...
						else if(msg.getNewValue() == MobilePlateformStatus.OFF)
						{
							if(isTransitionValid(PathFollowerState.PAUSED))
							{
								pause();
						...
						else if((msg.getNewValue() == MobilePlateformStatus.READY))
						{
							if(isTransitionValid(PathFollowerState.RUNNING))
							{
								resume();
