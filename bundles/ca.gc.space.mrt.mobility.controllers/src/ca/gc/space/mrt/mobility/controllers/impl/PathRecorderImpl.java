 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathRecorderImpl#getPositionSensor <em>Position Sensor</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathRecorderImpl#getMinimumDistanceDelta <em>Minimum Distance Delta</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathRecorderImpl#getMinimumTimeDelta <em>Minimum Time Delta</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathRecorderImpl#getSamplingMode <em>Sampling Mode</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.impl.PathRecorderImpl#getRecordedPath <em>Recorded Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
