 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPath <em>Path</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPlatform <em>Platform</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPoseSensor <em>Pose Sensor</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.PathFollower#isDestinationReached <em>Destination Reached</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPathFollowerState <em>Path Follower State</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower()
 * @model
 * @generated
 */
public interface PathFollower<PlatformType extends MobilePlateform, PathType extends Path> extends EObject
{
	 ...
	 * @see #setPath(Path)
	 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower_Path()
	 * @model
	 * @generated
	 */
	PathType getPath();
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPath <em>Path</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower_Platform()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPlatform <em>Platform</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower_PoseSensor()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPoseSensor <em>Pose Sensor</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower_DestinationReached()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.mobility.controllers.PathFollower#isDestinationReached <em>Destination Reached</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ca.gc.space.mrt.mobility.controllers.PathFollowerState}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.space.mrt.mobility.controllers.ControllersPackage#getPathFollower_PathFollowerState()
	 * @model default="IDLE"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.mobility.controllers.PathFollower#getPathFollowerState <em>Path Follower State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
