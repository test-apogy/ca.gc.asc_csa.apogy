...
import org.eclipse.symphony.addons.sensors.range.util.RangeAdapterFactory;
 ...
 * @generated
 */
public class RangeItemProviderAdapterFactory extends RangeAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(RangeEditPlugin.INSTANCE, RangePackage.eNS_URI);
		...
		protected static class CreationSwitch extends TopologySwitch<Object> {
			...
			public <T> Object caseContentNode(ContentNode<T> object) {
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 RangeFactory.eINSTANCE.createRayData()));
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 RangeFactory.eINSTANCE.createSensorsRangeFacade()));
