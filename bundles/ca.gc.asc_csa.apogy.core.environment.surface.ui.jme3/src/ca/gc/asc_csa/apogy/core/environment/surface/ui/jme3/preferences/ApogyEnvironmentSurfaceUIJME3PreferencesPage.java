...
{	
	 ...
	 */
	public ApogyEnvironmentSurfaceUIJME3PreferencesPage() {
	}
	...
	public Control createContents(Composite parent) 
	{
		...
		earthSkyBloomEnableEditor = createBooleanFieldEditor(earthSkyGroup, ApogyEnvironmentSurfaceUIJME3PreferencesConstants.DEFAULT_BLOOM_ENABLED_ID, "");
		...
		earthSkyShadowMapSizeEditor = createStringFieldEditor(earthSkyGroup, ApogyEnvironmentSurfaceUIJME3PreferencesConstants.DEFAULT_SHADOW_MAP_SIZE_ID, "");
		...
		earthSkySunCastShadowsEnableEditor = createBooleanFieldEditor(earthSkyGroup, ApogyEnvironmentSurfaceUIJME3PreferencesConstants.DEFAULT_SUN_CAST_SHADOWS_ENABLED_ID, "");
