 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getMesh <em>Mesh</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getPointSize <em>Point Size</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getNumberOfPoints <em>Number Of Points</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getNumberOfPolygons <em>Number Of Polygons</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getPresentationMode <em>Presentation Mode</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getTransparency <em>Transparency</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#isUseShading <em>Use Shading</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.data3d.ui.impl.TriangularMeshPresentationImpl#getTextureImage <em>Texture Image</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TriangularMeshPresentationImpl extends NodePresentationImpl implements TriangularMeshPresentation {
	...
	protected EClass eStaticClass() {
		return Data3DUIPackage.Literals.TRIANGULAR_MESH_PRESENTATION;
	}
	...
	public void setPointSize(int newPointSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__POINT_SIZE, oldPointSize, pointSize));
	}
	...
	public CartesianTriangularMesh getMesh() {
		if (mesh != null && mesh.eIsProxy()) {
			...
			if (mesh != oldMesh) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__MESH, oldMesh, mesh));
			}
		}
		return mesh;
	}
	...
	public void setPresentationMode(MeshPresentationMode newPresentationMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__PRESENTATION_MODE, oldPresentationMode, presentationMode));
	}
	...
	public void setTransparency(float newTransparency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__TRANSPARENCY, oldTransparency, transparency));
	}
	...
	public void setUseShading(boolean newUseShading) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__USE_SHADING, oldUseShading, useShading));
	}
	...
	public AbstractEImage getTextureImage() {
		if (textureImage != null && textureImage.eIsProxy()) {
			...
			if (textureImage != oldTextureImage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__TEXTURE_IMAGE, oldTextureImage, textureImage));
			}
		}
		return textureImage;
	}
	...
	public void setTextureImage(AbstractEImage newTextureImage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__TEXTURE_IMAGE, oldTextureImage, textureImage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__MESH:
			...
			case Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__USE_SHADING:
				return isUseShading();
			case Data3DUIPackage.TRIANGULAR_MESH_PRESENTATION__TEXTURE_IMAGE:
