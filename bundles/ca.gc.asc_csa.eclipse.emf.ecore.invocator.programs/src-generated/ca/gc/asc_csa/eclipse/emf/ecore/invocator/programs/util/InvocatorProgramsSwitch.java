 ...
 * @generated
 */
public class InvocatorProgramsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public InvocatorProgramsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InvocatorProgramsPackage.ABSTRACT_PROGRAM_RUNTIME: {
