 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#getOrbitModel <em>Orbit Model</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#getTimeSource <em>Time Source</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#getTimeInterval <em>Time Interval</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#getForwardPropagationDuration <em>Forward Propagation Duration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#getBackwardPropagationDuration <em>Backward Propagation Duration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#isShowGroundTrace <em>Show Ground Trace</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.OrbitModelWorldWindLayerImpl#isShowOrbit <em>Show Orbit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
