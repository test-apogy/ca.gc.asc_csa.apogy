...
import ca.gc.asc_csa.symphony.environment.orbit.earth.ui.SpacecraftSwathWorldWindLayer;
import ca.gc.asc_csa.symphony.environment.orbit.earth.ui.SymphonyEarthOrbitEnvironmentUIPackage;
import ca.gc.asc_csa.symphony.environment.orbit.earth.ui.utils.WorldWindUtils;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getOrbitModel <em>Orbit Model</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getTimeSource <em>Time Source</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getForwardPropagationDuration <em>Forward Propagation Duration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getBackwardPropagationDuration <em>Backward Propagation Duration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getTimeInterval <em>Time Interval</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getLeftSwathAngle <em>Left Swath Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getRightSwathAngle <em>Right Swath Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#isShowGroundTrace <em>Show Ground Trace</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getForwardSpacecraftSwathCorridor <em>Forward Spacecraft Swath Corridor</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.earth.ui.impl.SpacecraftSwathWorldWindLayerImpl#getBackwardSpacecraftSwathCorridor <em>Backward Spacecraft Swath Corridor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
