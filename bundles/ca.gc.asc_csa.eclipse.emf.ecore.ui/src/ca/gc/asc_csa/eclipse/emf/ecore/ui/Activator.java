...
public class Activator extends AbstractUIPlugin 
{
	...
	// The plug-in ID
	public static final String ID = "ca.gc.asc_csa.eclipse.emf.ecore.ui"; //$NON-NLS-1$

	private static final String TIME_SOURCE_COMPOSITE_PROVIDER_POINT_ID = "ca.gc.asc_csa.eclipse.emf.ecore.ui.TimeSourceCompositeProvider";
