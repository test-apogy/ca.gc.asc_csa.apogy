...
import ca.gc.asc_csa.apogy.common.geometry.data3d.ui.jme3.scene_objects.ColoredCartesianTriangularMeshJM3SceneObject;
...
/**
 * JME3 Adapter for ContentNode<ColoredCartesianTriangularMesh> nodes.
 * @author pallard
 */
public class ColoredCartesianTriangularMeshJME3Adapter implements JME3Adapter {
	...
	public JME3SceneObject getAdapter(Node obj, Object context) {
		...
		if (isAdapterFor(obj)) 
		{
			...
			ContentNode<ColoredCartesianTriangularMesh> cNode = (ContentNode<ColoredCartesianTriangularMesh>) obj;
						
			sceneObject = new ColoredCartesianTriangularMeshJM3SceneObject(cNode, (JME3RenderEngineDelegate) context);
		}
