...
public class WatchImpl extends MinimalEObjectImpl.Container implements Watch
{
  ...
  {
		return Symphony__CoreInvocatorPackage.Literals.WATCH;
	}
  ...
  /**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__NAME, oldName, name));
	}
  ...
  public void setDescription(String newDescription)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__DESCRIPTION, oldDescription, description));
	}
  ...
  {
		if (eContainerFeatureID() != Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST) return null;
  ...
  {
		msgs = eBasicSetContainer((InternalEObject)newWatchesList, Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST, msgs);
		return msgs;
	}
  ...
  {
		if (newWatchesList != eInternalContainer() || (eContainerFeatureID() != Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST && newWatchesList != null)) {
			...
			if (newWatchesList != null)
				msgs = ((InternalEObject)newWatchesList).eInverseAdd(this, Symphony__CoreInvocatorPackage.WATCHES_LIST__WATCHES, WatchesList.class, msgs);
			msgs = basicSetWatchesList(newWatchesList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST, newWatchesList, newWatchesList));
	}
  ...
  public Variable getVariable()
  {
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Symphony__CoreInvocatorPackage.WATCH__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
  ...
  public void setVariableGen(Variable newVariable)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__VARIABLE, oldVariable, variable));
	}
  ...
  public NotificationChain basicSetTypeMemberReferenceTreeElement(TypeMemberReferenceTreeElement newTypeMemberReferenceTreeElement, NotificationChain msgs)
  {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT, oldTypeMemberReferenceTreeElement, newTypeMemberReferenceTreeElement);
  ...
  public void setTypeMemberReferenceTreeElement(TypeMemberReferenceTreeElement newTypeMemberReferenceTreeElement)
  {
		if (newTypeMemberReferenceTreeElement != typeMemberReferenceTreeElement) {
			...
			if (typeMemberReferenceTreeElement != null)
				msgs = ((InternalEObject)typeMemberReferenceTreeElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CoreInvocatorPackage.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT, null, msgs);
			if (newTypeMemberReferenceTreeElement != null)
				msgs = ((InternalEObject)newTypeMemberReferenceTreeElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CoreInvocatorPackage.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT, null, msgs);
			msgs = basicSetTypeMemberReferenceTreeElement(newTypeMemberReferenceTreeElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT, newTypeMemberReferenceTreeElement, newTypeMemberReferenceTreeElement));
	}
...
//	  }
  ...
  /**
	...
	public NotificationChain basicSetTreeRootNode(TreeRootNode newTreeRootNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__TREE_ROOT_NODE, oldTreeRootNode, newTreeRootNode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTreeRootNode(TreeRootNode newTreeRootNode) {
		if (newTreeRootNode != treeRootNode) {
			...
			if (treeRootNode != null)
				msgs = ((InternalEObject)treeRootNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CoreInvocatorPackage.WATCH__TREE_ROOT_NODE, null, msgs);
			if (newTreeRootNode != null)
				msgs = ((InternalEObject)newTreeRootNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CoreInvocatorPackage.WATCH__TREE_ROOT_NODE, null, msgs);
			msgs = basicSetTreeRootNode(newTreeRootNode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CoreInvocatorPackage.WATCH__TREE_ROOT_NODE, newTreeRootNode, newTreeRootNode));
	}
  ...
  {
		switch (featureID) {
			case Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
		switch (eContainerFeatureID()) {
			case Symphony__CoreInvocatorPackage.WATCH__WATCHES_LIST:
				return eInternalContainer().eInverseRemove(this, Symphony__CoreInvocatorPackage.WATCHES_LIST__WATCHES, WatchesList.class, msgs);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (derivedFeatureID) {
				case Symphony__CoreInvocatorPackage.WATCH__DESCRIPTION: return Symphony__CommonEMFPackage.DESCRIBED__DESCRIPTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (baseFeatureID) {
				case Symphony__CommonEMFPackage.DESCRIBED__DESCRIPTION: return Symphony__CoreInvocatorPackage.WATCH__DESCRIPTION;
				default: return -1;
			}
		}
