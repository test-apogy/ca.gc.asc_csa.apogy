 ...
 */
public interface SystemsTopologyAdapterValidator {
	boolean validate();

	boolean validateDeployment(ApogyEnvironment value);
	boolean validateSystemsGroup(ReferencedGroupNode value);
}
