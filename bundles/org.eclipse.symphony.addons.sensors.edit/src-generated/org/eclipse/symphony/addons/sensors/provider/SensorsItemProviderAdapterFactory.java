 ...
 * @generated
 */
public class SensorsItemProviderAdapterFactory extends SensorsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(SensorsEditPlugin.INSTANCE, SensorsPackage.eNS_URI);
		...
		protected static class CreationSwitch extends TopologySwitch<Object> {
			...
			public <T> Object caseContentNode(ContentNode<T> object) {
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 SensorsFactory.eINSTANCE.createReferenceable()));
