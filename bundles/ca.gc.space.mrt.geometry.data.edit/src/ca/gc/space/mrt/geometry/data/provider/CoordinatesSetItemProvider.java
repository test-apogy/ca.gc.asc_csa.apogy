...
import ca.gc.space.mrt.geometry.data.DataFactory;
import ca.gc.space.mrt.geometry.data.DataPackage;

/**
 * This is the item provider adapter for a {@link ca.gc.space.mrt.geometry.data.CoordinatesSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoordinatesSetItemProvider
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public CoordinatesSetItemProvider(AdapterFactory adapterFactory)
	{
	...
	/**
	 * This returns CoordinatesSet.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CoordinatesSet"));
	}
	...
	{
		List labelValue = ((CoordinatesSet<?>)object).getNormals();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_CoordinatesSet_type") :
			getString("_UI_CoordinatesSet_type") + " " + label;
	}
