 ...
 * @generated
 */
public class RangeSensorsUIPackageImpl extends EPackageImpl implements RangeSensorsUIPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.symphony.addons.sensors.range.ui.RangeSensorsUIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RangeSensorsUIPackageImpl() {
		super(eNS_URI, RangeSensorsUIFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RangeSensorsUIPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RangeSensorsUIPackage init() {
		if (isInited) return (RangeSensorsUIPackage)EPackage.Registry.INSTANCE.getEPackage(RangeSensorsUIPackage.eNS_URI);

		// Obtain or create and register package
		RangeSensorsUIPackageImpl theRangeSensorsUIPackage = (RangeSensorsUIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RangeSensorsUIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RangeSensorsUIPackageImpl());
		...
		theRangeSensorsUIPackage.createPackageContents();

		// Initialize created meta-data
		theRangeSensorsUIPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRangeSensorsUIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RangeSensorsUIPackage.eNS_URI, theRangeSensorsUIPackage);
		return theRangeSensorsUIPackage;
	}
	 ...
	 * @generated
	 */
	public RangeSensorsUIFactory getRangeSensorsUIFactory() {
		return (RangeSensorsUIFactory)getEFactoryInstance();
	}
