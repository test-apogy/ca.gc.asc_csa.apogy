...
public class ImagingUtilitiesImpl extends MinimalEObjectImpl.Container implements ImagingUtilities 
{
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyAddonsSensorsImagingPackage.IMAGING_UTILITIES___LINEAR_CONVERT_TO_HORIZONTAL_ANGLE__IMAGESNAPSHOT_INT:
				return linearConvertToHorizontalAngle((ImageSnapshot)arguments.get(0), (Integer)arguments.get(1));
			case ApogyAddonsSensorsImagingPackage.IMAGING_UTILITIES___LINEAR_CONVERT_TO_VERTICAL_ANGLE__IMAGESNAPSHOT_INT:
				return linearConvertToVerticalAngle((ImageSnapshot)arguments.get(0), (Integer)arguments.get(1));
			case ApogyAddonsSensorsImagingPackage.IMAGING_UTILITIES___GET_AZIMUTH_ELEVATION_OVERLAY__INT_INT_DOUBLE_DOUBLE_DOUBLE_DOUBLE_AZIMUTHDIRECTION_ELEVATIONDIRECTION_INT_STRING_INT_COLOR_COLOR_INT:
