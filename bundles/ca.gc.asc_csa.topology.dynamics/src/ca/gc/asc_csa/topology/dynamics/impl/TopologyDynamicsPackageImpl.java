...
import static ca.gc.asc_csa.topology.dynamics.TopologyDynamicsPackage.CLASS;
...
public class TopologyDynamicsPackageImpl extends EPackageImpl implements TopologyDynamicsPackage {
	 ...
	 * @see ca.gc.asc_csa.topology.dynamics.TopologyDynamicsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getDynamicSystemProperties_Contraints() {
	 ...
	 * @generated
	 */
	public EAttribute getAbstractConstraint_Id() {
	 ...
	 * @generated
	 */
	public EAttribute getConstraintAttachmentPoint_Id() {
	 ...
	 * @generated
	 */
	public EAttribute getCollisionGeometry_Id() {
	 ...
	 * @generated
	 */
	public EAttribute getAbstractMaterial_Id() {
	...
	public void createPackageContents() {
		...
		createEReference(dynamicSystemPropertiesEClass, DYNAMIC_SYSTEM_PROPERTIES__CONTRAINTS);
		...
		createEAttribute(abstractConstraintEClass, ABSTRACT_CONSTRAINT__ID);
		...
		createEAttribute(constraintAttachmentPointEClass, CONSTRAINT_ATTACHMENT_POINT__ID);
		...
		createEAttribute(collisionGeometryEClass, COLLISION_GEOMETRY__ID);

		abstractMaterialEClass = createEClass(ABSTRACT_MATERIAL);
		createEAttribute(abstractMaterialEClass, ABSTRACT_MATERIAL__ID);
	...
	public void initializePackageContents() {
		...
		initEReference(getDynamicSystemProperties_Contraints(), this.getAbstractConstraint(), null, "contraints", null, 0, -1, DynamicSystemProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPhysicalProperties_Mass(), ecorePackage.getEDouble(), "mass", null, 0, 1, PhysicalProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAbstractConstraint_Description(), ecorePackage.getEString(), "description", null, 0, 1, AbstractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractConstraint_Id(), ecorePackage.getEString(), "id", null, 0, 1, AbstractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAbstractConstraint_Enabled(), ecorePackage.getEBoolean(), "enabled", "false", 0, 1, AbstractConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getConstraintState_Position(), ecorePackage.getEDouble(), "position", null, 0, 1, ConstraintState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraintState_Velocity(), ecorePackage.getEDouble(), "velocity", null, 0, 1, ConstraintState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraintState_Force(), ecorePackage.getEDouble(), "force", null, 0, 1, ConstraintState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGearRatioConstraint_Force(), ecorePackage.getEDouble(), "force", null, 0, 1, GearRatioConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getConstraintAttachmentPoint_Description(), ecorePackage.getEString(), "description", null, 0, 1, ConstraintAttachmentPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConstraintAttachmentPoint_Id(), ecorePackage.getEString(), "id", null, 0, 1, ConstraintAttachmentPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCollisionGeometry_Description(), ecorePackage.getEString(), "description", null, 0, 1, CollisionGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCollisionGeometry_Id(), ecorePackage.getEString(), "id", null, 0, 1, CollisionGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAbstractMaterial_Id(), ecorePackage.getEString(), "id", null, 0, 1, AbstractMaterial.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCapsuleGeometry_Radius(), ecorePackage.getEDouble(), "radius", null, 0, 1, CapsuleGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCapsuleGeometry_Length(), ecorePackage.getEDouble(), "length", null, 0, 1, CapsuleGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCylinderGeometry_Radius(), ecorePackage.getEDouble(), "radius", null, 0, 1, CylinderGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCylinderGeometry_Length(), ecorePackage.getEDouble(), "length", null, 0, 1, CylinderGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sphereGeometryEClass, SphereGeometry.class, "SphereGeometry", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSphereGeometry_Radius(), ecorePackage.getEDouble(), "radius", null, 0, 1, SphereGeometry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getDynamicsFacade__FindTotalMass__Node(), ecorePackage.getEDouble(), "findTotalMass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theTopologyPackage.getNode(), "root", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		EGenericType g1 = createEGenericType(this.getAbstractPhysicalBodySimulationProperties());
		...
		g2 = createEGenericType(this.getPhysicalBody());
		g1.getETypeArguments().add(g2);
		initEOperation(op, g1);
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (getDynamicSystemProperties_Contraints(), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (getPhysicalBody_SimulationProperties(), 
		   source, 
		   new String[] {
			 "documentation", "The list of simulation properties associated with this body. Note that this list can contain items for different implementation of Dynamic Engine."
		   });		
		addAnnotation
		...
		addAnnotation
		  (getAbstractConstraint_SimulationProperties(), 
		   source, 
		   new String[] {
			 "documentation", "The list of simulation properties associated with this constraint. Note that this list can contain items for different implementation of Dynamic Engine."
		   });		
		addAnnotation
		...
		addAnnotation
		  (getConstraintState_Position(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (getConstraintState_Velocity(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (getConstraintState_Force(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		...
		addAnnotation
		  (getCylindricalConstraint_AngularCurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (getCylindricalConstraint_LinearCurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (gearRatioConstraintEClass, 
		   source, 
		   new String[] {
			 "documentation", "This constraint is a velocity-based constraint that constrains the velocity of a body relative to its primary attachment axis to the velocity of another body relative to its primary attachment axis."
		   });		
		addAnnotation
		  (getGearRatioConstraint_Force(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		...
		addAnnotation
		  (getHingeConstraint_AngularCurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		...
		addAnnotation
		  (getPrismaticConstraint_LinearCurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (rproConstraintEClass, 
		   source, 
		   new String[] {
			 "documentation", "(Relative Position Relative Orientation) is a constraint used to fix two parts with a given distance and orientation. Both linear and angular strengths describes the forces needed to respect this constraint."
		   });		
		addAnnotation
		  (getRPROConstraint_LinearStrength(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (getRPROConstraint_AngularStrength(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		...
		addAnnotation
		  (getUniversalConstraint_Angular0CurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		addAnnotation
		  (getUniversalConstraint_Angular1CurrentState(), 
		   source, 
		   new String[] {
			 "documentation", "TODO"
		   });		
		...
		addAnnotation
		  (getConstraintAttachmentPoint_Transform(), 
		   source, 
		   new String[] {
			 "documentation", "The transform expressiong the position of the ConstraintAttachmentPoint expressed in the PhysicalBody reference frame."
		   });		
		addAnnotation
		...
		addAnnotation
		  (getConstraintAttachmentPoint_Id(), 
		   source, 
		   new String[] {
		...
		addAnnotation
		  (capsuleGeometryEClass, 
		   source, 
		   new String[] {
			 "documentation", "The capsule is like a cylinder with rounded extremities. The shape is defined by the radius of the capsule (width) and its length (from one rounded extremity to the other)."
		   });		
		addAnnotation
		...
		addAnnotation
		  (abstractConstraintSimulationPropertiesEClass, 
		   source, 
		   new String[] {
			 "documentation", "Abstract base class used to represent constraint properties that are specific to a particular simulation engine."
		   });		
		addAnnotation
		...
		addAnnotation
		  ((getDynamicsFacade__FindCenterOfMass__Node()).getEParameters().get(0), 
		   source, 
		   new String[] {
			 "documentation", "The root of the topology for which the position of the center of mass is to be computed."
		   });		
		addAnnotation
		...
		addAnnotation
		  ((getDynamicsFacade__FindTotalMass__Node()).getEParameters().get(0), 
		   source, 
		   new String[] {
			 "documentation", "The root of the topology for which the total mass is to be computed."
		   });		
		addAnnotation
		  (getDynamicsFacade__GetPhysicalBodies__Node(), 
		   source, 
		   new String[] {
			 "documentation", "Given a node in a topology, traverse the tree and extracts the Set of RigidBody defined in the topology."
		   });
	}
