 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.RPROConstraintImpl#getLinearStrength <em>Linear Strength</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.RPROConstraintImpl#getAngularStrength <em>Angular Strength</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RPROConstraintImpl extends AbstractConstraintImpl implements RPROConstraint {
	...
	protected EClass eStaticClass() {
		return TopologyDynamicsPackage.Literals.RPRO_CONSTRAINT;
	}
		...
		if (linearStrength != null && linearStrength.eIsProxy()) {
			...
			if (linearStrength != oldLinearStrength) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TopologyDynamicsPackage.RPRO_CONSTRAINT__LINEAR_STRENGTH, oldLinearStrength, linearStrength));
			}
		}
	...
	public void setLinearStrength(Tuple3d newLinearStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyDynamicsPackage.RPRO_CONSTRAINT__LINEAR_STRENGTH, oldLinearStrength, linearStrength));
	}
	...
	public Tuple3d getAngularStrength() {
		if (angularStrength != null && angularStrength.eIsProxy()) {
			...
			if (angularStrength != oldAngularStrength) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TopologyDynamicsPackage.RPRO_CONSTRAINT__ANGULAR_STRENGTH, oldAngularStrength, angularStrength));
			}
		}
	...
	public void setAngularStrength(Tuple3d newAngularStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyDynamicsPackage.RPRO_CONSTRAINT__ANGULAR_STRENGTH, oldAngularStrength, angularStrength));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TopologyDynamicsPackage.RPRO_CONSTRAINT__LINEAR_STRENGTH:
				if (resolve) return getLinearStrength();
				return basicGetLinearStrength();
			case TopologyDynamicsPackage.RPRO_CONSTRAINT__ANGULAR_STRENGTH:
