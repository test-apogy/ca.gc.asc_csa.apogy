 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getPhysicalProperties <em>Physical Properties</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getConstraintAttachmentPoints <em>Constraint Attachment Points</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getSimulationProperties <em>Simulation Properties</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getCenterOfMassKinematicState <em>Center Of Mass Kinematic State</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getPointsOfInterest <em>Points Of Interest</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.PhysicalBodyImpl#getCollisionGeometry <em>Collision Geometry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
