 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.CylinderGeometryImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.CylinderGeometryImpl#getLength <em>Length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CylinderGeometryImpl extends GeometryImpl implements CylinderGeometry {
	...
	protected EClass eStaticClass() {
		return TopologyDynamicsPackage.Literals.CYLINDER_GEOMETRY;
	}
	...
	public void setRadius(double newRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyDynamicsPackage.CYLINDER_GEOMETRY__RADIUS, oldRadius, radius));
	}
	...
	public void setLength(double newLength) {
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TopologyDynamicsPackage.CYLINDER_GEOMETRY__LENGTH, oldLength, length));
	}
