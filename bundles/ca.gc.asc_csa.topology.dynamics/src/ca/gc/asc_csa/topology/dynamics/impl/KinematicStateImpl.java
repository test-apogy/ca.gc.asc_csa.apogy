 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getLinearVelocity <em>Linear Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getAngularVelocity <em>Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getLinearAcceleration <em>Linear Acceleration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.dynamics.impl.KinematicStateImpl#getAngularAcceleration <em>Angular Acceleration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class KinematicStateImpl extends EObjectImpl implements KinematicState {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
