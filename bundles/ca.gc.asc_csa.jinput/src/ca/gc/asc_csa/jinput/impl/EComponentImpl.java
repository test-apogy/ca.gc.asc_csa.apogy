 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getDeadZone <em>Dead Zone</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#isRelative <em>Relative</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#isAnalog <em>Analog</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getPojoComponent <em>Pojo Component</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getPollData <em>Poll Data</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.impl.EComponentImpl#getEComponents <em>EComponents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
