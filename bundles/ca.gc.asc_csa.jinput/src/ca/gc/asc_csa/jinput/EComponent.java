 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getDeadZone <em>Dead Zone</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#isRelative <em>Relative</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#isAnalog <em>Analog</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getPojoComponent <em>Pojo Component</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getPollData <em>Poll Data</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EComponent#getEComponents <em>EComponents</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent()
 * @model
 * @generated
 */
public interface EComponent extends EObject {
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_DeadZone()
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_Identifier()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_Relative()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	boolean isRelative();
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_Analog()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	boolean isAnalog();
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_Name()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	String getName();
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_PojoComponent()
	 * @model dataType="ca.gc.asc_csa.jinput.Component"
	 * @generated
	 */
	Component getPojoComponent();

	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EComponent#getPojoComponent <em>Pojo Component</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_PollData()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	float getPollData();
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.jinput.EComponents#getComponents <em>Components</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEComponent_EComponents()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EComponent#getEComponents <em>EComponents</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
