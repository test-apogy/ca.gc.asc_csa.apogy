 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#isLastPollResult <em>Last Poll Result</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getPortNumber <em>Port Number</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getType <em>Type</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getPortType <em>Port Type</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getPojoController <em>Pojo Controller</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getEComponents <em>EComponents</em>}</li>
 *   <li>{@link ca.gc.asc_csa.jinput.EController#getControllerCount <em>Controller Count</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController()
 * @model
 * @generated
 */
public interface EController extends EObject {
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_LastPollResult()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EController#isLastPollResult <em>Last Poll Result</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_Name()
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_PortNumber()
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_Type()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	String getType();
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_PortType()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	String getPortType();
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_PojoController()
	 * @model dataType="ca.gc.asc_csa.jinput.Controller"
	 * @generated
	 */
	Controller getPojoController();

	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EController#getPojoController <em>Pojo Controller</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.jinput.EComponents#getEController <em>EController</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_EComponents()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EController#getEComponents <em>EComponents</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.jinput.JInputPackage#getEController_ControllerCount()
	 * @model default="-1"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.jinput.EController#getControllerCount <em>Controller Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
