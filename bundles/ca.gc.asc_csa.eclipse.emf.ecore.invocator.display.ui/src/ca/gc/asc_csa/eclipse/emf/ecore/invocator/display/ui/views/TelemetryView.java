package ca.gc.asc_csa.eclipse.emf.ecore.invocator.display.ui.views;
...
import ca.gc.asc_csa.eclipse.emf.ecore.invocator.display.ui.composites.DisplaysListComposite;

public class TelemetryView extends ViewPart implements ISelectionListener 
{
	public static String partName = "Telemetry View";
	public static String ID = "ca.gc.asc_csa.eclipse.emf.ecore.invocator.display.ui.views.TelemetryView";
