 ...
 *
 * $Id: DataPackageImpl.java,v 1.6.4.3 2015/09/22 19:39:40 rlarcheveque Exp $
 */
...
public class DataPackageImpl extends EPackageImpl implements DataPackage
{
	 ...
	 * @see ca.gc.space.mrt.geometry.data.DataPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  ...
  /**
	...
	public void initializePackageContents()
	{
		...
		op = initEOperation(getCoordinatesSamplingShape__IsInside__Coordinates(), ecorePackage.getEBoolean(), "isInside", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getPolygonSamplingShape__IsPolygonInside__Polygon(), ecorePackage.getEBoolean(), "isPolygonInside", 0, 1, IS_UNIQUE, IS_ORDERED);
