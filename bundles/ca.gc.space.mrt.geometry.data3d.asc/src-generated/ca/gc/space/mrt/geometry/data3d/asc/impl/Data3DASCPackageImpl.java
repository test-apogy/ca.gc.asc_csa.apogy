 ...
 * @generated
 */
public class Data3DASCPackageImpl extends EPackageImpl implements Data3DASCPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private Data3DASCPackageImpl() {
		super(eNS_URI, Data3DASCFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Data3DASCPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Data3DASCPackage init() {
		if (isInited) return (Data3DASCPackage)EPackage.Registry.INSTANCE.getEPackage(Data3DASCPackage.eNS_URI);

		// Obtain or create and register package
		Data3DASCPackageImpl theData3DASCPackage = (Data3DASCPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Data3DASCPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Data3DASCPackageImpl());
		...
		theData3DASCPackage.createPackageContents();

		// Initialize created meta-data
		theData3DASCPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theData3DASCPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Data3DASCPackage.eNS_URI, theData3DASCPackage);
		return theData3DASCPackage;
	}
	 ...
	 * @generated
	 */
	public Data3DASCFactory getData3DASCFactory() {
		return (Data3DASCFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(asc3DIOEClass, ca.gc.space.mrt.geometry.data3d.asc.ASC3DIO.class, "ASC3DIO", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		EOperation op = initEOperation(getASC3DIO__LoadDigitalElevationMap__String_AltitudeMode(), theData3dPackage.getDigitalElevationMap(), "loadDigitalElevationMap", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getASC3DIO__LoadDigitalElevationMap__String_AltitudeMode_double(), theData3dPackage.getDigitalElevationMap(), "loadDigitalElevationMap", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEDouble(), "targetResolution", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEException(op, this.getException());

		op = initEOperation(getASC3DIO__LoadDigitalElevationMap__String_AltitudeMode_Coordinates2D_Coordinates2D(), theData3dPackage.getDigitalElevationMap(), "loadDigitalElevationMap", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getASC3DIO__LoadDigitalElevationMap__String_AltitudeMode_Coordinates2D_Coordinates2D_double(), theData3dPackage.getDigitalElevationMap(), "loadDigitalElevationMap", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "southWestCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "northEastCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getASC3DIO__LoadTriangularMesh__String_AltitudeMode(), theData3dPackage.getCartesianTriangularMesh(), "loadTriangularMesh", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEException(op, this.getException());

		op = initEOperation(getASC3DIO__LoadTriangularMesh__String_AltitudeMode_double(), theData3dPackage.getCartesianTriangularMesh(), "loadTriangularMesh", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEDouble(), "targetResolution", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEException(op, this.getException());

		op = initEOperation(getASC3DIO__LoadTriangularMesh__String_AltitudeMode_Coordinates2D_Coordinates2D(), theData3dPackage.getCartesianTriangularMesh(), "loadTriangularMesh", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "southWestCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "northEastCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getASC3DIO__LoadTriangularMesh__String_AltitudeMode_Coordinates2D_Coordinates2D_double(), theData3dPackage.getCartesianTriangularMesh(), "loadTriangularMesh", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getEString(), "file", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getAltitudeMode(), "altitudeMode", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "southWestCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getCoordinates2D(), "northEastCorner", 0, 1, !IS_UNIQUE, IS_ORDERED);
