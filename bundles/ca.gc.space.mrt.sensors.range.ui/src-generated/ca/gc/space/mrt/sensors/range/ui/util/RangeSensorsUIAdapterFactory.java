 ...
 * @generated
 */
public class RangeSensorsUIAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public RangeSensorsUIAdapterFactory() {
	 ...
	 * @generated
	 */
	protected RangeSensorsUISwitch<Adapter> modelSwitch =
		new RangeSensorsUISwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseSimpleSonarPresentation(SimpleSonarPresentation object) {
				return createSimpleSonarPresentationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.sensors.range.ui.RasterScanDataPresentation <em>Raster Scan Data Presentation</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.sensors.range.ui.SimpleSonarPresentation <em>Simple Sonar Presentation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
