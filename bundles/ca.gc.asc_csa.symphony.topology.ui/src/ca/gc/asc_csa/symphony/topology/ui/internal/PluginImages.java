 ...
 *******************************************************************************/
package ca.gc.asc_csa.symphony.topology.ui.internal;
...
public class PluginImages {
	...
	private static void declareImages() {
		...
		// Enabled
		declareRegistryImage(IConstants.IMG_ELCL_NEW_TOPO_VIEW, ELCL
				+ "new_con.gif"); //$NON-NLS-1$		
		declareRegistryImage(IConstants.IMG_ELCL_PIN, ELCL + "pin.gif"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_DISPLAY_3D_AXIS, ELCL
				+ "Photoshop3DAxis.png"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_ANTIALIASING, ELCL
				+ "anti_aliasing_filter_icon.jpg"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_VIEWPOINT, ELCL + "test.png"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_CAMERA, ELCL
				+ "camera-lens.png"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_ARBITRARY, ELCL
				+ "layer-shape-polygon.png"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_ELCL_ZOOM_TO_FIT, ELCL
				+ "Gnome-Zoom-Fit-Best-16.png"); //$NON-NLS-1$

		// Disabled
		declareRegistryImage(IConstants.IMG_DLCL_PIN, DLCL + "pin.gif"); //$NON-NLS-1$
		declareRegistryImage(IConstants.IMG_DLCL_DISPLAY_3D_AXIS, DLCL
				+ "Photoshop3DAxis.png"); //$NON-NLS-1$
