package ca.gc.asc_csa.symphony.topology.ui;
...
import ca.gc.asc_csa.symphony.topology.ui.preferences.SymphonyTopologyUIPreferencesConstants;
...
{		
	// The plug-in ID
	public static final String ID = "ca.gc.asc_csa.symphony.topology.ui"; //$NON-NLS-1$
