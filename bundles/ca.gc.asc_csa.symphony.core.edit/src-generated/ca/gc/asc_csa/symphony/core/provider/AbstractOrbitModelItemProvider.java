...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.core.AbstractOrbitModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractOrbitModelItemProvider 
	 ...
	 * @generated
	 */
	public AbstractOrbitModelItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOrbitModelsListPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Orbit Models List feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOrbitModelsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	public String getText(Object object) {
		String label = ((AbstractOrbitModel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractOrbitModel_type") :
			getString("_UI_AbstractOrbitModel_type") + " " + label;
	}
