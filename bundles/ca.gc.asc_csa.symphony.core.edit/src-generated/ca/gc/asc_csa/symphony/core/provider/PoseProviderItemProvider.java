...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.core.PoseProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PoseProviderItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public PoseProviderItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PoseProvider"));
	}
  ...
  {
		return getString("_UI_PoseProvider_type");
	}
