...
public class ControllerComponentWizardPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public ControllerComponentWizardPage() {
	...
	public void createControl(Composite parent) {
		...
		newProgramComposite.getTreeViewerGroups().addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				ControllerComponentWizardPage.this.programsGroup = (ProgramsGroup) ((StructuredSelection) event.getSelection()).getFirstElement();
				validate();
			}
		});
		newProgramComposite.getTreeViewerTypes().addSelectionChangedListener(new ISelectionChangedListener() {
			...
			@Override
			public void selectionChanged(SelectionChangedEvent event) {
				ControllerComponentWizardPage.this.programsType = (EClass) ((StructuredSelection) event.getSelection()).getFirstElement();
				System.out.println(
