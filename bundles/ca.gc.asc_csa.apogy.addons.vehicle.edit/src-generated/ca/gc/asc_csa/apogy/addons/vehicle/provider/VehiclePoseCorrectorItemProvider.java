...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.addons.vehicle.VehiclePoseCorrector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  extends PoseCorrectorItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__INITIALIZING,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__MESHES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__CONTACT_BODIES,
				 false,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__ZCORRECTION_MODE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__ZCORRECTION,
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__ORIENTATION_CORRECTION,
				 false,
				 false,
				 true,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__MESHES);
			childrenFeatures.add(ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__CONTACT_PROVIDER);
		}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApogyAddonsVehiclePackage.Literals.VEHICLE_POSE_CORRECTOR__CONTACT_PROVIDER,
