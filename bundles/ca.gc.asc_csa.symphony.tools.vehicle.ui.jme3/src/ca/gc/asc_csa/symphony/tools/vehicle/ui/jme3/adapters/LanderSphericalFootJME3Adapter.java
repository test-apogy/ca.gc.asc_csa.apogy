...
import ca.gc.asc_csa.symphony.tools.vehicle.ui.jme3.scene_objects.LanderSphericalFootJME3Object;
import ca.gc.asc_csa.topology.ui.jme3.JME3Adapter;
import ca.gc.asc_csa.topology.ui.jme3.JME3RenderEngineDelegate;
import ca.gc.asc_csa.topology.ui.jme3.JME3SceneObject;
import ca.gc.space.topology.Node;

public class LanderSphericalFootJME3Adapter implements JME3Adapter {
	...
	public JME3SceneObject getAdapter(Node obj, Object context) {
		...
		if (isAdapterFor(obj)) 
		{
			...
			sceneObject = new LanderSphericalFootJME3Object((LanderSphericalFoot) obj, (JME3RenderEngineDelegate) context);
		}
