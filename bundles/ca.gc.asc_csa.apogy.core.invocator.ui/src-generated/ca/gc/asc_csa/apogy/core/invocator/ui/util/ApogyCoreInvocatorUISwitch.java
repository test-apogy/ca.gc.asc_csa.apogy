...
public class ApogyCoreInvocatorUISwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ApogyCoreInvocatorUIPackage.PROGRAM_ARGUMENTS_PART_SELECTION: {
				ProgramArgumentsPartSelection programArgumentsPartSelection = (ProgramArgumentsPartSelection)theEObject;
				T result = caseProgramArgumentsPartSelection(programArgumentsPartSelection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ApogyCoreInvocatorUIPackage.VARIABLE_RUNTIME_PART_SELECTION: {
				VariableRuntimePartSelection variableRuntimePartSelection = (VariableRuntimePartSelection)theEObject;
				T result = caseVariableRuntimePartSelection(variableRuntimePartSelection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program Arguments Part Selection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program Arguments Part Selection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramArgumentsPartSelection(ProgramArgumentsPartSelection object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Variable Runtime Part Selection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Variable Runtime Part Selection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVariableRuntimePartSelection(VariableRuntimePartSelection object) {
		return null;
	}
