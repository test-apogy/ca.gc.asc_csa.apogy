...
public class DynamicSystemPropertiesImpl extends AggregateGroupNodeImpl implements DynamicSystemProperties {
	...
	public EList<AbstractConstraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<AbstractConstraint>(AbstractConstraint.class, this, TopologyDynamicsPackage.DYNAMIC_SYSTEM_PROPERTIES__CONSTRAINTS);
		}
		return constraints;
	}
