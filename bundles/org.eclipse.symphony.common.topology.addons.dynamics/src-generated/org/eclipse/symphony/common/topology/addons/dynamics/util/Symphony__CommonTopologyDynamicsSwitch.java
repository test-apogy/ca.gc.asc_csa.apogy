 ...
 * @generated
 */
public class Symphony__CommonTopologyDynamicsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Symphony__CommonTopologyDynamicsPackage modelPackage;
	 ...
	 * @generated
	 */
	public Symphony__CommonTopologyDynamicsSwitch() {
		if (modelPackage == null) {
			modelPackage = Symphony__CommonTopologyDynamicsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Symphony__CommonTopologyDynamicsPackage.DYNAMIC_SYSTEM_PROPERTIES: {
			...
			case Symphony__CommonTopologyDynamicsPackage.ABSTRACT_DYNAMICS_ENGINE: {
			...
			case Symphony__CommonTopologyDynamicsPackage.PHYSICAL_BODY: {
			...
			case Symphony__CommonTopologyDynamicsPackage.PHYSICAL_PROPERTIES: {
				PhysicalProperties physicalProperties = (PhysicalProperties)theEObject;
				T result = casePhysicalProperties(physicalProperties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Symphony__CommonTopologyDynamicsPackage.ABSTRACT_PHYSICAL_BODY_SIMULATION_PROPERTIES: {
			...
			case Symphony__CommonTopologyDynamicsPackage.ABSTRACT_CONSTRAINT_SIMULATION_PROPERTIES: {
			...
			case Symphony__CommonTopologyDynamicsPackage.ABSTRACT_COLLISION_GEOMETRY_SIMULATION_PROPERTIES: {
			...
			case Symphony__CommonTopologyDynamicsPackage.GEAR_RATIO_CONSTRAINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.HINGE_CONSTRAINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.PRISMATIC_CONSTRAINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.RPRO_CONSTRAINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.UNIVERSAL_CONSTRAINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.CONSTRAINT_ATTACHMENT_POINT: {
			...
			case Symphony__CommonTopologyDynamicsPackage.CAPSULE_GEOMETRY: {
			...
			case Symphony__CommonTopologyDynamicsPackage.CYLINDER_GEOMETRY: {
			...
			case Symphony__CommonTopologyDynamicsPackage.SPHERE_GEOMETRY: {
			...
			case Symphony__CommonTopologyDynamicsPackage.DYNAMICS_FACADE: {
...
} //Symphony__CommonTopologyDynamicsSwitch
