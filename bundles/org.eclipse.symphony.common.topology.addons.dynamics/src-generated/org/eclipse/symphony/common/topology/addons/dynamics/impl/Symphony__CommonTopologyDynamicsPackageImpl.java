 ...
 * </copyright>
 *
 * $Id: Symphony__CommonTopologyDynamicsPackageImpl.java,v 1.29.2.2 2015/02/03 20:01:36 rlarcheveque Exp $
 */
 ...
 * @generated
 */
public class Symphony__CommonTopologyDynamicsPackageImpl extends EPackageImpl implements Symphony__CommonTopologyDynamicsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.symphony.common.topology.addons.dynamics.Symphony__CommonTopologyDynamicsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Symphony__CommonTopologyDynamicsPackageImpl() {
		super(eNS_URI, Symphony__CommonTopologyDynamicsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Symphony__CommonTopologyDynamicsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Symphony__CommonTopologyDynamicsPackage init() {
		if (isInited) return (Symphony__CommonTopologyDynamicsPackage)EPackage.Registry.INSTANCE.getEPackage(Symphony__CommonTopologyDynamicsPackage.eNS_URI);

		// Obtain or create and register package
		Symphony__CommonTopologyDynamicsPackageImpl theSymphony__CommonTopologyDynamicsPackage = (Symphony__CommonTopologyDynamicsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Symphony__CommonTopologyDynamicsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Symphony__CommonTopologyDynamicsPackageImpl());
		...
		theSymphony__CommonTopologyDynamicsPackage.createPackageContents();

		// Initialize created meta-data
		theSymphony__CommonTopologyDynamicsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSymphony__CommonTopologyDynamicsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Symphony__CommonTopologyDynamicsPackage.eNS_URI, theSymphony__CommonTopologyDynamicsPackage);
		return theSymphony__CommonTopologyDynamicsPackage;
	}
	 ...
	 * @generated
	 */
	public Symphony__CommonTopologyDynamicsFactory getSymphony__CommonTopologyDynamicsFactory() {
		return (Symphony__CommonTopologyDynamicsFactory)getEFactoryInstance();
	}
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "Symphony__CommonTopologyDynamics",
