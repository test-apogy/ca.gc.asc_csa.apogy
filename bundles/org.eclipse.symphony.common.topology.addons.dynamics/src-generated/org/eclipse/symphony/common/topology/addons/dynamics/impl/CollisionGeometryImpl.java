...
public class CollisionGeometryImpl extends MinimalEObjectImpl.Container implements CollisionGeometry {
	...
	protected EClass eStaticClass() {
		return Symphony__CommonTopologyAddonsDynamicsPackage.Literals.COLLISION_GEOMETRY;
	}
	...
	public EList<AbstractCollisionGeometrySimulationProperties> getSimulationProperties() {
		if (simulationProperties == null) {
			simulationProperties = new EObjectResolvingEList<AbstractCollisionGeometrySimulationProperties>(AbstractCollisionGeometrySimulationProperties.class, this, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__SIMULATION_PROPERTIES);
		}
	...
	public NotificationChain basicSetGeometry(Geometry newGeometry, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY, oldGeometry, newGeometry);
	...
	public void setGeometry(Geometry newGeometry) {
		if (newGeometry != geometry) {
			...
			if (geometry != null)
				msgs = ((InternalEObject)geometry).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY, null, msgs);
			if (newGeometry != null)
				msgs = ((InternalEObject)newGeometry).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY, null, msgs);
			msgs = basicSetGeometry(newGeometry, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY, newGeometry, newGeometry));
	}
	...
	public NotificationChain basicSetTransform(Matrix4x4 newTransform, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__TRANSFORM, oldTransform, newTransform);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTransform(Matrix4x4 newTransform) {
		if (newTransform != transform) {
			NotificationChain msgs = null;
			if (transform != null)
				msgs = ((InternalEObject)transform).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__TRANSFORM, null, msgs);
			if (newTransform != null)
				msgs = ((InternalEObject)newTransform).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__TRANSFORM, null, msgs);
			msgs = basicSetTransform(newTransform, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__TRANSFORM, newTransform, newTransform));
	}
	...
	public AbstractMaterial getMaterial() {
		if (material != null && material.eIsProxy()) {
			...
			if (material != oldMaterial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__MATERIAL, oldMaterial, material));
			}
		}
		return material;
	}
	...
	public void setMaterial(AbstractMaterial newMaterial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__MATERIAL, oldMaterial, material));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__DESCRIPTION, oldDescription, description));
	}
	...
	public void setGeometryId(String newGeometryId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY_ID, oldGeometryId, geometryId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__SIMULATION_PROPERTIES:
				return getSimulationProperties();
			case Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__GEOMETRY:
				return getGeometry();
			case Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__TRANSFORM:
				return getTransform();
			case Symphony__CommonTopologyAddonsDynamicsPackage.COLLISION_GEOMETRY__MATERIAL:
