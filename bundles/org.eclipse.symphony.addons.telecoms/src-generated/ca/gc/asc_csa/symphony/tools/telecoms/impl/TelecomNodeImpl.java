...
import ca.gc.asc_csa.symphony.tools.telecoms.TelecomNodeStatus;
import ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getStatusMonitorTool <em>Status Monitor Tool</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getPacketsToSend <em>Packets To Send</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getConnectionTimeout <em>Connection Timeout</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getLatencyWarning <em>Latency Warning</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getLatencyAlarm <em>Latency Alarm</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getPacketLossWarning <em>Packet Loss Warning</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getPacketLossAlarm <em>Packet Loss Alarm</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getLatency <em>Latency</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getPacketLoss <em>Packet Loss</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.impl.TelecomNodeImpl#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
