 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#getTelecomNodes <em>Telecom Nodes</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#getStatusMonitorToolList <em>Status Monitor Tool List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#isRunning <em>Running</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#isDisposed <em>Disposed</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.telecoms.SymphonyTelecomToolsPackage#getTelecomStatusMonitorTool()
 * @model
 * @generated
 */
public interface TelecomStatusMonitorTool extends EObject {
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomNode}.
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomNode#getStatusMonitorTool <em>Status Monitor Tool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.telecoms.SymphonyTelecomToolsPackage#getTelecomStatusMonitorTool_TelecomNodes()
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorToolList#getTelecomStatusMonitors <em>Telecom Status Monitors</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.telecoms.SymphonyTelecomToolsPackage#getTelecomStatusMonitorTool_StatusMonitorToolList()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#getStatusMonitorToolList <em>Status Monitor Tool List</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.telecoms.SymphonyTelecomToolsPackage#getTelecomStatusMonitorTool_Running()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#isRunning <em>Running</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.telecoms.SymphonyTelecomToolsPackage#getTelecomStatusMonitorTool_Disposed()
	 * @model default="false" unique="false" transient="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Readonly' notify='true' children='false'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.telecoms.TelecomStatusMonitorTool#isDisposed <em>Disposed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
