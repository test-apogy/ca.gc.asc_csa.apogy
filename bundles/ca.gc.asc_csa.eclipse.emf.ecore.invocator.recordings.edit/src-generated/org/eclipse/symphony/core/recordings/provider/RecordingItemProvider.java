 ...
 * @generated
 */
public class RecordingItemProvider extends AbstractResultItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Recording)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Recording_type") :
			getString("_UI_Recording_type") + " " + label;
	}
