	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (derivedFeatureID) {
				case SymphonyOrbitEnvironmentPackage.TIMED_STAMPED_PVA_COORDINATES__TIME: return Symphony__CommonEMFPackage.TIMED__TIME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (baseFeatureID) {
				case Symphony__CommonEMFPackage.TIMED__TIME: return SymphonyOrbitEnvironmentPackage.TIMED_STAMPED_PVA_COORDINATES__TIME;
				default: return -1;
			}
		}
