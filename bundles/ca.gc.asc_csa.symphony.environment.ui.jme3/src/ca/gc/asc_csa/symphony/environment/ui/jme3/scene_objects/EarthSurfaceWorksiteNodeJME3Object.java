...
import ca.gc.asc_csa.symphony.environment.ui.jme3.EnvironmentUIJME3Utilities;
...
{					
	...
	public static final float AZIMUTH_DISPLAY_RADIUS  = (float) (EarthSkyNodeJME3Object.CELESTIAL_SPHERE_RADIUS * 0.75);	
	...
	public static final float ELEVATION_DISPLAY_RADIUS  = (float) (EarthSkyNodeJME3Object.CELESTIAL_SPHERE_RADIUS * 0.75f);
			...
			adapter = new AdapterImpl()
			{
				...
				public void notifyChanged(Notification msg) 
				{
					if(msg.getNotifier() instanceof EarthSurfaceWorksiteNode)
					{
						...
						if(msg.getFeatureID(EarthSurfaceWorksiteNode.class) == SymphonyEnvironmentPackage.EARTH_SURFACE_WORKSITE_NODE__WORKSITE)
						{
