 ...
 * <!-- end-user-doc -->
 * @see ca.gc.space.mrt.common.processors.MRTProcessorsPackage
 * @generated
 */
public class MRTProcessorsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static MRTProcessorsPackage modelPackage;
	 ...
	 * @generated
	 */
	public MRTProcessorsSwitch() {
		if (modelPackage == null) {
			modelPackage = MRTProcessorsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MRTProcessorsPackage.PROCESSORS_CHAIN: {
			...
			case MRTProcessorsPackage.JOB_PROCESSORS_CHAIN: {
			...
			case MRTProcessorsPackage.VERBOSE_PROVIDER: {
