...
import ca.gc.space.mrt.common.processors.MRTProcessorsFactory;
import ca.gc.space.mrt.common.processors.MRTProcessorsPackage;
 ...
 * @generated
 */
public class MRTProcessorsPackageImpl extends EPackageImpl implements MRTProcessorsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ca.gc.space.mrt.common.processors.MRTProcessorsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MRTProcessorsPackageImpl() {
		super(eNS_URI, MRTProcessorsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link MRTProcessorsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MRTProcessorsPackage init() {
		if (isInited) return (MRTProcessorsPackage)EPackage.Registry.INSTANCE.getEPackage(MRTProcessorsPackage.eNS_URI);

		// Obtain or create and register package
		MRTProcessorsPackageImpl theMRTProcessorsPackage = (MRTProcessorsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MRTProcessorsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MRTProcessorsPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(MRTProcessorsPackage.eNS_URI, theMRTProcessorsPackage);
	 ...
	 * @generated
	 */
	public MRTProcessorsFactory getMRTProcessorsFactory() {
		return (MRTProcessorsFactory)getEFactoryInstance();
	}
		...
		addAnnotation
		  (this, 
		   ...
		   new String[] {
			 ...
			 "editDirectory", "/ca.gc.space.mrt.common.processors.edit/src-generated",
