...
import org.eclipse.symphony.addons.mobility.controllers.MobilityControllersFactory;
import org.eclipse.symphony.addons.mobility.controllers.MobilityControllersPackage;

import org.eclipse.symphony.addons.mobility.controllers.util.MobilityControllersAdapterFactory;
 ...
 * @generated
 */
public class MobilityControllersItemProviderAdapterFactory extends MobilityControllersAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(MobilityControllersEditPlugin.INSTANCE, MobilityControllersPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public MobilityControllersItemProviderAdapterFactory() {
	...
	public static class TopologyChildCreationExtender implements IChildCreationExtender {
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createPathFollower()));

				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createSkidSteeredPlatformPathFollower()));

				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createPathRecorder()));

				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createWaypointPathRecorder()));

				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createSkidSteeredWayPointPathFollower()));

				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 MobilityControllersFactory.eINSTANCE.createAstolfiGuidanceController()));
		 ...
		 */
		public ResourceLocator getResourceLocator() {
			return MobilityControllersEditPlugin.INSTANCE;
		}
	}
