 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.ImageCountOverlay#isIndicatorVisible <em>Indicator Visible</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getImageCountOverlay()
 * @model
 * @generated
 */
public interface ImageCountOverlay extends AbstractTextOverlay {
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getImageCountOverlay_IndicatorVisible()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.ImageCountOverlay#isIndicatorVisible <em>Indicator Visible</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
