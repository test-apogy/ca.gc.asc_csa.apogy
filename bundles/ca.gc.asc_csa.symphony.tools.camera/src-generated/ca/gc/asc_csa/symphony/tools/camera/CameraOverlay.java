 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.CameraOverlay#getCameraOverlayList <em>Camera Overlay List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.CameraOverlay#getOverlayAlignment <em>Overlay Alignment</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getCameraOverlay()
 * @model abstract="true"
 * @generated
 */
public interface CameraOverlay extends CameraImageAnnotation
{
  ...
  /**
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.camera.CameraOverlayList#getOverlays <em>Overlays</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getCameraOverlay_CameraOverlayList()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.CameraOverlay#getCameraOverlayList <em>Camera Overlay List</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.symphony.tools.camera.OverlayAlignment}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getCameraOverlay_OverlayAlignment()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.CameraOverlay#getOverlayAlignment <em>Overlay Alignment</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
