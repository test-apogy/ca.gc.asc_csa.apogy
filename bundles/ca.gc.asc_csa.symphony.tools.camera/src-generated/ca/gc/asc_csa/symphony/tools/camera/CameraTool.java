 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.CameraTool#getCameraToolList <em>Camera Tool List</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getCameraTool()
 * @model abstract="true"
 * @generated
 */
public interface CameraTool extends CameraImageAnnotation {
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.camera.CameraToolList#getTools <em>Tools</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getCameraTool_CameraToolList()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.CameraTool#getCameraToolList <em>Camera Tool List</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
