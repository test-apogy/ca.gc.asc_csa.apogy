 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getVariableFeatureReference <em>Variable Feature Reference</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getNumberFormat <em>Number Format</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getVariableFeatureReferenceChangeCount <em>Variable Feature Reference Change Count</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getEMFFeatureOverlay()
 * @model
 * @generated
 */
public interface EMFFeatureOverlay extends AbstractTextOverlay
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getEMFFeatureOverlay_VariableFeatureReference()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getVariableFeatureReference <em>Variable Feature Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getEMFFeatureOverlay_NumberFormat()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getNumberFormat <em>Number Format</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  void setNumberFormat(String value);
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getEMFFeatureOverlay_VariableFeatureReferenceChangeCount()
	...
	long getVariableFeatureReferenceChangeCount();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.EMFFeatureOverlay#getVariableFeatureReferenceChangeCount <em>Variable Feature Reference Change Count</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
