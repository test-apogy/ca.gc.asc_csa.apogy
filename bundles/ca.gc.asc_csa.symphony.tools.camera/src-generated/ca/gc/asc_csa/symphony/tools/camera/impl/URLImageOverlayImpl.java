 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.impl.URLImageOverlayImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.impl.URLImageOverlayImpl#getImageSizePolicy <em>Image Size Policy</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.impl.URLImageOverlayImpl#getImage <em>Image</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URLImageOverlayImpl extends ImageCameraOverlayImpl implements URLImageOverlay {
	...
	protected EClass eStaticClass() {
		return SymphonyCameraToolsPackage.Literals.URL_IMAGE_OVERLAY;
	}
	...
	public void setUrlGen(String newUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyCameraToolsPackage.URL_IMAGE_OVERLAY__URL, oldUrl, url));
	}
	...
	public void setImageSizePolicy(ImageSizePolicy newImageSizePolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyCameraToolsPackage.URL_IMAGE_OVERLAY__IMAGE_SIZE_POLICY, oldImageSizePolicy, imageSizePolicy));
	}
	...
	public AbstractEImage getImage() {
		if (image != null && image.eIsProxy()) {
			...
			if (image != oldImage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SymphonyCameraToolsPackage.URL_IMAGE_OVERLAY__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImage(AbstractEImage newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyCameraToolsPackage.URL_IMAGE_OVERLAY__IMAGE, oldImage, image));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SymphonyCameraToolsPackage.URL_IMAGE_OVERLAY__IMAGE:
