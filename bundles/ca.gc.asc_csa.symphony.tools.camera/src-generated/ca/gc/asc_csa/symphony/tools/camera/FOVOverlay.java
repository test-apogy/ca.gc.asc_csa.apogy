 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getLineWidth <em>Line Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getPositiveValuesColor <em>Positive Values Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getNegativeValueColor <em>Negative Value Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getAngleInterval <em>Angle Interval</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getFontName <em>Font Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getAzimuthDirection <em>Azimuth Direction</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getElevationDirection <em>Elevation Direction</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay()
 * @model
 * @generated
 */
public interface FOVOverlay extends DrawnCameraOverlay, ToolTipTextProvider {
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_LineWidth()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getLineWidth <em>Line Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_PositiveValuesColor()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getPositiveValuesColor <em>Positive Values Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_NegativeValueColor()
	 * @model default="1.0,0.0,0.0" unique="false" dataType="ca.gc.asc_csa.symphony.tools.camera.Color3f"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel propertyCategory='OVERLAY_PROPERTIES'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getNegativeValueColor <em>Negative Value Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_AngleInterval()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getAngleInterval <em>Angle Interval</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_FontName()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getFontName <em>Font Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setFontSize(int)
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_FontSize()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getFontSize <em>Font Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_AzimuthDirection()
	 * @model unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getAzimuthDirection <em>Azimuth Direction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.camera.SymphonyCameraToolsPackage#getFOVOverlay_ElevationDirection()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel propertyCategory='DIRECTIONS_PROPERTIES'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.camera.FOVOverlay#getElevationDirection <em>Elevation Direction</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
