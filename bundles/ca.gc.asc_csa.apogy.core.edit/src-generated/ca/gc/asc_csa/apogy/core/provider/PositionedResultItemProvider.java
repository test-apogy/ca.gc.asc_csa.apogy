...
import ca.gc.asc_csa.apogy.core.invocator.provider.AbstractResultItemProvider;

/**
 * This is the item provider adapter for a
 * {@link ca.gc.asc_csa.apogy.core.PositionedResult} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PositionedResultItemProvider extends
		AbstractResultItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PositionedResultItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PositionedResult.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PositionedResult"));
	}
	...
	public String getText(Object object) {
		Date labelValue = ((PositionedResult)object).getTime();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PositionedResult_type") :
			getString("_UI_PositionedResult_type") + " " + label;
	}
