 ...
 * {@link ca.gc.asc_csa.apogy.core.ConnectionPoint} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ConnectionPointItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCorePackage.Literals.CONNECTION_POINT__NODE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		String label = getString("_UI_ConnectionPoint_type");

		if (connectionPoint.getName() != null
				&& connectionPoint.getName().length() > 0) {
			label = connectionPoint.getName();
		}
		return label;
	}
