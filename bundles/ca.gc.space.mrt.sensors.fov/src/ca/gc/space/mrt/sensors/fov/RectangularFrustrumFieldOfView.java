 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getRange <em>Range</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getHorizontalFieldOfViewAngle <em>Horizontal Field Of View Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getVerticalFieldOfViewAngle <em>Vertical Field Of View Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getVolume <em>Volume</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.fov.FovPackage#getRectangularFrustrumFieldOfView()
 * @model
 * @generated
 */
public interface RectangularFrustrumFieldOfView extends FieldOfView {
	 ...
	 * @see ca.gc.space.mrt.sensors.fov.FovPackage#getRectangularFrustrumFieldOfView_Range()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getRange <em>Range</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.fov.FovPackage#getRectangularFrustrumFieldOfView_HorizontalFieldOfViewAngle()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getHorizontalFieldOfViewAngle <em>Horizontal Field Of View Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.fov.FovPackage#getRectangularFrustrumFieldOfView_VerticalFieldOfViewAngle()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.fov.RectangularFrustrumFieldOfView#getVerticalFieldOfViewAngle <em>Vertical Field Of View Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.fov.FovPackage#getRectangularFrustrumFieldOfView_Volume()
