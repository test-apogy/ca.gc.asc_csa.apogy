			...
			adapter = new AdapterImpl()
			{
				...
				{					
					...
					{												
						...
						if(featureId == ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL)
						{
					...
					else if(msg.getNotifier() instanceof SunVector3DTool)
					{
						...
						if(!sunVector3DTool.isDisposed())
						{
							...
							switch(featureId)
							{
								...
								case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__FROM_RELATIVE_POSITION:
								case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__FROM_ABSOLUTE_POSITION:
								case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__TO_ABSOLUTE_POSITION:
								case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_INTENSITY:
								case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__TO_RELATIVE_POSITION:
										updateGeometry();
								break;
