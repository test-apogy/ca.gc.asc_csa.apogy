 ...
 *
 * $Id: CsvPackageImpl.java,v 1.3.4.2 2015/05/21 15:49:55 pallard Exp $
 */
...
public class CsvPackageImpl extends EPackageImpl implements CsvPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getCsvValueProvider__GetStringValue__Object(), theEcorePackage.getEString(), "getStringValue", 1, 1, IS_UNIQUE, IS_ORDERED);
