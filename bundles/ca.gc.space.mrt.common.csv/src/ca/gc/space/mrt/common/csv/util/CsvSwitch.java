 ...
 *
 * $Id: CsvSwitch.java,v 1.3.4.2 2015/05/21 15:49:55 pallard Exp $
 */
...
public class CsvSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CsvPackage.CSV_COLUMS_SET: {
				CsvColumsSet csvColumsSet = (CsvColumsSet)theEObject;
				T result = caseCsvColumsSet(csvColumsSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Column Values Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Column Values Map</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Colums Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Colums Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCsvColumsSet(CsvColumsSet object) {
		return null;
	}
