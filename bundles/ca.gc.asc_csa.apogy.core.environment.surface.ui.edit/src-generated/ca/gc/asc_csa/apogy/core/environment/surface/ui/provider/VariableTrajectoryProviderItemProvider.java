...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.surface.ui.VariableTrajectoryProvider} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableTrajectoryProviderItemProvider extends TrajectoryProviderItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VariableTrajectoryProviderItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.VARIABLE_TRAJECTORY_PROVIDER__POSE_PROVIDER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		XYDataItem labelValue = ((VariableTrajectoryProvider)object).getLatestPosition();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_VariableTrajectoryProvider_type") :
			getString("_UI_VariableTrajectoryProvider_type") + " " + label;
	}
