...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.surface.ui.AbstractVariableAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractVariableAnnotationItemProvider extends MapAnnotationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.ABSTRACT_VARIABLE_ANNOTATION__VARIABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.ABSTRACT_VARIABLE_ANNOTATION__VARIABLE_INSTANCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogySurfaceEnvironmentUIPackage.Literals.ABSTRACT_VARIABLE_ANNOTATION__APOGY_SYSTEM_API_ADAPTER,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_AbstractVariableAnnotation_type") + " " + abstractVariableAnnotation.isVisible();
	}
