 ...
 * @generated
 */
public class PoseItemProviderAdapterFactory extends PoseAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(PoseEditPlugin.INSTANCE, PosePackage.eNS_URI);
		...
		protected static class CreationSwitch extends TopologySwitch<Object> {
			...
			public <T> Object caseContentNode(ContentNode<T> object) {
				...
				newChildDescriptors.add
					(createChildParameter
						(TopologyPackage.Literals.CONTENT_NODE__CONTENT,
						 PoseFactory.eINSTANCE.createPoseFacade()));
