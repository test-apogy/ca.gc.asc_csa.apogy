 ...
 * @generated
 */
public class PoseDataLoggerItemProvider 
	 ...
	 * @generated
	 */
	public PoseDataLoggerItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((PoseDataLogger)object).getOutputFile();
		return label == null || label.length() == 0 ?
			getString("_UI_PoseDataLogger_type") :
			getString("_UI_PoseDataLogger_type") + " " + label;
	}
