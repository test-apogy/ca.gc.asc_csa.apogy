...
public class NoEObjectSelectionComposite extends Composite {
	/**
	 * Create the composite.
	 * @param parent
	 * @param style
	 */
	public NoEObjectSelectionComposite(Composite parent, int style) {
		super(parent, style);
		...
		lblNoActiveSession.setText("No compatible selection");
	}
}