 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='Topology' childCreationExtenders='true' extensibleProviderFactory='true' multipleEditorPages='false' copyrightText='Canadian Space Agency / Agence spatiale canadienne 2015 Copyrights (c)' modelName='Topology' operationReflection='true' suppressGenModelAnnotations='false' modelDirectory='/ca.gc.space.topology.core/src-generated' editDirectory='/ca.gc.space.topology.core.edit/src-generated' basePackage='ca.gc.space'"
 * @generated
 */
public interface TopologyPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "ca.gc.space.topology";
	...
	/**
	 * The meta object id for the '{@link ca.gc.space.topology.impl.GroupNodeImpl <em>Group Node</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.space.topology.impl.GroupNodeImpl
	 ...
	 * @see ca.gc.space.topology.impl.TopologyPackageImpl#getMatrix4d()
	 * @generated
	 */
	int MATRIX4D = 17;
	 ...
	 * @see ca.gc.space.topology.impl.TopologyPackageImpl#getEClass()
	 * @generated
	 */
	int ECLASS = 18;
	...
	/**
	 * Returns the meta object for the '{@link ca.gc.space.topology.TopologyFacade#getEuclideanDistance(ca.gc.space.topology.Node, ca.gc.space.topology.Node) <em>Get Euclidean Distance</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Euclidean Distance</em>' operation.
	 * @see ca.gc.space.topology.TopologyFacade#getEuclideanDistance(ca.gc.space.topology.Node, ca.gc.space.topology.Node)
	 * @generated
	 */
	 ...
	 * @see ca.gc.space.topology.INodeVisitor
	 * @model instanceClass="ca.gc.space.topology.INodeVisitor"
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link ca.gc.space.topology.impl.GroupNodeImpl <em>Group Node</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.space.topology.impl.GroupNodeImpl
		 * @see ca.gc.space.topology.impl.TopologyPackageImpl#getGroupNode()
