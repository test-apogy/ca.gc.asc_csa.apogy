 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#isLoopEnable <em>Loop Enable</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getTimedsList <em>Timeds List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getCurrentTimedElement <em>Current Timed Element</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getEarliestDate <em>Earliest Date</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getLatestDate <em>Latest Date</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource()
 * @model
 * @generated
 */
public interface CollectionTimedTimeSource extends BrowseableTimeSource {
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource_LoopEnable()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#isLoopEnable <em>Loop Enable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.eclipse.emf.ecore.Timed}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource_TimedsList()
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource_CurrentTimedElement()
	 * @model transient="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getCurrentTimedElement <em>Current Timed Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource_EarliestDate()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Readonly'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getEarliestDate <em>Earliest Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.EMFEcorePackage#getCollectionTimedTimeSource_LatestDate()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Readonly'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.CollectionTimedTimeSource#getLatestDate <em>Latest Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
