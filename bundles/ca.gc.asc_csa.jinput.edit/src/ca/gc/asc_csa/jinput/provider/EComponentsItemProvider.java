...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.jinput.EComponents} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EComponentsItemProvider
	 ...
	 * @generated
	 */
	public EComponentsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EComponents"));
	}
	 ...
	 * @generated_NOT
	 */
	public Object getImageOld(Object object) {
		String type = ((EComponents)object).getName();
		String img = "";
		if(type.equalsIgnoreCase("axis")) {
			img = "axis.png";
		} else if(type.equalsIgnoreCase("buttons")) {
			img = "key.png";
		}
		else
		{
	...
	public String getText(Object object) {
		String label = ((EComponents)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EComponents_type") :  label;
	}
