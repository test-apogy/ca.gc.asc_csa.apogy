 ...
 */
package ca.gc.asc_csa.jinput.provider;
...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.jinput.EVirtualComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EVirtualComponentItemProvider
	extends EComponentItemProvider
	implements
	 ...
	 * @generated
	 */
	public EVirtualComponentItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JInputPackage.Literals.EVIRTUAL_COMPONENT__CURRENT_VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns EVirtualComponent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EVirtualComponent"));
	}
	...
	public String getText(Object object) {
		String label = ((EVirtualComponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EVirtualComponent_type") :
			getString("_UI_EVirtualComponent_type") + " " + label;
	}
