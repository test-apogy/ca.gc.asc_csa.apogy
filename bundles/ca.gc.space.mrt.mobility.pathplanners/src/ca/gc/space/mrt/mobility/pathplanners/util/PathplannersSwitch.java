 ...
 *
 * $Id: PathplannersSwitch.java,v 1.5.4.3 2015/09/22 19:39:42 rlarcheveque Exp $
 */
...
public class PathplannersSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PathplannersPackage.WAY_POINT_PATH_PLANNER: {
			...
			case PathplannersPackage.MESH_WAY_POINT_PATH_PLANNER: {
			...
			case PathplannersPackage.EXCLUSION_ZONE: {
			...
			case PathplannersPackage.CIRCULAR_EXCLUSION_ZONE: {
			...
			case PathplannersPackage.PATH_PLANNERS_FACADE: {
