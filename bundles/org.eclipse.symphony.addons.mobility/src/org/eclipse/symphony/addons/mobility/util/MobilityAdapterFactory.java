 ...
 *
 * $Id: MobilityAdapterFactory.java,v 1.5.4.3 2015/09/22 19:39:42 rlarcheveque Exp $
 */
...
public class MobilityAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MobilitySwitch<Adapter> modelSwitch =
		new MobilitySwitch<Adapter>() {
			@Override
			public Adapter caseMobilePlateform(MobilePlateform object) {
				return createMobilePlateformAdapter();
			}
			@Override
			public Adapter caseSkidSteeredMobilePlateform(SkidSteeredMobilePlateform object) {
				return createSkidSteeredMobilePlateformAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.symphony.addons.mobility.MobilePlateform <em>Mobile Plateform</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.symphony.addons.mobility.SkidSteeredMobilePlateform <em>Skid Steered Mobile Plateform</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
