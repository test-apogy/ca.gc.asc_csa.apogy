...
public class MobilityFactoryImpl extends EFactoryImpl implements MobilityFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MobilityPackage.MOBILE_PLATFORM: return createMobilePlatform();
			case MobilityPackage.SKID_STEERED_MOBILE_PLATFORM: return createSkidSteeredMobilePlatform();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue)
	{
		switch (eDataType.getClassifierID()) {
			case MobilityPackage.MOBILE_PLATFORM_STATUS:
