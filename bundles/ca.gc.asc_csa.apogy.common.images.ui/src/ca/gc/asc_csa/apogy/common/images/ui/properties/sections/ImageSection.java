...
public class ImageSection extends AbstractExtendedPropertySection implements IFilter
{
	...
	{
		return (Symphony__CommonConvertersFacade.INSTANCE.convert(toTest, AbstractEImage.class) != null);
	}

	@Override
	protected void render(EObject eObject)
	{
		AbstractEImage image = (AbstractEImage) Symphony__CommonConvertersFacade.INSTANCE.convert(eObject, AbstractEImage.class);
