 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.TranslationBinding#getPositionNode <em>Position Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.TranslationBinding#getTranslationAxis <em>Translation Axis</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getTranslationBinding()
 * @model
 * @generated
 */
public interface TranslationBinding extends AbstractTopologyBinding
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getTranslationBinding_TranslationAxis()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.TranslationBinding#getTranslationAxis <em>Translation Axis</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getTranslationBinding_PositionNode()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.TranslationBinding#getPositionNode <em>Position Node</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
