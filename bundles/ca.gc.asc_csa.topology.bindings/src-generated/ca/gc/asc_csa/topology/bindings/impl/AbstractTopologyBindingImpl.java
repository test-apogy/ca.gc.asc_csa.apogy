 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#isBinded <em>Binded</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#getFeatureNode <em>Feature Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.impl.AbstractTopologyBindingImpl#getFeatureNodeAdapter <em>Feature Node Adapter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
