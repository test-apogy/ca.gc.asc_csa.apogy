 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#isBinded <em>Binded</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getSource <em>Source</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getFeatureNode <em>Feature Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getFeatureNodeAdapter <em>Feature Node Adapter</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding()
 * @model abstract="true"
 * @generated
 */
public interface AbstractTopologyBinding extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_Binded()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#isBinded <em>Binded</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_Description()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_Name()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel propertyCategory='INFORMATION'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_Source()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getSource <em>Source</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_FeatureNode()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.AbstractTopologyBinding#getFeatureNode <em>Feature Node</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getAbstractTopologyBinding_FeatureNodeAdapter()
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" originalToCopyNodeMapDataType="ca.gc.asc_csa.topology.bindings.Map<ca.gc.space.topology.Node, ca.gc.space.topology.Node>" originalToCopyNodeMapUnique="false"
	 * @generated
	 */
