...
public class TopologyBindingsPackageImpl extends EPackageImpl implements TopologyBindingsPackage
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  ...
  public void initializePackageContents()
  {
		...
		initEEnum(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.class, "AXIS");
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.XAXIS);
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.YAXIS);
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.ZAXIS);
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.MINUS_XAXIS);
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.MINUS_YAXIS);
		addEEnumLiteral(axisEEnum, ca.gc.asc_csa.topology.bindings.AXIS.MINUS_ZAXIS);

		initEEnum(anglE_UNITSEEnum, ca.gc.asc_csa.topology.bindings.ANGLE_UNITS.class, "ANGLE_UNITS");
		addEEnumLiteral(anglE_UNITSEEnum, ca.gc.asc_csa.topology.bindings.ANGLE_UNITS.RADIANS);
		addEEnumLiteral(anglE_UNITSEEnum, ca.gc.asc_csa.topology.bindings.ANGLE_UNITS.DEGREES);
