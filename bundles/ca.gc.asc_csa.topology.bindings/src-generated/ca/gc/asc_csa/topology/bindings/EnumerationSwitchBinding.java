 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.EnumerationSwitchBinding#getParentNode <em>Parent Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.EnumerationSwitchBinding#getCases <em>Cases</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.EnumerationSwitchBinding#getActiveCase <em>Active Case</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getEnumerationSwitchBinding()
 * @model
 * @generated
 */
public interface EnumerationSwitchBinding extends AbstractTopologyBinding
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getEnumerationSwitchBinding_ParentNode()
	 * @model required="true"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.EnumerationSwitchBinding#getParentNode <em>Parent Node</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.topology.bindings.EnumerationCase}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getEnumerationSwitchBinding_Cases()
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getEnumerationSwitchBinding_ActiveCase()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.EnumerationSwitchBinding#getActiveCase <em>Active Case</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
