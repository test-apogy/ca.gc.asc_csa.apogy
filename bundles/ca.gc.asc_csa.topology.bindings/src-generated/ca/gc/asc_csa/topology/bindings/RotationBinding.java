 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationNode <em>Rotation Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationAxis <em>Rotation Axis</em>}</li>
 *   <li>{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationUnits <em>Rotation Units</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getRotationBinding()
 * @model
 * @generated
 */
public interface RotationBinding extends AbstractTopologyBinding
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getRotationBinding_RotationNode()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationNode <em>Rotation Node</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.topology.bindings.AXIS}.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getRotationBinding_RotationAxis()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationAxis <em>Rotation Axis</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.topology.bindings.ANGLE_UNITS}.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.topology.bindings.TopologyBindingsPackage#getRotationBinding_RotationUnits()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.topology.bindings.RotationBinding#getRotationUnits <em>Rotation Units</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
