 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#isBusy <em>Busy</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#isAutoPathPlanEnabled <em>Auto Path Plan Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#getMeshLayer <em>Mesh Layer</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#getPathPlanner <em>Path Planner</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#getPlannedPath <em>Planned Path</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.PathPlannerToolImpl#getPathPlannerToolNode <em>Path Planner Tool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
