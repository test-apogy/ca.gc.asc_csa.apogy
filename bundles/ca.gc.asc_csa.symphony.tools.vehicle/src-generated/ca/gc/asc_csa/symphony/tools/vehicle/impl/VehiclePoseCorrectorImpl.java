...
import ca.gc.asc_csa.symphony.tools.vehicle.OrientationCorrectionMode;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#isInitializing <em>Initializing</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getMeshes <em>Meshes</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getContactBodies <em>Contact Bodies</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getZCorrectionMode <em>ZCorrection Mode</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getZCorrection <em>ZCorrection</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getOrientationCorrectionMode <em>Orientation Correction Mode</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getOrientationCorrection <em>Orientation Correction</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.VehiclePoseCorrectorImpl#getContactProvider <em>Contact Provider</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VehiclePoseCorrectorImpl extends PoseCorrectorImpl implements VehiclePoseCorrector
{
  ...
  {	
	  ...
	  if(newEnabled && !previousEnabled)
	  {
		  try
		  {
			  if(getSymphonySystemApiAdapter() != null)
			  {
				  Matrix4x4 correctedPose = applyCorrection(getSymphonySystemApiAdapter().getPoseTransform());
				  getSymphonySystemApiAdapter().setPoseTransform(correctedPose);
			  }
		  }
		  catch(Throwable t)
		  {
  ...
  protected List<MeshNodeEntry> extractMeshes()
  {
	  ...
	  try
	  {		  
		  SymphonyEnvironment env = (SymphonyEnvironment) getSymphonySystemApiAdapter().getEnvironment();		  		  		  
		  Node root = env.getSymphonyTopology().getRootNode();		  		  		  
