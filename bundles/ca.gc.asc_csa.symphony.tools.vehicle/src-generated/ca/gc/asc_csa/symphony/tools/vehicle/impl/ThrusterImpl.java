 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.ThrusterImpl#getMinimumThrust <em>Minimum Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.ThrusterImpl#getMaximumThrust <em>Maximum Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.ThrusterImpl#getCurrentThrust <em>Current Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.ThrusterImpl#getThrustLevel <em>Thrust Level</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.impl.ThrusterImpl#getPlumeAngle <em>Plume Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
