...
import ca.gc.asc_csa.symphony.tools.vehicle.impl.WheelVehicleUtilitiesImpl;
 ...
 *
 *
 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getWheelVehicleUtilities()
 * @model
 * @generated
 */
public interface WheelVehicleUtilities extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.Point2d" unique="false" wheelRadiusUnique="false" wheelCenterXUnique="false" segmentDataType="ca.gc.asc_csa.symphony.tools.vehicle.Segment2D" segmentUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * @return The position of the wheel center, null if none is found.
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.Point2d" unique="false" wheelRadiusUnique="false" wheelCenterXUnique="false" terrainProfileDataType="ca.gc.asc_csa.symphony.tools.vehicle.TerrainProfile" terrainProfileUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.TerrainProfile" unique="false" meshUnique="false" planeDataType="ca.gc.asc_csa.symphony.tools.vehicle.Plane" planeUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.List<ca.gc.asc_csa.symphony.tools.vehicle.Point3d>" unique="false" many="false" planeDataType="ca.gc.asc_csa.symphony.tools.vehicle.Plane" planeUnique="false" line3dDataType="ca.gc.asc_csa.symphony.tools.vehicle.Line3d" line3dUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" pDataType="ca.gc.asc_csa.symphony.tools.vehicle.Point2d" pUnique="false" segmentDataType="ca.gc.asc_csa.symphony.tools.vehicle.Segment2D" segmentUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" pointDataType="ca.gc.asc_csa.symphony.tools.vehicle.Point3d" pointUnique="false" meshExtentUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.Vector3d" unique="false" pointsDataType="ca.gc.asc_csa.symphony.tools.vehicle.List<ca.gc.asc_csa.symphony.tools.vehicle.Point3d>" pointsUnique="false" pointsMany="false"
	 * @generated
	 */
