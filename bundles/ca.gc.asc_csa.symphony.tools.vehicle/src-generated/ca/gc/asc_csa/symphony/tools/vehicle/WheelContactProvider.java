 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.WheelContactProvider#getContactMode <em>Contact Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getWheelContactProvider()
 * @model
 * @generated
 */
public interface WheelContactProvider extends ContactProvider
{
  /**
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.symphony.tools.vehicle.WheelContactMode}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getWheelContactProvider_ContactMode()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.WheelContactProvider#getContactMode <em>Contact Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
