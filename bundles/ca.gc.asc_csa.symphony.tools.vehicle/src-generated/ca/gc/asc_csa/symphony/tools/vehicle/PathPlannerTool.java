 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#isBusy <em>Busy</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#isAutoPathPlanEnabled <em>Auto Path Plan Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getMeshLayer <em>Mesh Layer</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPathPlanner <em>Path Planner</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPlannedPath <em>Planned Path</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPathPlannerToolNode <em>Path Planner Tool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool()
 * @model
 * @generated
 */
public interface PathPlannerTool extends AbstractTwoPoints3DTool {
	 ...
	 * @see #setBusy(boolean)
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_Busy()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#isBusy <em>Busy</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_AutoPathPlanEnabled()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#isAutoPathPlanEnabled <em>Auto Path Plan Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_MeshLayer()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getMeshLayer <em>Mesh Layer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_PathPlanner()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPathPlanner <em>Path Planner</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_PlannedPath()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPlannedPath <em>Planned Path</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerToolNode#getPathPlannerTool <em>Path Planner Tool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getPathPlannerTool_PathPlannerToolNode()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.PathPlannerTool#getPathPlannerToolNode <em>Path Planner Tool Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
