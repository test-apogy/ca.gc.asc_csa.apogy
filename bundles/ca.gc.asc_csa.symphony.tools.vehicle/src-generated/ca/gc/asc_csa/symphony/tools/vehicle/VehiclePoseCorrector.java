 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#isInitializing <em>Initializing</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getMeshes <em>Meshes</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getContactBodies <em>Contact Bodies</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getZCorrectionMode <em>ZCorrection Mode</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getZCorrection <em>ZCorrection</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getOrientationCorrectionMode <em>Orientation Correction Mode</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getOrientationCorrection <em>Orientation Correction</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getContactProvider <em>Contact Provider</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector()
 * @model
 * @generated
 */
public interface VehiclePoseCorrector extends PoseCorrector
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_Initializing()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#isInitializing <em>Initializing</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.symphony.tools.vehicle.MeshNodeEntry}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_Meshes()
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_ContactBodies()
  ...
  /**
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.symphony.tools.vehicle.ZCorrectionMode}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_ZCorrectionMode()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getZCorrectionMode <em>ZCorrection Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_ZCorrection()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getZCorrection <em>ZCorrection</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * The literals are from the enumeration {@link ca.gc.asc_csa.symphony.tools.vehicle.OrientationCorrectionMode}.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_OrientationCorrectionMode()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' propertyCategory='SETTINGS_INFO'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getOrientationCorrectionMode <em>Orientation Correction Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_OrientationCorrection()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getOrientationCorrection <em>Orientation Correction</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.vehicle.ContactProvider#getVehiclePoseCorrector <em>Vehicle Pose Corrector</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getVehiclePoseCorrector_ContactProvider()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.VehiclePoseCorrector#getContactProvider <em>Contact Provider</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.tools.vehicle.ClosestNeighbourIteratorProvider" unique="false" meshUnique="false"
	 * @generated
	 */
