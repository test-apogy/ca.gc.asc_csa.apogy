 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getMinimumThrust <em>Minimum Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getMaximumThrust <em>Maximum Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getCurrentThrust <em>Current Thrust</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getThrustLevel <em>Thrust Level</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getPlumeAngle <em>Plume Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster()
 * @model
 * @generated
 */
public interface Thruster extends Node
{
  /**
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster_MinimumThrust()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getMinimumThrust <em>Minimum Thrust</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster_MaximumThrust()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getMaximumThrust <em>Maximum Thrust</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster_CurrentThrust()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getCurrentThrust <em>Current Thrust</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster_PlumeAngle()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getPlumeAngle <em>Plume Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.vehicle.SymphonyToolsVehiclePackage#getThruster_ThrustLevel()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.vehicle.Thruster#getThrustLevel <em>Thrust Level</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
