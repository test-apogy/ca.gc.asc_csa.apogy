...
{		
		...
		if (fromAbsolutePosition != null && fromAbsolutePosition.eIsProxy()) {
			...
			if (fromAbsolutePosition != oldFromAbsolutePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__FROM_ABSOLUTE_POSITION, oldFromAbsolutePosition, fromAbsolutePosition));
			}
		}
	...
	public void setFromAbsolutePosition(Tuple3d newFromAbsolutePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__FROM_ABSOLUTE_POSITION, oldFromAbsolutePosition, fromAbsolutePosition));
	}
	...
	public Tuple3d getFromRelativePosition() {
		if (fromRelativePosition != null && fromRelativePosition.eIsProxy()) {
			...
			if (fromRelativePosition != oldFromRelativePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__FROM_RELATIVE_POSITION, oldFromRelativePosition, fromRelativePosition));
			}
		}
	...
	public void setFromRelativePositionGen(Tuple3d newFromRelativePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__FROM_RELATIVE_POSITION, oldFromRelativePosition, fromRelativePosition));
	}
	...
	public Tuple3d getToAbsolutePosition() {
		if (toAbsolutePosition != null && toAbsolutePosition.eIsProxy()) {
			...
			if (toAbsolutePosition != oldToAbsolutePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__TO_ABSOLUTE_POSITION, oldToAbsolutePosition, toAbsolutePosition));
			}
		}
	...
	public void setToAbsolutePosition(Tuple3d newToAbsolutePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__TO_ABSOLUTE_POSITION, oldToAbsolutePosition, toAbsolutePosition));
	}
	...
	public Tuple3d getToRelativePosition() {
		if (toRelativePosition != null && toRelativePosition.eIsProxy()) {
			...
			if (toRelativePosition != oldToRelativePosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__TO_RELATIVE_POSITION, oldToRelativePosition, toRelativePosition));
			}
		}
	...
	public void setToRelativePositionGen(Tuple3d newToRelativePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsPackage.ABSTRACT_TWO_POINTS3_DTOOL__TO_RELATIVE_POSITION, oldToRelativePosition, toRelativePosition));
	}
	...
	protected void updateFromAbsolutePosition()
	{
		...
		if(getFromNode() != null)
		{
			...
			ApogyCommonEmfTransactionFacade.INSTANCE.basicSet(this, ApogyAddonsPackage.Literals.ABSTRACT_TWO_POINTS3_DTOOL__FROM_ABSOLUTE_POSITION, ApogyCommonMathFacade.INSTANCE.createTuple3d(from));			
		}
	}
	...
	protected void updateToAbsolutePosition()
	{
		...
		if(getToNode() != null)
		{
			...
			ApogyCommonEmfTransactionFacade.INSTANCE.basicSet(this, ApogyAddonsPackage.Literals.ABSTRACT_TWO_POINTS3_DTOOL__TO_ABSOLUTE_POSITION, ApogyCommonMathFacade.INSTANCE.createTuple3d(to));				
		}
	}
	...
	protected void updateDistance()
	{
		...
		ApogyCommonEmfTransactionFacade.INSTANCE.basicSet(this, ApogyAddonsPackage.Literals.ABSTRACT_TWO_POINTS3_DTOOL__DISTANCE, distance);								
	}
