package ca.gc.asc_csa.jinput.ui.views;
...
public class JInputStatusView extends ViewPart {
	...
	public static final String ID = "ca.gc.asc_csa.jinput.ui.views.JInputStatusView";
	...
	public void createPartControl(final Composite parent) {
		...
		ca.gc.asc_csa.jinput.Activator.getEControllerEnvironment().eAdapters().add(viewerAdapter);
		
		parent.addDisposeListener(new DisposeListener() {
			@Override
			public void widgetDisposed(DisposeEvent e) {
				ca.gc.asc_csa.jinput.Activator.getEControllerEnvironment().eAdapters().remove(viewerAdapter);
				viewerAdapter = null;
			}
		});
	}
