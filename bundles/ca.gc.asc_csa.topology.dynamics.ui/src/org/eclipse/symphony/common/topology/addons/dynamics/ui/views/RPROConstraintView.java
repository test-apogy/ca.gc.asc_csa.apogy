...
import org.eclipse.symphony.common.topology.addons.dynamics.ui.composites.RPROConstraintComposite;

public class RPROConstraintView extends AbstractPinableView<RPROConstraint>
{
	private RPROConstraint rPROConstraint;
	public static final String ID = "org.eclipse.symphony.common.topology.addons.dynamics.ui.views.RPROConstraintView"; //$NON-NLS-1$
