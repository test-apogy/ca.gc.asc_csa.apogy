...
public class PrismaticConstraintComposite extends Composite {
	...
	private ca.gc.asc_csa.topology.dynamics.PrismaticConstraint prismaticConstraint;
	...
	public PrismaticConstraintComposite(
			Composite parent,
			int style,
			ca.gc.asc_csa.topology.dynamics.PrismaticConstraint newPrismaticConstraint) {
		this(parent, style);
	...
	public ca.gc.asc_csa.topology.dynamics.PrismaticConstraint getPrismaticConstraint() {
		return prismaticConstraint;
	}

	public void setPrismaticConstraint(ca.gc.asc_csa.topology.dynamics.PrismaticConstraint newPrismaticConstraint) 
	{
