...
public class HingeConstraintComposite extends Composite {
	...
	private ca.gc.asc_csa.topology.dynamics.HingeConstraint hingeConstraint;
	...
	public HingeConstraintComposite(Composite parent, int style,
			ca.gc.asc_csa.topology.dynamics.HingeConstraint newHingeConstraint) {
		this(parent, style);
	...
	public ca.gc.asc_csa.topology.dynamics.HingeConstraint getHingeConstraint() {
		return hingeConstraint;
	}

	public void setHingeConstraint(ca.gc.asc_csa.topology.dynamics.HingeConstraint newHingeConstraint) 
	{			
