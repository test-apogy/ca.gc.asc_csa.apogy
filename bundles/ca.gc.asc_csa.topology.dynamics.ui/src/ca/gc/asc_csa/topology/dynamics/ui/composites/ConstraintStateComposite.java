...
public class ConstraintStateComposite extends Composite {
	...
	private ca.gc.asc_csa.topology.dynamics.ConstraintState constraintState;
	private Text forceText;
	private Text positionText;
	private Text velocityText;

	public ConstraintStateComposite(Composite parent, int style,
			ca.gc.asc_csa.topology.dynamics.ConstraintState newConstraintState) {
		this(parent, style);
	...
	private DataBindingContext initDataBindings() 
	{
		...
		IObservableValue forceObserveValue = EMFObservables.observeValue(
						constraintState,
						ca.gc.asc_csa.topology.dynamics.TopologyDynamicsPackage.Literals.CONSTRAINT_STATE__FORCE);
		...
		IObservableValue positionObserveValue = EMFObservables.observeValue(
						constraintState,
						ca.gc.asc_csa.topology.dynamics.TopologyDynamicsPackage.Literals.CONSTRAINT_STATE__POSITION);
		...
		IObservableValue velocityObserveValue = EMFObservables.observeValue(
						constraintState,
						ca.gc.asc_csa.topology.dynamics.TopologyDynamicsPackage.Literals.CONSTRAINT_STATE__VELOCITY);
	...
	public ca.gc.asc_csa.topology.dynamics.ConstraintState getConstraintState() {
