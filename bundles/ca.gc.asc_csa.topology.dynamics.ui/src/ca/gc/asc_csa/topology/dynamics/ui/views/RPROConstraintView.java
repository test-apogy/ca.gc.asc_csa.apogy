...
import ca.gc.asc_csa.topology.dynamics.ui.composites.RPROConstraintComposite;

public class RPROConstraintView extends AbstractPinableView<RPROConstraint>
{
	private RPROConstraint rPROConstraint;
	public static final String ID = "ca.gc.asc_csa.topology.dynamics.ui.views.RPROConstraintView"; //$NON-NLS-1$
