...
public class EImagesUtilitiesImpl extends MinimalEObjectImpl.Container implements EImagesUtilities 
{
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___COPY__ABSTRACTEIMAGE:
				return copy((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CONVERT_TO_GRAY_SCALE__ABSTRACTEIMAGE:
				return convertToGrayScale((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___RESIZE__ABSTRACTEIMAGE_DOUBLE:
				return resize((AbstractEImage)arguments.get(0), (Double)arguments.get(1));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___RESIZE__ABSTRACTEIMAGE_DOUBLE_DOUBLE:
				return resize((AbstractEImage)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___RESIZE__ABSTRACTEIMAGE_INT_INT:
				return resize((AbstractEImage)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CREATE_TRANSPARENT_IMAGE__INT_INT:
				return createTransparentImage((Integer)arguments.get(0), (Integer)arguments.get(1));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___SAVE_IMAGE_AS_JPEG__STRING_ABSTRACTEIMAGE:
				try {
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___SAVE_IMAGE_AS_PNG__STRING_ABSTRACTEIMAGE:
				try {
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_OVERLAY__ABSTRACTEIMAGE_ABSTRACTEIMAGE_BOOLEAN:
				return applyOverlay((AbstractEImage)arguments.get(0), (AbstractEImage)arguments.get(1), (Boolean)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___FLIP_HORIZONTAL__ABSTRACTEIMAGE:
				return flipHorizontal((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___FLIP_VERTICAL__ABSTRACTEIMAGE:
				return flipVertical((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___ROTATE__ABSTRACTEIMAGE_DOUBLE_BOOLEAN:
				return rotate((AbstractEImage)arguments.get(0), (Double)arguments.get(1), (Boolean)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___TRANSLATE__ABSTRACTEIMAGE_INT_INT:
				return translate((AbstractEImage)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___GET_ALL_ENCOMPASSING_IMAGE_SIZE__LIST:
				return getAllEncompassingImageSize((List<? extends AbstractEImage>)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___SUPER_POSE_IMAGES__LIST_BOOLEAN_IMAGEALIGNMENT:
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___SUPER_POSE_IMAGES__ABSTRACTEIMAGE_ABSTRACTEIMAGE_BOOLEAN_IMAGEALIGNMENT:
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___ADD_BORDER__ABSTRACTEIMAGE_INT_INT_INT_INT:
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___GET_SUB_IMAGE__ABSTRACTEIMAGE_INT_INT_INT_INT:
				try {
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CONVERT_TO_BUFFERED_IMAGE__IMAGEDATA:
				return convertToBufferedImage((ImageData)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CONVERT_TO_IMAGE_DATA__BUFFEREDIMAGE:
				return convertToImageData((BufferedImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CREATE_UNIFORM_COLOR_IMAGE__INT_INT_INT_INT_INT_INT:
			...
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_ALPHA__ABSTRACTEIMAGE_FLOAT:
				return applyAlpha((AbstractEImage)arguments.get(0), (Float)arguments.get(1));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_EDGE_FILTER__ABSTRACTEIMAGE:
				return applyEdgeFilter((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_CONTRAST_AND_BRIGHTNESS_FILTER__ABSTRACTEIMAGE_DOUBLE_DOUBLE:
				return applyContrastAndBrightnessFilter((AbstractEImage)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_EXPOSURE_FILTER__ABSTRACTEIMAGE_DOUBLE:
				return applyExposureFilter((AbstractEImage)arguments.get(0), (Double)arguments.get(1));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_INVERT_FILTER__ABSTRACTEIMAGE:
				return applyInvertFilter((AbstractEImage)arguments.get(0));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_RESCALE_FILTER__ABSTRACTEIMAGE_DOUBLE:
				return applyRescaleFilter((AbstractEImage)arguments.get(0), (Double)arguments.get(1));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___APPLY_GAIN_FILTER__ABSTRACTEIMAGE_DOUBLE_DOUBLE:
				return applyGainFilter((AbstractEImage)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyCommonImagesPackage.EIMAGES_UTILITIES___CREATE_TEXT_IMAGE__STRING_FONT_COLOR_COLOR_INT:
