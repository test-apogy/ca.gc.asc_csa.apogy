 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getPointSize <em>Point Size</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getPresentationMode <em>Presentation Mode</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getEndPointsRadius <em>End Points Radius</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.geometry.paths.ui.PathsUIPackage#getWayPointPathPresentation()
 * @model
 * @generated
 */
public interface WayPointPathPresentation extends NodePresentation {
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.ui.PathsUIPackage#getWayPointPathPresentation_PointSize()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getPointSize <em>Point Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ca.gc.space.mrt.geometry.paths.ui.PathPresentationMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.ui.PathsUIPackage#getWayPointPathPresentation_PresentationMode()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getPresentationMode <em>Presentation Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.ui.PathsUIPackage#getWayPointPathPresentation_EndPointsRadius()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.ui.WayPointPathPresentation#getEndPointsRadius <em>End Points Radius</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
