 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.symphony.addons.geometry.paths.ui.PathsUIPackage
 * @generated
 */
public class PathsUISwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PathsUIPackage.WAY_POINT_PATH_PRESENTATION: {
			...
			case PathsUIPackage.WAY_POINT_PRESENTATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Way Point Path Presentation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Way Point Path Presentation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWayPointPathPresentation(WayPointPathPresentation object) {
		return null;
	}
