 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolNodeImpl#getSunVector3DTool <em>Sun Vector3 DTool</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SunVector3DToolNodeImpl extends NodeImpl implements SunVector3DToolNode {
		...
		if (sunVector3DTool != null && sunVector3DTool.eIsProxy()) {
			...
			if (sunVector3DTool != oldSunVector3DTool) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, oldSunVector3DTool, sunVector3DTool));
			}
		}
	...
	public NotificationChain basicSetSunVector3DTool(SunVector3DTool newSunVector3DTool, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, oldSunVector3DTool, newSunVector3DTool);
	...
	public void setSunVector3DTool(SunVector3DTool newSunVector3DTool) {
		if (newSunVector3DTool != sunVector3DTool) {
			...
			if (sunVector3DTool != null)
				msgs = ((InternalEObject)sunVector3DTool).eInverseRemove(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, SunVector3DTool.class, msgs);
			if (newSunVector3DTool != null)
				msgs = ((InternalEObject)newSunVector3DTool).eInverseAdd(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, SunVector3DTool.class, msgs);
			msgs = basicSetSunVector3DTool(newSunVector3DTool, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, newSunVector3DTool, newSunVector3DTool));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL:
				if (sunVector3DTool != null)
					msgs = ((InternalEObject)sunVector3DTool).eInverseRemove(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, SunVector3DTool.class, msgs);
