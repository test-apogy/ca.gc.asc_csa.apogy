 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getVectorColor <em>Vector Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getVectorLength <em>Vector Length</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getEndPointRadius <em>End Point Radius</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getSunIntensity <em>Sun Intensity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getCurrentDayMaximumSunIntensity <em>Current Day Maximum Sun Intensity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getCurrentSunIntensityPercentage <em>Current Sun Intensity Percentage</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.earth.surface.ui.impl.SunVector3DToolImpl#getSunVector3DToolNode <em>Sun Vector3 DTool Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SunVector3DToolImpl extends AbstractTwoPoints3DToolImpl implements SunVector3DTool 
{
	...
	public void setVectorColor(Color3f newVectorColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__VECTOR_COLOR, oldVectorColor, vectorColor));
	}
	...
	public void setVectorLengthGen(double newVectorLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__VECTOR_LENGTH, oldVectorLength, vectorLength));
	}
	...
	public void setEndPointRadius(double newEndPointRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__END_POINT_RADIUS, oldEndPointRadius, endPointRadius));
	}
	...
	public void setSunIntensity(double newSunIntensity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_INTENSITY, oldSunIntensity, sunIntensity));
	}
	...
	public void setCurrentDayMaximumSunIntensity(double newCurrentDayMaximumSunIntensity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__CURRENT_DAY_MAXIMUM_SUN_INTENSITY, oldCurrentDayMaximumSunIntensity, currentDayMaximumSunIntensity));
	}
	...
	public void setCurrentSunIntensityPercentage(double newCurrentSunIntensityPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__CURRENT_SUN_INTENSITY_PERCENTAGE, oldCurrentSunIntensityPercentage, currentSunIntensityPercentage));
	}
	...
	public SunVector3DToolNode getSunVector3DToolNode() {
		if (sunVector3DToolNode != null && sunVector3DToolNode.eIsProxy()) {
			...
			if (sunVector3DToolNode != oldSunVector3DToolNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, oldSunVector3DToolNode, sunVector3DToolNode));
			}
		}
	...
	public NotificationChain basicSetSunVector3DToolNode(SunVector3DToolNode newSunVector3DToolNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, oldSunVector3DToolNode, newSunVector3DToolNode);
	...
	public void setSunVector3DToolNode(SunVector3DToolNode newSunVector3DToolNode) {
		if (newSunVector3DToolNode != sunVector3DToolNode) {
			...
			if (sunVector3DToolNode != null)
				msgs = ((InternalEObject)sunVector3DToolNode).eInverseRemove(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, SunVector3DToolNode.class, msgs);
			if (newSunVector3DToolNode != null)
				msgs = ((InternalEObject)newSunVector3DToolNode).eInverseAdd(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, SunVector3DToolNode.class, msgs);
			msgs = basicSetSunVector3DToolNode(newSunVector3DToolNode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE, newSunVector3DToolNode, newSunVector3DToolNode));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_VECTOR3_DTOOL_NODE:
				if (sunVector3DToolNode != null)
					msgs = ((InternalEObject)sunVector3DToolNode).eInverseRemove(this, ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL_NODE__SUN_VECTOR3_DTOOL, SunVector3DToolNode.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__VECTOR_COLOR:
				return getVectorColor();
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__VECTOR_LENGTH:
				return getVectorLength();
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__END_POINT_RADIUS:
				return getEndPointRadius();
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__SUN_INTENSITY:
				return getSunIntensity();
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__CURRENT_DAY_MAXIMUM_SUN_INTENSITY:
				return getCurrentDayMaximumSunIntensity();
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.SUN_VECTOR3_DTOOL__CURRENT_SUN_INTENSITY_PERCENTAGE:
