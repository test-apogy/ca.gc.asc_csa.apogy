...
public class EnvironmentUIUtilitiesImpl extends MinimalEObjectImpl.Container implements EnvironmentUIUtilities 
{
	...
	protected EClass eStaticClass() {
		return ApogyCoreEnvironmentSurfaceEarthUIPackage.Literals.ENVIRONMENT_UI_UTILITIES;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.ENVIRONMENT_UI_UTILITIES___TO_POINT3F__STAR:
				return toPoint3f((Star)arguments.get(0));
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.ENVIRONMENT_UI_UTILITIES___GET_POINT_SIZE_FOR_MAGNITUDE__FLOAT_FLOAT_FLOAT_FLOAT_FLOAT:
			...
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.ENVIRONMENT_UI_UTILITIES___GET_SUN_LIGHT_COLOR__DOUBLE:
				return getSunLightColor((Double)arguments.get(0));
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.ENVIRONMENT_UI_UTILITIES___GET_SKY_TRANSPARENCY__DOUBLE:
				return getSkyTransparency((Double)arguments.get(0));
			case ApogyCoreEnvironmentSurfaceEarthUIPackage.ENVIRONMENT_UI_UTILITIES___GET_SKY_COLOR__DOUBLE:
