 ...
 */
package ca.gc.asc_csa.eclipse.images.core.provider;
...
import ca.gc.asc_csa.eclipse.images.core.ImagesAlbum;
import ca.gc.asc_csa.eclipse.images.core.ImagesCorePackage;

/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.images.core.ImagesAlbum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImagesAlbumItemProvider
	 ...
	 * @generated
	 */
	public ImagesAlbumItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImagesAlbum"));
	}
	...
	public String getText(Object object) {
		String label = ((ImagesAlbum)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ImagesAlbum_type") :
			getString("_UI_ImagesAlbum_type") + " " + label;
	}
