...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.images.core.EImage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EImageItemProvider
	 ...
	 * @generated
	 */
	public EImageItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EImage"));
	}
	...
	{
		EImage eImage = (EImage)object;
		
		String label = getString("_UI_EImage_type");
		label += " (" + eImage.getWidth() + " x " + eImage.getHeight() + ")";
