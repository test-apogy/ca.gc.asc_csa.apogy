...
public class EMFEcoreInvocatorUIFacadeImpl extends MinimalEObjectImpl.Container implements EMFEcoreInvocatorUIFacade {
	...
	protected EClass eStaticClass() {
		return Symphony__CoreInvocatorUIPackage.Literals.EMF_ECORE_INVOCATOR_UI_FACADE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Symphony__CoreInvocatorUIPackage.EMF_ECORE_INVOCATOR_UI_FACADE___COPY_INITIALIZATION_DATA__CONTEXT_CONTEXT:
				try {
			...
			case Symphony__CoreInvocatorUIPackage.EMF_ECORE_INVOCATOR_UI_FACADE___COPY_INITIALIZATION_DATA__ABSTRACTTYPEIMPLEMENTATION_ABSTRACTTYPEIMPLEMENTATION_COMPOUNDCOMMAND:
				try {
