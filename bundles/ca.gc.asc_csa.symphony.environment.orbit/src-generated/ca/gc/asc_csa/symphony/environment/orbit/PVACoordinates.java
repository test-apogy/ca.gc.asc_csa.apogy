 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getPosition <em>Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getVelocity <em>Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getAngularVelocity <em>Angular Velocity</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getPVACoordinates()
 * @model
 * @generated
 */
public interface PVACoordinates extends EObject {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getPVACoordinates_Position()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getPosition <em>Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getPVACoordinates_Velocity()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getVelocity <em>Velocity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getPVACoordinates_Acceleration()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getAcceleration <em>Acceleration</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getPVACoordinates_AngularVelocity()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.PVACoordinates#getAngularVelocity <em>Angular Velocity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
