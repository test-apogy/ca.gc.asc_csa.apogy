 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getReferenceFrame <em>Reference Frame</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getAttitudeProvider <em>Attitude Provider</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getInitialOrbit <em>Initial Orbit</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getValidFromDate <em>Valid From Date</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.AbstractOrbitPropagatorImpl#getValidToDate <em>Valid To Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
