 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.Orbit#getReferenceFrame <em>Reference Frame</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getOrbit()
 * @model abstract="true"
 * @generated
 */
public interface Orbit extends Named, Described, Timed {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getOrbit_ReferenceFrame()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.Orbit#getReferenceFrame <em>Reference Frame</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
