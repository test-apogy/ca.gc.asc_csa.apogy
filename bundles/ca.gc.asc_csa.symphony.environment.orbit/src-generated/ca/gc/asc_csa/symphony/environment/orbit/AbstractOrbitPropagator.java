 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getReferenceFrame <em>Reference Frame</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getAttitudeProvider <em>Attitude Provider</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getInitialOrbit <em>Initial Orbit</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getValidFromDate <em>Valid From Date</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getValidToDate <em>Valid To Date</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator()
 * @model abstract="true"
 * @generated
 */
public interface AbstractOrbitPropagator extends Named, Described {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator_ReferenceFrame()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getReferenceFrame <em>Reference Frame</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.symphony.environment.orbit.AttitudeProvider}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * *
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator_AttitudeProvider()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator_InitialOrbit()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getInitialOrbit <em>Initial Orbit</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator_ValidFromDate()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getValidFromDate <em>Valid From Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.orbit.SymphonyOrbitEnvironmentPackage#getAbstractOrbitPropagator_ValidToDate()
	 * @model unique="false" required="true"
	 * @generated
	 */
	Date getValidToDate();
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.orbit.AbstractOrbitPropagator#getValidToDate <em>Valid To Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" exceptions="ca.gc.asc_csa.symphony.environment.orbit.Exception" targetDateUnique="false"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.orbit.List<ca.gc.asc_csa.symphony.environment.orbit.SpacecraftState>" unique="false" many="false" exceptions="ca.gc.asc_csa.symphony.environment.orbit.Exception" startDateUnique="false" endDateUnique="false" timeIntervalUnique="false"
