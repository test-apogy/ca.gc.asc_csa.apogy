 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.orbit.impl.TimedStampedPVACoordinatesImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimedStampedPVACoordinatesImpl extends PVACoordinatesImpl implements TimedStampedPVACoordinates {
	...
	protected EClass eStaticClass() {
		return SymphonyOrbitEnvironmentPackage.Literals.TIMED_STAMPED_PVA_COORDINATES;
	}
	...
	public void setTime(Date newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyOrbitEnvironmentPackage.TIMED_STAMPED_PVA_COORDINATES__TIME, oldTime, time));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (derivedFeatureID) {
				case SymphonyOrbitEnvironmentPackage.TIMED_STAMPED_PVA_COORDINATES__TIME: return EMFEcorePackage.TIMED__TIME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Timed.class) {
			switch (baseFeatureID) {
				case EMFEcorePackage.TIMED__TIME: return SymphonyOrbitEnvironmentPackage.TIMED_STAMPED_PVA_COORDINATES__TIME;
				default: return -1;
			}
		}
