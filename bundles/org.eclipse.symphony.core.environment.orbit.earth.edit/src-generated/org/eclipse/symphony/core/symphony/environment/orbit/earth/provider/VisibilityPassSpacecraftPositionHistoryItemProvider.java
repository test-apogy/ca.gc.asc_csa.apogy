...
/**
 * This is the item provider adapter for a {@link org.eclipse.symphony.core.environment.orbit.earth.VisibilityPassSpacecraftPositionHistory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VisibilityPassSpacecraftPositionHistoryItemProvider 
	...
	protected DecimalFormat intervalFormat = new DecimalFormat("0.0");
	...
	public String getText(Object object) 
	{
		...
		String label = getString("_UI_VisibilityPassSpacecraftPositionHistory_type");
		
		try
		{
			label += "( " + DELTA_STRING + "t " + intervalFormat.format(visibilityPassSpacecraftPositionHistory.getTimeInterval()) + "s)";
			label += "[" + visibilityPassSpacecraftPositionHistory.getPositions().size() +"]";
		}
		catch(Throwable t)
		{			
		}
