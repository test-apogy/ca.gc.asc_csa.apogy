 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.addons.sensors.imaging.camera.impl.AbstractTextOverlayImpl#getFontName <em>Font Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.addons.sensors.imaging.camera.impl.AbstractTextOverlayImpl#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.addons.sensors.imaging.camera.impl.AbstractTextOverlayImpl#getHorizontalOffset <em>Horizontal Offset</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.addons.sensors.imaging.camera.impl.AbstractTextOverlayImpl#getVerticalOffset <em>Vertical Offset</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.addons.sensors.imaging.camera.impl.AbstractTextOverlayImpl#getTextColor <em>Text Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTextOverlayImpl extends DrawnCameraOverlayImpl implements AbstractTextOverlay
{
  ...
  public void setFontName(String newFontName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__FONT_NAME, oldFontName, fontName));
	}
  ...
  public void setFontSize(int newFontSize)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__FONT_SIZE, oldFontSize, fontSize));
	}
  ...
  public void setHorizontalOffset(int newHorizontalOffset)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__HORIZONTAL_OFFSET, oldHorizontalOffset, horizontalOffset));
	}
  ...
  public void setVerticalOffset(int newVerticalOffset)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__VERTICAL_OFFSET, oldVerticalOffset, verticalOffset));
	}
  ...
  public void setTextColor(Color3f newTextColor)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__TEXT_COLOR, oldTextColor, textColor));
	}
  ...
  {
		switch (featureID) {
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__FONT_NAME:
				return getFontName();
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__FONT_SIZE:
				return getFontSize();
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__HORIZONTAL_OFFSET:
				return getHorizontalOffset();
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__VERTICAL_OFFSET:
				return getVerticalOffset();
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY__TEXT_COLOR:
				return getTextColor();
		}
  ...
  {
		switch (operationID) {
			case ApogyAddonsSensorsImagingCameraPackage.ABSTRACT_TEXT_OVERLAY___GET_DISPLAYED_STRING:
