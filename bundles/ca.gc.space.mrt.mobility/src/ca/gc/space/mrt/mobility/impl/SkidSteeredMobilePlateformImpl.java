 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getCommandedRightWheelsVelocity <em>Commanded Right Wheels Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getActualRightWheelsVelocity <em>Actual Right Wheels Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getCommandedLeftWheelsVelocity <em>Commanded Left Wheels Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getActualLeftWheelsVelocity <em>Actual Left Wheels Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getCommandedAngularVelocity <em>Commanded Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getActualAngularVelocity <em>Actual Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getCommandedTranslationVelocity <em>Commanded Translation Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getActualTranslationVelocity <em>Actual Translation Velocity</em>}</li>
 *   <li>{@link ca.gc.space.mrt.mobility.impl.SkidSteeredMobilePlateformImpl#getEffectiveSteeringWidth <em>Effective Steering Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
