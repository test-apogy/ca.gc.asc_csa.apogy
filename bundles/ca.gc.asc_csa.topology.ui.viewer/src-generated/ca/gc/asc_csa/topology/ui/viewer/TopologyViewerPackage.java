 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='TopologyViewer' childCreationExtenders='true' extensibleProviderFactory='true' multipleEditorPages='false' copyrightText='Agence spatiale canadienne / Canadian Space Agency 2015 Copyrights (c)' modelName='TopologyViewer' complianceLevel='6.0' modelDirectory='/ca.gc.asc_csa.topology.ui.viewer/src-generated' editDirectory='/ca.gc.asc_csa.topology.ui.viewer.edit/src-generated' basePackage='ca.gc.asc_csa.topology.ui'"
 * @generated
 */
public interface TopologyViewerPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "ca.gc.asc_csa.topology.ui.viewer";
	 ...
	 * @generated
	 */
	TopologyViewerPackage eINSTANCE = ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerPackageImpl.init();

	/**
	 * The meta object id for the '{@link ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerRegistryImpl <em>Registry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerRegistryImpl
	 * @see ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerPackageImpl#getTopologyViewerRegistry()
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer
	 * @see ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerPackageImpl#getITopologyViewer()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry <em>Registry</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Registry</em>'.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry
	 * @generated
	 */
	EClass getTopologyViewerRegistry();

	/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#isVerbose <em>Verbose</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Verbose</em>'.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#isVerbose()
	...
	/**
	 * Returns the meta object for the attribute list '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#getITopologyViewers <em>ITopology Viewers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>ITopology Viewers</em>'.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#getITopologyViewers()
	 * @see #getTopologyViewerRegistry()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#getLatestNodeSelection <em>Latest Node Selection</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Latest Node Selection</em>'.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#getLatestNodeSelection()
	 * @see #getTopologyViewerRegistry()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#registerITopologyViewer(ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer) <em>Register ITopology Viewer</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Register ITopology Viewer</em>' operation.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#registerITopologyViewer(ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer)
	 * @generated
	 */
	EOperation getTopologyViewerRegistry__RegisterITopologyViewer__ITopologyViewer();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#unRegisterITopologyViewer(ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer) <em>Un Register ITopology Viewer</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Un Register ITopology Viewer</em>' operation.
	 * @see ca.gc.asc_csa.topology.ui.viewer.TopologyViewerRegistry#unRegisterITopologyViewer(ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer)
	 * @generated
	 */
	EOperation getTopologyViewerRegistry__UnRegisterITopologyViewer__ITopologyViewer();

	/**
	 * Returns the meta object for data type '{@link ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer <em>ITopology Viewer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for data type '<em>ITopology Viewer</em>'.
	 * @see ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer
	 * @model instanceClass="ca.gc.asc_csa.topology.ui.viewer.ITopologyViewer"
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerRegistryImpl <em>Registry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerRegistryImpl
		 * @see ca.gc.asc_csa.topology.ui.viewer.impl.TopologyViewerPackageImpl#getTopologyViewerRegistry()
