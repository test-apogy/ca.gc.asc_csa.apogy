 ...
 * 
 */
public class TopologyViewerLightingPreferences {
	...
	public IPreferenceStore getPreferenceStore() 
	{
		if (preferenceStore == null) 
		{
			...
			String qualifier = ca.gc.asc_csa.topology.ui.viewer.Activator.ID;
	...
	public float getKeyLightWarmth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_LIGHT_WARMTH);
	}

	public float getKeyLightIntensity() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_LIGHT_INTENSITY);
	}

	public float getKeyLightElevation() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_LIGHT_ELEVATION);
	}

	public float getKeyLightAzimuth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_LIGHT_AZIMUTH);
	}

	// Fill light
	public float getFillLightWarmth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_FILL_LIGHT_WARMTH);
	}

	public float getKeyToFillRatio() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_TO_FILL_RATIO);
	}

	public float getFillLightElevation() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_FILL_LIGHT_ELEVATION);
	}

	public float getFillLightAzimuth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_FILL_LIGHT_AZIMUTH);
	}

	// Back light
	public float getBackLightWarmth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_BACK_LIGHT_WARMTH);
	}

	public float getKeyToBackRatio() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_TO_BACK_RATIO);
	}

	public float getBackLightElevation() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_BACK_LIGHT_ELEVATION);
	}

	public float getBackLightAzimuth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_BACK_LIGHT_AZIMUTH);
	}

	// Head light
	public float getHeadLightWarmth() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_HEAD_LIGHT_WARMTH);
	}

	public float getKeyToHeadRatio() {
		return getPreferenceStore().getFloat(
				TopologyViewerLightingPreferenceConstants.P_KEY_TO_HEAD_RATIO);
	}
	...
	public boolean isKeyLightEnabled() {
		return getPreferenceStore().getBoolean(
				TopologyViewerLightingPreferenceConstants.P_KEY_LIGHT_ENABLED);
	}
	...
	public boolean isBackLightEnabled() {
		return getPreferenceStore().getBoolean(
				TopologyViewerLightingPreferenceConstants.P_BACK_LIGHT_ENABLED);
	}
	...
	public boolean isFillLightEnabled() {
		return getPreferenceStore().getBoolean(
				TopologyViewerLightingPreferenceConstants.P_FILL_LIGHT_ENABLED);
	}
	...
	public boolean isHeadLightEnabled() {
		return getPreferenceStore().getBoolean(
				TopologyViewerLightingPreferenceConstants.P_HEAD_LIGHT_ENABLED);
	}
