...
public class ControllersPackageImpl extends EPackageImpl implements ControllersPackage
{
	...
	public void initializePackageContents()
	{
		...
		EGenericType g1 = createEGenericType(theMobilityPackage.getMobilePlatform());
		...
		g1 = createEGenericType(theMobilityPackage.getSkidSteeredMobilePlatform());
		...
		g2 = createEGenericType(theMobilityPackage.getSkidSteeredMobilePlatform());
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(thePathsPackage.getWayPointPath());
		g1.getETypeArguments().add(g2);
