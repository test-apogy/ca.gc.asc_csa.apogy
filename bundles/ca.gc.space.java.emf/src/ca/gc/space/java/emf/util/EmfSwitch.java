 ...
 *
 */
package ca.gc.space.java.emf.util;
 ...
 * @generated
 */
public class EmfSwitch<T1> extends Switch<T1> {
	/**
	 ...
	 * @generated
	 */
	public <T> T1 caseComparator(Comparator<T> object) {
		return null;
	}
