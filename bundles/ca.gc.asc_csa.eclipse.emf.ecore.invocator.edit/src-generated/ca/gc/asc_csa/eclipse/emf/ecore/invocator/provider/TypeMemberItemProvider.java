...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeMember} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeMemberItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public TypeMemberItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
		if (itemPropertyDescriptors == null) {
			...
			addMemberTypePropertyDescriptor(object);
		}
  ...
  /**
	 * This adds a property descriptor for the Member Type feature.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected void addMemberTypePropertyDescriptor(Object object)
  {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TypeMember"));
	}
  ...
  {
	  TypeMember typeMember = (TypeMember) object;
	  
	  String label = getString("_UI_TypeMember_type");
	  
	  if(typeMember.getName() != null && typeMember.getName().length() > 0)
	  {
		  label = typeMember.getName();
	  }
	  
	  if(typeMember.getMemberType() != null)
	  {
		  label += " (" + typeMember.getMemberType().getName() + ")";
	  }
