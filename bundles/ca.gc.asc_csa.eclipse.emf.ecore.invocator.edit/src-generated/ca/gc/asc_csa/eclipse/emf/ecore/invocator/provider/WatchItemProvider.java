...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.Watch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WatchItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public WatchItemProvider(AdapterFactory adapterFactory)
  {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFEcoreInvocatorPackage.Literals.WATCH__VARIABLE,
				 true,
				 false,
				 true,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EMFEcoreInvocatorPackage.Literals.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT);
			childrenFeatures.add(EMFEcoreInvocatorPackage.Literals.WATCH__TREE_ROOT_NODE);
		}
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Watch"));
	}
  ...
  public String getText(Object object)
  {
		...
		if(watch.getName() != null && watch.getName().length() > 0)
		{
			label = watch.getName();
		}
		else if(watch.getVariable() != null)
		{
			label = watch.getVariable().getName();
		}
		else
		{
			label = getString("_UI_Watch_type");
		}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(EMFEcoreInvocatorPackage.Literals.WATCH__TYPE_MEMBER_REFERENCE_TREE_ELEMENT,
				 EMFEcoreInvocatorFactory.eINSTANCE.createTypeMemberReferenceTreeElement()));

		newChildDescriptors.add
			(createChildParameter
				(EMFEcoreInvocatorPackage.Literals.WATCH__TREE_ROOT_NODE,
