...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.AbstractDisplay} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractDisplayItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public AbstractDisplayItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		String label = ((AbstractDisplay)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractDisplay_type") :
			getString("_UI_AbstractDisplay_type") + " " + label;
	}
