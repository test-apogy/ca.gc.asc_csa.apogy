...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.ExceptionContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExceptionContainerItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ExceptionContainerItemProvider(AdapterFactory adapterFactory)
  {
  ...
  /**
	 * This returns ExceptionContainer.gif.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExceptionContainer"));
	}
  ...
  {
	  ExceptionContainer container = ((ExceptionContainer)object);
	  
	  if (container.getException() == null) return _UI_NO_EXCEPTION_MESSAGE;    
	  else
	  {
		  StringWriter sw = new StringWriter();
		  PrintWriter pw = new PrintWriter(sw);
		  container.getException().printStackTrace(pw);
