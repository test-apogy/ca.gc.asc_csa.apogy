...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypesList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypesListItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public TypesListItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TypesList"));
	}
  ...
  {
		return getString("_UI_TypesList_type");
	}
