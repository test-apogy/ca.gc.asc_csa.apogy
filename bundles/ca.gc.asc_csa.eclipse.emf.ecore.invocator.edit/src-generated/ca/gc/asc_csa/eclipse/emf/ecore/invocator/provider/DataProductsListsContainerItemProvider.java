...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.DataProductsListsContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataProductsListsContainerItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public DataProductsListsContainerItemProvider(AdapterFactory adapterFactory)
  {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFEcoreInvocatorPackage.Literals.DATA_PRODUCTS_LISTS_CONTAINER__INVOCATOR_SESSION,
				 true,
				 false,
				 true,
				 null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EMFEcoreInvocatorPackage.Literals.DATA_PRODUCTS_LISTS_CONTAINER__DATA_PRODUCTS_LIST);
		}
  ...
  /**
	 * This returns DataProductsListsContainer.gif.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataProductsListsContainer"));
	}
  ...
  {
		String label = ((DataProductsListsContainer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DataProductsListsContainer_type") :
			getString("_UI_DataProductsListsContainer_type") + " " + label;
	}
  ...
  public void notifyChanged(Notification notification)
  {
		...
		switch (notification.getFeatureID(DataProductsListsContainer.class)) {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(EMFEcoreInvocatorPackage.Literals.DATA_PRODUCTS_LISTS_CONTAINER__DATA_PRODUCTS_LIST,
				 EMFEcoreInvocatorFactory.eINSTANCE.createDataProductsList()));
	}
