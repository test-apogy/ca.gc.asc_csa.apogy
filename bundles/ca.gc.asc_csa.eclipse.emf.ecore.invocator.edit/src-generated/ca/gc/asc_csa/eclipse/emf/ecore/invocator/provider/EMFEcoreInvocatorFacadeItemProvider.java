...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.EMFEcoreInvocatorFacade} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EMFEcoreInvocatorFacadeItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreInvocatorFacadeItemProvider(AdapterFactory adapterFactory)
  {
  ...
  /**
	...
	protected void addActiveInvocatorSessionPropertyDescriptor(Object object) {
		...
		/**
	 * This returns EMFEcoreInvocatorFacade.gif.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EMFEcoreInvocatorFacade"));
	}
  ...
  {
		return getString("_UI_EMFEcoreInvocatorFacade_type");
	}
