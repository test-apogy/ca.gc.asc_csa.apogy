 ...
 * @generated
 */
public class PathPlannersUISwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PathPlannersUIPackage.CIRCULAR_EXCLUSION_ZONE_PRESENTATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Circular Exclusion Zone Presentation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Circular Exclusion Zone Presentation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCircularExclusionZonePresentation(CircularExclusionZonePresentation object) {
		return null;
	}
