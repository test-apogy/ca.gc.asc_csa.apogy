...
/**
 * This is the item provider adapter for a {@link ca.gc.space.topology.CADNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CADNodeItemProvider
	extends URLNodeItemProvider
	implements
	 ...
	 * @generated
	 */
	public CADNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CADNode"));
	}
	...
	{
		CADNode cadNode = (CADNode)object;
		String label = null;
		if(cadNode.getNodeId() != null && cadNode.getNodeId().length() > 0)
		{
			label = cadNode.getNodeId();
		}
		else
		{
			label = getString("_UI_CADNode_type");
		}
