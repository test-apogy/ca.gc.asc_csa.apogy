 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.pose.impl.PoseSensorImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.pose.impl.PoseSensorImpl#getPositionCoordinates <em>Position Coordinates</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.pose.impl.PoseSensorImpl#getOrientationCoordinates <em>Orientation Coordinates</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.pose.impl.PoseSensorImpl#getPose <em>Pose</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.pose.impl.PoseSensorImpl#getDataLogger <em>Data Logger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
