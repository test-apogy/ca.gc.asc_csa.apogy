 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#getServiceName <em>Service Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#isLaunched <em>Launched</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#getServiceClient <em>Service Client</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#getNode <em>Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.ros.impl.RosServiceImpl#isDisconnectOnTimeout <em>Disconnect On Timeout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RosServiceImpl<Request extends Message, Response extends Message> extends MinimalEObjectImpl.Container implements RosService<Request, Response>
{
  ...
  {
		return RosPackage.Literals.ROS_SERVICE;
	}
  ...
  public void setServiceName(String newServiceName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__SERVICE_NAME, oldServiceName, serviceName));
	}
  ...
  public void setServiceType(String newServiceType)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__SERVICE_TYPE, oldServiceType, serviceType));
	}
  ...
  public void setLaunched(boolean newLaunched)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__LAUNCHED, oldLaunched, launched));
	}
  ...
  public void setServiceClient(ServiceClient<Request, Response> newServiceClient)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__SERVICE_CLIENT, oldServiceClient, serviceClient));
	}
  ...
  public RosNode getNode()
  {
		if (node != null && node.eIsProxy()) {
			...
			if (node != oldNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RosPackage.ROS_SERVICE__NODE, oldNode, node));
			}
		}
		return node;
	}
  ...
  public void setNode(RosNode newNode)
  {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__NODE, oldNode, node));
	}
  ...
  public void setDisconnectOnTimeout(boolean newDisconnectOnTimeout)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RosPackage.ROS_SERVICE__DISCONNECT_ON_TIMEOUT, oldDisconnectOnTimeout, disconnectOnTimeout));
	}
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
		switch (featureID) {
			...
			case RosPackage.ROS_SERVICE__NODE:
  ...
  {
		switch (operationID) {
			case RosPackage.ROS_SERVICE___LAUNCH__ROSNODE:
				try {
			...
			case RosPackage.ROS_SERVICE___STOP:
				stop();
				return null;
			case RosPackage.ROS_SERVICE___NEW_REQUEST_MESSAGE:
				return newRequestMessage();
			case RosPackage.ROS_SERVICE___CALL__MESSAGE:
				return call((Request)arguments.get(0));
			case RosPackage.ROS_SERVICE___CALL__MESSAGE_BOOLEAN:
