...
public class MobilityItemProviderAdapterFactory extends MobilityAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender
{
	...
	{
		if (mobilePlatformItemProvider == null) {
			mobilePlatformItemProvider = new MobilePlatformItemProvider(this);
		}

		return mobilePlatformItemProvider;
	}
	...
	{
		if (skidSteeredMobilePlatformItemProvider == null) {
			skidSteeredMobilePlatformItemProvider = new SkidSteeredMobilePlatformItemProvider(this);
		}

		return skidSteeredMobilePlatformItemProvider;
	}
	...
	public void dispose()
	{
		if (mobilePlatformItemProvider != null) mobilePlatformItemProvider.dispose();
		if (skidSteeredMobilePlatformItemProvider != null) skidSteeredMobilePlatformItemProvider.dispose();
	}
