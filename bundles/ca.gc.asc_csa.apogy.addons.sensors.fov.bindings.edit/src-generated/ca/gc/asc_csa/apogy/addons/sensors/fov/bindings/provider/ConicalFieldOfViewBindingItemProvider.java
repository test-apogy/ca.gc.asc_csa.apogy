...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.addons.sensors.fov.bindings.ConicalFieldOfViewBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConicalFieldOfViewBindingItemProvider
  extends AbstractTopologyBindingItemProvider
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ConicalFieldOfViewBindingItemProvider(AdapterFactory adapterFactory)
  {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsSensorsFOVBindingsPackage.Literals.CONICAL_FIELD_OF_VIEW_BINDING__FOV,
				 true,
				 false,
				 true,
				 null,
  ...
  /**
	 * This returns ConicalFieldOfViewBinding.gif.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConicalFieldOfViewBinding"));
	}
  ...
  {
		String label = ((ConicalFieldOfViewBinding)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConicalFieldOfViewBinding_type") :
			getString("_UI_ConicalFieldOfViewBinding_type") + " " + label;
	}
