...
import ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.Activator;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#getTimeSource <em>Time Source</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#getRecordings <em>Recordings</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#getDataStartTime <em>Data Start Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#getDataEndTime <em>Data End Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.recordings.impl.PlayerImpl#getPlayBackTime <em>Play Back Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
