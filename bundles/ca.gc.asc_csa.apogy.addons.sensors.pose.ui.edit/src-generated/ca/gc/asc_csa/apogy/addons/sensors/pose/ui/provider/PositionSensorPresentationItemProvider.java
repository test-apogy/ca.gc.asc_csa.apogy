...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.addons.sensors.pose.ui.PositionSensorPresentation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionSensorPresentationItemProvider extends NodePresentationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PositionSensorPresentationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyAddonsSensorsPoseUIPackage.Literals.POSITION_SENSOR_PRESENTATION__FRAME_VISIBLE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PositionSensorPresentation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PositionSensorPresentation"));
	}
	...
	public String getText(Object object) {
		RGB labelValue = ((PositionSensorPresentation)object).getColor();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PositionSensorPresentation_type") :
			getString("_UI_PositionSensorPresentation_type") + " " + label;
	}
