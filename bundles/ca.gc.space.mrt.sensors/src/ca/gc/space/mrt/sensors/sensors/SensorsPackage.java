 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.space.mrt.sensors.sensors.SensorsFactory
 * @model kind="package"
 * @generated
 */
public interface SensorsPackage extends EPackage {
	 ...
	 * @generated
	 */
	SensorsPackage eINSTANCE = ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl.init();

	/**
	 * The meta object id for the '{@link ca.gc.space.mrt.sensors.sensors.impl.SensorImpl <em>Sensor</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorImpl
	 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getSensor()
	 * @generated
	 */
	int SENSOR = 0;
	...
	/**
	 * The meta object id for the '{@link ca.gc.space.mrt.sensors.sensors.impl.ReferenceableImpl <em>Referenceable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.space.mrt.sensors.sensors.impl.ReferenceableImpl
	 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getReferenceable()
	 * @generated
	 */
	int REFERENCEABLE = 1;
	...
	/**
	 * The meta object id for the '{@link ca.gc.space.mrt.sensors.sensors.SensorStatus <em>Sensor Status</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.space.mrt.sensors.sensors.SensorStatus
	 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getSensorStatus()
	 * @generated
	 */
	int SENSOR_STATUS = 2;

	/**
	 * Returns the meta object for class '{@link ca.gc.space.mrt.sensors.sensors.Sensor <em>Sensor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link ca.gc.space.mrt.sensors.sensors.Sensor#getStatus <em>Status</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Status</em>'.
	 * @see ca.gc.space.mrt.sensors.sensors.Sensor#getStatus()
	 * @see #getSensor()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link ca.gc.space.mrt.sensors.sensors.Referenceable <em>Referenceable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Referenceable</em>'.
	 * @see ca.gc.space.mrt.sensors.sensors.Referenceable
	 * @generated
	 */
	EClass getReferenceable();

	/**
	 * Returns the meta object for the reference '{@link ca.gc.space.mrt.sensors.sensors.Referenceable#getReferenceFrame <em>Reference Frame</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Reference Frame</em>'.
	 * @see ca.gc.space.mrt.sensors.sensors.Referenceable#getReferenceFrame()
	...
	/**
	 * Returns the meta object for enum '{@link ca.gc.space.mrt.sensors.sensors.SensorStatus <em>Sensor Status</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link ca.gc.space.mrt.sensors.sensors.impl.SensorImpl <em>Sensor</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorImpl
		 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getSensor()
		...
		/**
		 * The meta object literal for the '{@link ca.gc.space.mrt.sensors.sensors.impl.ReferenceableImpl <em>Referenceable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.space.mrt.sensors.sensors.impl.ReferenceableImpl
		 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getReferenceable()
		...
		/**
		 * The meta object literal for the '{@link ca.gc.space.mrt.sensors.sensors.SensorStatus <em>Sensor Status</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.space.mrt.sensors.sensors.SensorStatus
		 * @see ca.gc.space.mrt.sensors.sensors.impl.SensorsPackageImpl#getSensorStatus()
