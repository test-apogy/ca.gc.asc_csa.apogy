 ...
 */
package org.eclipse.symphony.common.obsolete.mrt.util;

import org.eclipse.emf.ecore.EObject;
import org.eclipse.emf.ecore.EPackage;
import org.eclipse.emf.ecore.util.Switch;
import org.eclipse.symphony.common.obsolete.mrt.*;
...
public class CommonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommonPackage.TIME_TAGGED_ELEMENT: {
				TimeTaggedElement timeTaggedElement = (TimeTaggedElement)theEObject;
				T result = caseTimeTaggedElement(timeTaggedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommonPackage.SERVER: {
