...
/**
 * This is the item provider adapter for a {@link ca.gc.space.mrt.sensors.range.RangeScanner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RangeScannerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitorable_progressMonitor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitorable_progressMonitor_feature", "_UI_Monitorable_type"),
				 ProcessorsPackage.Literals.MONITORABLE__PROGRESS_MONITOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessorsPackage.Literals.PROCESSOR__INPUT);
			childrenFeatures.add(ProcessorsPackage.Literals.PROCESSOR__OUTPUT);
		}
