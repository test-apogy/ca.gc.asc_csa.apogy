...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.topology.dynamics.ConstraintAttachmentPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintAttachmentPointItemProvider
	...
	protected void addTransformPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintAttachmentPoint_transform_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintAttachmentPoint_transform_feature", "_UI_ConstraintAttachmentPoint_type"),
				 TopologyDynamicsPackage.Literals.CONSTRAINT_ATTACHMENT_POINT__TRANSFORM,
				 true,
				 false,
				 true,
				 null,
				 getString("_UI_GEOMETRY_INFORMATIONPropertyCategory"),
				 null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintAttachmentPoint_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintAttachmentPoint_id_feature", "_UI_ConstraintAttachmentPoint_type"),
				 TopologyDynamicsPackage.Literals.CONSTRAINT_ATTACHMENT_POINT__ID,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ConstraintAttachmentPoint)object).getId();
