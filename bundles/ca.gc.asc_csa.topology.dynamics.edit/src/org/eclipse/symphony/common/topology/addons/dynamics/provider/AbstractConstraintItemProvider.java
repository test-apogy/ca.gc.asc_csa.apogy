...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.topology.dynamics.AbstractConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__SIMULATION_PROPERTIES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				 getString("_UI_GENERAL_INFORMATIONPropertyCategory"),
				 null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractConstraint_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractConstraint_id_feature", "_UI_AbstractConstraint_type"),
				 TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__ID,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__ENABLED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__ATTACHMENT_POINTS);
		}
	...
	/**
	 * This returns AbstractConstraint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AbstractConstraint"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TopologyDynamicsPackage.Literals.ABSTRACT_CONSTRAINT__ATTACHMENT_POINTS,
