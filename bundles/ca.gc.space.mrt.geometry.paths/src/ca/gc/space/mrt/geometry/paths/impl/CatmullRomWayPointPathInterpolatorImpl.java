...
import ca.gc.space.mrt.geometry.paths.SplinesUtilities;
 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.impl.CatmullRomWayPointPathInterpolatorImpl#getTension <em>Tension</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.impl.CatmullRomWayPointPathInterpolatorImpl#getMaximumWayPointsDistance <em>Maximum Way Points Distance</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.impl.CatmullRomWayPointPathInterpolatorImpl#getEndControlPointGenerationMode <em>End Control Point Generation Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
//		List<Point3d> resultPoints = SplinesUtilities.generateCatMullSplineDegreeParam(controlPoints, 
//				10.0,
//				getEndControlPointGenerationMode(), 
//				getTension(), 
//				getProgressMonitor()
