 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getTension <em>Tension</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getMaximumWayPointsDistance <em>Maximum Way Points Distance</em>}</li>
 *   <li>{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getEndControlPointGenerationMode <em>End Control Point Generation Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.geometry.paths.PathsPackage#getCatmullRomWayPointPathInterpolator()
 * @model
 * @generated
 */
public interface CatmullRomWayPointPathInterpolator extends WayPointPathInterpolator {
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.PathsPackage#getCatmullRomWayPointPathInterpolator_Tension()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getTension <em>Tension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.PathsPackage#getCatmullRomWayPointPathInterpolator_MaximumWayPointsDistance()
	 * @model default="1.0"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getMaximumWayPointsDistance <em>Maximum Way Points Distance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link ca.gc.space.mrt.geometry.paths.SplineEndControlPointGenerationMode}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.space.mrt.geometry.paths.PathsPackage#getCatmullRomWayPointPathInterpolator_EndControlPointGenerationMode()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.geometry.paths.CatmullRomWayPointPathInterpolator#getEndControlPointGenerationMode <em>End Control Point Generation Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
