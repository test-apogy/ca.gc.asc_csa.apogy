...
import ca.gc.space.topology.util.NodeRelativePoseListener;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getFromAbsolutePosition <em>From Absolute Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getFromRelativePosition <em>From Relative Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getFromNode <em>From Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#isFromNodeLock <em>From Node Lock</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getToAbsolutePosition <em>To Absolute Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getToRelativePosition <em>To Relative Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getToNode <em>To Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#isToNodeLock <em>To Node Lock</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.AbstractTwoPoints3DToolImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
