 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getVectorColor <em>Vector Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getVectorLength <em>Vector Length</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getEndPointRadius <em>End Point Radius</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getSunIntensity <em>Sun Intensity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getCurrentDayMaximumSunIntensity <em>Current Day Maximum Sun Intensity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getCurrentSunIntensityPercentage <em>Current Sun Intensity Percentage</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.SunVector3DToolImpl#getSunVector3DToolNode <em>Sun Vector3 DTool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SunVector3DToolImpl extends AbstractTwoPoints3DToolImpl implements SunVector3DTool 
{
	...
	protected void updateSunIntensity()
	{
		...
		SymphonyEnvironment env = getSymphonyEnvironment();
		
		if(env != null)
		{
			 if(env.getActiveWorksite() instanceof EarthSurfaceWorksite)
			 {
				 EarthSurfaceWorksite earthSurfaceWorksite = (EarthSurfaceWorksite) getSymphonyEnvironment().getActiveWorksite();				 
	...
	protected SymphonyEnvironment getSymphonyEnvironment()
	{
		if(symphonyEnvironment == null)
		{
			...
			{				
				...
				if(env instanceof SymphonyEnvironment)
				{
					symphonyEnvironment = (SymphonyEnvironment) env;					
				}			
			}
			catch(Throwable t)
			{
	...
	{
		 if(getSymphonyEnvironment().getActiveWorksite() instanceof SurfaceWorksite)
		 {
			 SurfaceWorksite surfaceWorksite = (SurfaceWorksite) getSymphonyEnvironment().getActiveWorksite();
