 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getRulerColor <em>Ruler Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getExtremitiesRadius <em>Extremities Radius</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMinorTickColor <em>Minor Tick Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMinorTickSpacing <em>Minor Tick Spacing</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMinorTickLenght <em>Minor Tick Lenght</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMajorTickColor <em>Major Tick Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMajorTickSpacing <em>Major Tick Spacing</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getMajorTickLenght <em>Major Tick Lenght</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Ruler3DToolImpl#getRuler3dToolNode <em>Ruler3d Tool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
