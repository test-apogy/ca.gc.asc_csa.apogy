 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getFeatureOfInterestList <em>Feature Of Interest List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getPickAbsolutePosition <em>Pick Absolute Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getPickRelativePosition <em>Pick Relative Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getPickedNode <em>Picked Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getPickAbsoluteNormal <em>Pick Absolute Normal</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.FeatureOfInterestPickingToolImpl#getPickRelativeNormal <em>Pick Relative Normal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
