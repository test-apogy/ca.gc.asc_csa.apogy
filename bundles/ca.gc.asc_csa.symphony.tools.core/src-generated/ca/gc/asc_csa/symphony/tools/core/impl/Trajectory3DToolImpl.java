 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#isPenDown <em>Pen Down</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getDistanceThreshold <em>Distance Threshold</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getTotalDistance <em>Total Distance</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getPoseProvider <em>Pose Provider</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.impl.Trajectory3DToolImpl#getTrajectory3DToolNode <em>Trajectory3 DTool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
