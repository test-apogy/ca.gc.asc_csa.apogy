 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#isPenDown <em>Pen Down</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getVariable <em>Variable</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getDistanceThreshold <em>Distance Threshold</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getTotalDistance <em>Total Distance</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getPaths <em>Paths</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getPoseProvider <em>Pose Provider</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getTrajectory3DToolNode <em>Trajectory3 DTool Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool()
 * @model
 * @generated
 */
public interface Trajectory3DTool extends Simple3DTool {
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_PenDown()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#isPenDown <em>Pen Down</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_Variable()
	 * @model required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel propertyCategory='TRAJECTORY_3D_TOOL'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getVariable <em>Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_DistanceThreshold()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getDistanceThreshold <em>Distance Threshold</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_TotalDistance()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getTotalDistance <em>Total Distance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_Paths()
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_PoseProvider()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getPoseProvider <em>Pose Provider</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DToolNode#getTrajectory3DTool <em>Trajectory3 DTool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.tools.core.SymphonyToolsCorePackage#getTrajectory3DTool_Trajectory3DToolNode()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.tools.core.Trajectory3DTool#getTrajectory3DToolNode <em>Trajectory3 DTool Node</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
