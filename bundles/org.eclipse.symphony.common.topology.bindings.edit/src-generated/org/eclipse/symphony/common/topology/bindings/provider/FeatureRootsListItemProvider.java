 ...
 * @generated
 */
public class FeatureRootsListItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public FeatureRootsListItemProvider(AdapterFactory adapterFactory)
  {
  ...
  /**
	 * This returns FeatureRootsList.gif.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureRootsList"));
	}
  ...
  {
	  FeatureRootsList list = (FeatureRootsList) object;
	  
	  String label = getString("_UI_FeatureRootsList_type");
	  
	  if(list.getFeatureRoots() != null && list.getFeatureRoots().size() > 0)
	  {
		  label += " [" + list.getFeatureRoots().size() + "]";
	  }
