 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getFile <em>File</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getInputStream <em>Input Stream</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getVlrs <em>Vlrs</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getProgressMonitor <em>Progress Monitor</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getHeader <em>Header</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.LASReader#getPoints <em>Points</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader()
 * @model
 * @generated
 */
public interface LASReader extends EObject {
	 ...
	 * @see #setFile(String)
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_File()
	 * @model
	 * @generated
	 */
	String getFile();
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.io.las.LASReader#getFile <em>File</em>}' attribute.
	 ...
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_InputStream()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.io.las.LASReader#getInputStream <em>Input Stream</em>}' attribute.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.io.las.VariableLengthRecord}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_Vlrs()
	 ...
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_ProgressMonitor()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.io.las.LASReader#getProgressMonitor <em>Progress Monitor</em>}' attribute.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_Header()
	 * @model transient="true"
	 * @generated
	 */
	LASHeader getHeader();
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.io.las.LASReader#getHeader
	 ...
	 * list contents are of type {@link ca.gc.asc_csa.io.las.LASPoint}. <!--
	 * begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.io.las.LasPackage#getLASReader_Points()
	 * @model transient="true"
	 * @generated
	 */
