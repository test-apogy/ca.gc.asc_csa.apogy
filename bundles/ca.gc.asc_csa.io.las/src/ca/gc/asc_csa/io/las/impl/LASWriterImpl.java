 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getProgressMonitor <em>Progress Monitor</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getScaleX <em>Scale X</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getScaleY <em>Scale Y</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getScaleZ <em>Scale Z</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getXOffset <em>XOffset</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getYOffset <em>YOffset</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getZOffset <em>ZOffset</em>}</li>
 *   <li>{@link ca.gc.asc_csa.io.las.impl.LASWriterImpl#getOutputStream <em>Output Stream</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
