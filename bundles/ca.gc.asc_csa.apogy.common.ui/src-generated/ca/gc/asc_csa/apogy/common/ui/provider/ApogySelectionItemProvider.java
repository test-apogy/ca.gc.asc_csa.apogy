...
public class ApogySelectionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ApogySelection_selection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ApogySelection_selection_feature", "_UI_ApogySelection_type"),
				 ApogyCommonUiPackage.Literals.APOGY_SELECTION__SELECTION,
				 true,
				 false,
				 false,
	...
	protected void addPartIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ApogySelection_PartID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ApogySelection_PartID_feature", "_UI_ApogySelection_type"),
				 ApogyCommonUiPackage.Literals.APOGY_SELECTION__PART_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		ISelection labelValue = ((ApogySelection)object).getSelection();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ApogySelection_type") :
			getString("_UI_ApogySelection_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ApogySelection.class)) {
