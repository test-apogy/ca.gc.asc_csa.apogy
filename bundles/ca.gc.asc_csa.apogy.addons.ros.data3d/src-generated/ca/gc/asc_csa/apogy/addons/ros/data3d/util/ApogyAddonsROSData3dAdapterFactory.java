 ...
 */
package ca.gc.asc_csa.apogy.addons.ros.data3d.util;
...
public class ApogyAddonsROSData3dAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ApogyAddonsROSData3dSwitch<Adapter> modelSwitch =
		new ApogyAddonsROSData3dSwitch<Adapter>() {
			@Override
			public Adapter caseApogyAddonsROSData3dFacade(ApogyAddonsROSData3dFacade object) {
				return createApogyAddonsROSData3dFacadeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.apogy.addons.ros.data3d.ApogyAddonsROSData3dFacade <em>Facade</em>}'.
	 * <!-- begin-user-doc -->
...
} //ApogyAddonsROSData3dAdapterFactory
