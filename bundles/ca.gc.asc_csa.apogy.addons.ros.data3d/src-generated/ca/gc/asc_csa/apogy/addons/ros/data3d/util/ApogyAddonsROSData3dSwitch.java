...
public class ApogyAddonsROSData3dSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApogyAddonsROSData3dPackage.APOGY_ADDONS_ROS_DATA3D_FACADE: {
				ApogyAddonsROSData3dFacade apogyAddonsROSData3dFacade = (ApogyAddonsROSData3dFacade)theEObject;
				T result = caseApogyAddonsROSData3dFacade(apogyAddonsROSData3dFacade);
	 ...
	 * @generated
	 */
	public T caseApogyAddonsROSData3dFacade(ApogyAddonsROSData3dFacade object) {
		return null;
	}
