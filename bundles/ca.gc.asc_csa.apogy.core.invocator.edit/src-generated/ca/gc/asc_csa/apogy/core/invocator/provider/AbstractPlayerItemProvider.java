...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.AbstractPlayer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractPlayerItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public AbstractPlayerItemProvider(AdapterFactory adapterFactory)
  {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreInvocatorPackage.Literals.ABSTRACT_PLAYER__RECORDING_TOOLS_CONTAINER,
				 true,
				 false,
				 true,
				 null,
  ...
  {
		String label = ((AbstractPlayer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractPlayer_type") :
			getString("_UI_AbstractPlayer_type") + " " + label;
	}
