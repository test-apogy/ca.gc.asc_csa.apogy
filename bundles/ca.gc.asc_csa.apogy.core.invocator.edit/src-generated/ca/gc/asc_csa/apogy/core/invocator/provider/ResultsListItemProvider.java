...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.ResultsList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultsListItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ResultsListItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		String label = ((ResultsList)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ResultsList_type") :
			getString("_UI_ResultsList_type") + " " + label;
	}
