...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.AbstractProgramRuntime} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractProgramRuntimeItemProvider 
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractProgramRuntime_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractProgramRuntime_state_feature", "_UI_AbstractProgramRuntime_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreInvocatorPackage.Literals.ABSTRACT_PROGRAM_RUNTIME__PROGRAM,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((AbstractProgramRuntime)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractProgramRuntime_type") :
			getString("_UI_AbstractProgramRuntime_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractProgramRuntime.class)) {
