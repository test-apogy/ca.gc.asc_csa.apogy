...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.DisplaysList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplaysListItemProvider
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public DisplaysListItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApogyCoreInvocatorPackage.Literals.DISPLAYS_LIST__DISPLAYS);
		}
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DisplaysList"));
	}
  ...
  {
	  DisplaysList list = (DisplaysList) object;
	  String label = null;
	  ...
	  {
		  label = getString("_UI_DisplaysList_type");
	  }

	  if(list.getDisplays().size() > 0)
	  {
		  label += " [" +  list.getDisplays().size() + "]";
	  }
