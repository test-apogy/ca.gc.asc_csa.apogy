...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.AbstractChannel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractChannelItemProvider 
	 ...
	 * @generated
	 */
	public AbstractChannelItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addChannelsListPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Channels List feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addChannelsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 ...
				 ApogyCoreInvocatorPackage.Literals.ABSTRACT_CHANNEL__CHANNELS_LIST,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((AbstractChannel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractChannel_type") :
			getString("_UI_AbstractChannel_type") + " " + label;
	}
