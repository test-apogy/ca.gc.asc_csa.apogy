...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.Environment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
  {
		if (itemPropertyDescriptors == null) {
			...
			addActiveContextPropertyDescriptor(object);
		}
  ...
  /**
	 * This adds a property descriptor for the Active Context feature.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected void addActiveContextPropertyDescriptor(Object object)
  {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
  ...
  public String getText(Object object)
  {
	  ...
	  String label = getString("_UI_Environment_type");
	  ...
	  {
		  label += " (" + environment.getActiveContext().getName() + ")";
	  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApogyCoreInvocatorPackage.Literals.ENVIRONMENT__VARIABLES_LIST,
				 ApogyCoreInvocatorFactory.eINSTANCE.createVariablesList()));

		newChildDescriptors.add
			(createChildParameter
				(ApogyCoreInvocatorPackage.Literals.ENVIRONMENT__CONTEXTS_LIST,
				 ApogyCoreInvocatorFactory.eINSTANCE.createContextsList()));
	}
