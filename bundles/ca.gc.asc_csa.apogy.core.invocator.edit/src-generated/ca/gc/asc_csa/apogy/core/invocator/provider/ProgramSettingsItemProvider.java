...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.invocator.ProgramSettings} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramSettingsItemProvider 
	 ...
	 * @generated
	 */
	public ProgramSettingsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApogyCoreInvocatorPackage.Literals.PROGRAM_SETTINGS__SPECIFIC_PROGRAM_SETTINGS);
		}
	...
	/**
	 * This returns ProgramSettings.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProgramSettings"));
	}
	...
	public String getText(Object object) {
		String label = ((ProgramSettings)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProgramSettings_type") :
			getString("_UI_ProgramSettings_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProgramSettings.class)) {
