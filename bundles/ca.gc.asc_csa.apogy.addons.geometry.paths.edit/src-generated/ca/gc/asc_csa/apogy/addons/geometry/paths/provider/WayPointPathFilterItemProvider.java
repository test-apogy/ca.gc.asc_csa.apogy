 ...
 * @generated
 */
public class WayPointPathFilterItemProvider extends ProcessorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public WayPointPathFilterItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		IProgressMonitor labelValue = ((WayPointPathFilter)object).getProgressMonitor();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_WayPointPathFilter_type") :
			getString("_UI_WayPointPathFilter_type") + " " + label;
	}
