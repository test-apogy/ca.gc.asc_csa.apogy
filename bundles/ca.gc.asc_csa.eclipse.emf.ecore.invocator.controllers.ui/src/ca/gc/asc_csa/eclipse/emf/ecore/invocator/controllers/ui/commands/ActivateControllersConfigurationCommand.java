package ca.gc.asc_csa.eclipse.emf.ecore.invocator.controllers.ui.commands;
...
public class ActivateControllersConfigurationCommand extends AbstractHandler implements
		IHandler {
			...
			protected IStatus run(IProgressMonitor monitor) 
			{
				...
				while (selections.hasNext())
				{
					...
					if (selection instanceof ControllersConfiguration)
					{
						...
						controllersConfiguration.setActive(true);
					}					
				}
