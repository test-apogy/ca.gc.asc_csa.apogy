			...
			earthSkyAdapter = new AdapterImpl()
			{
				public void notifyChanged(Notification msg) 
				{
					...
					if(msg.getNotifier() instanceof EarthSky)
					{
						...
						if(msg.getFeatureID(EarthSky.class) == ApogyEarthSurfaceEnvironmentPackage.EARTH_SKY__SUN_HORIZONTAL_COORDINATES)
						{				
						...
						else if(msg.getFeatureID(EarthSky.class) == ApogyEarthSurfaceEnvironmentPackage.EARTH_SKY__MOON_HORIZONTAL_COORDINATES)
						{
