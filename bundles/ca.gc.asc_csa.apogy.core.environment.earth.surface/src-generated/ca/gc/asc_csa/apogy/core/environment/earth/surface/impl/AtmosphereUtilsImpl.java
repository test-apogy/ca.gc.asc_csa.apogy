...
public class AtmosphereUtilsImpl extends MinimalEObjectImpl.Container implements AtmosphereUtils 
{
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyEarthSurfaceEnvironmentPackage.ATMOSPHERE_UTILS___GET_AIR_MASS__DOUBLE:
				return getAirMass((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ATMOSPHERE_UTILS___GET_DIRECT_SUN_INTENSITY__DOUBLE_DOUBLE:
				return getDirectSunIntensity((Double)arguments.get(0), (Double)arguments.get(1));
			case ApogyEarthSurfaceEnvironmentPackage.ATMOSPHERE_UTILS___GET_DIFFUSE_SUN_INTENSITY__DOUBLE_DOUBLE:
				return getDiffuseSunIntensity((Double)arguments.get(0), (Double)arguments.get(1));
			case ApogyEarthSurfaceEnvironmentPackage.ATMOSPHERE_UTILS___GET_ATMOSPHERE_REFRACTION_CORRECTION__DOUBLE:
