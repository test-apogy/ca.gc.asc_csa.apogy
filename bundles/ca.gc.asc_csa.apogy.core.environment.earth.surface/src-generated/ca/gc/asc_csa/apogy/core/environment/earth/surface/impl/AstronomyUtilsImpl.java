...
//			System.out.println("Decl (deg) : " + Math.toDegrees(geocentricCoords.getDeclination()));
	  ...
	  {
			HorizontalCoordinates result = ApogyEarthEnvironmentFactory.eINSTANCE.createHorizontalCoordinates();
	  ...
	  {
			EclipticCoordinates eclipticCoordinates = ApogyEarthEnvironmentFactory.eINSTANCE.createEclipticCoordinates();
	  ...
	  {
			EclipticCoordinates eclipticCoord = ApogyEarthEnvironmentFactory.eINSTANCE.createEclipticCoordinates();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_SUN_EQUATORIAL_POSITION__DOUBLE:
				return getSunEquatorialPosition((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_HORIZONTAL_SUN_POSITION__DATE_DOUBLE_DOUBLE:
				return getHorizontalSunPosition((Date)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_MOON_EQUATORIAL_POSITION__DOUBLE:
				return getMoonEquatorialPosition((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_MOON_TOPOCENTRIC_EQUATORIAL_POSITION__DATE_DOUBLE_DOUBLE:
				return getMoonTopocentricEquatorialPosition((Date)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_HORIZONTAL_MOON_POSITION__DATE_DOUBLE_DOUBLE:
				return getHorizontalMoonPosition((Date)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_TIME_SINCE_J2000__DOUBLE:
				return getTimeSinceJ2000((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_LOCAL_SIDERAL_TIME__DATE_DOUBLE:
				return getLocalSideralTime((Date)arguments.get(0), (Double)arguments.get(1));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_UTC_DECIMAL_HOURS__DATE:
				return getUTCDecimalHours((Date)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_TO_HORIZONTAL_COORDINATES__EQUATORIALCOORDINATES_DOUBLE_DOUBLE_DATE:
			...
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_TIME_TO_ANGLE__INT_INT_INT:
				return convertTimeToAngle((Integer)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CLAMP_ANGLE_TO_ZERO2_PI__DOUBLE:
				return clampAngleToZero2PI((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_TO_EQUATORIAL_COORDINATES__ECLIPTICCOORDINATES:
				return convertToEquatorialCoordinates((EclipticCoordinates)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_TO_ECLIPTIC_COORDINATES__EQUATORIALCOORDINATES:
				return convertToEclipticCoordinates((EquatorialCoordinates)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_EQUATORIAL_RECTANGULAR_TO_ECLIPTIC_RECTANGULAR__POINT3D:
				return convertFromEquatorialRectangularToEclipticRectangular((Point3d)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_ECLIPTIC_RECTANGULAR_TO_EQUATORIAL_RECTANGULAR__POINT3D:
				return convertFromEclipticRectangularToEquatorialRectangular((Point3d)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_ECLIPTIC_RECTANGULAR_TO_ECLIPTIC_COORDINATES__POINT3D:
				return convertFromEclipticRectangularToEclipticCoordinates((Point3d)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_EQUATORIAL_RECTANGULAR_TO_EQUATORIAL_COORDINATES__POINT3D:
				return convertFromEquatorialRectangularToEquatorialCoordinates((Point3d)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_HORIZONTAL_COORDINATES_TO_HORIZONTAL_RECTANGULAR__HORIZONTALCOORDINATES:
				return convertFromHorizontalCoordinatesToHorizontalRectangular((HorizontalCoordinates)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_FROM_EQUATORIAL_COORDINATES_TO_EQUATORIAL_RECTANGULAR__EQUATORIALCOORDINATES:
				return convertFromEquatorialCoordinatesToEquatorialRectangular((EquatorialCoordinates)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_AUTO_METERS__DOUBLE:
				return convertAUtoMeters((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_MAXIMUM_SUN_ALTITUDE__DOUBLE:
				return getMaximumSunAltitude((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___CONVERT_TO_HHMMSS_STRING__DOUBLE:
				return convertToHHmmssString((Double)arguments.get(0));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_SUN_RISE_TIME__DATE_DOUBLE_DOUBLE:
				return getSunRiseTime((Date)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_SUN_SET_TIME__DATE_DOUBLE_DOUBLE:
				return getSunSetTime((Date)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2));
			case ApogyEarthSurfaceEnvironmentPackage.ASTRONOMY_UTILS___GET_SUN_HIGHEST_ELEVATION_TIME__DATE_DOUBLE_DOUBLE:
