...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.environment.orbit.earth.Corridor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CorridorItemProvider 
	 ...
	 * @generated
	 */
	public CorridorItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Corridor"));
	}
	...
	public String getText(Object object) 
	{
		...
		String label = null;
		if(corridor.getName() != null && corridor.getName().length() > 0)
		{
			label = corridor.getName();
		}
		else
		{
			label = getString("_UI_Corridor_type");
		}
		
		if(corridor.getPoints().size() > 0)
		{
			label += " [" + corridor.getPoints().size() + "]";
		}
