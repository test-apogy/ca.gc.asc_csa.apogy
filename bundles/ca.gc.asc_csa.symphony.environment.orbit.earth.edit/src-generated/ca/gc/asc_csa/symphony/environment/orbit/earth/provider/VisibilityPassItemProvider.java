...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.environment.orbit.earth.VisibilityPass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VisibilityPassItemProvider 
	...
	protected DecimalFormat durationFormat = new DecimalFormat("0.0");
	...
	public String getText(Object object) 
	{
		...
		String label = getString("_UI_VisibilityPass_type");
		
		try
		{
			label += " (";
			if(visibilityPass.getOrbitModel().getName() != null)
			{
				label += visibilityPass.getOrbitModel().getName() + ", ";
			}
			label += dateFormat.format(visibilityPass.getStartTime()) + " , ";			
			label += durationFormat.format(visibilityPass.getDuration()) + "s)";
		}
		catch(Throwable t)
		{			
		}
