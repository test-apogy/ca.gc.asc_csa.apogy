...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.apogy.core.environment.orbit.earth.ui.OrbitModelWorldWindLayer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__ORBIT_MODEL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__TIME_SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(new AbstractUnitItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__TIME_INTERVAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(new AbstractUnitItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__FORWARD_PROPAGATION_DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(new AbstractUnitItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__BACKWARD_PROPAGATION_DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__SHOW_GROUND_TRACE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApogyCoreEnvironmentOrbitEarthUIPackage.Literals.ORBIT_MODEL_WORLD_WIND_LAYER__SHOW_ORBIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
