 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EarthSky#getMoon <em>Moon</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EarthSky#getMoonHorizontalCoordinates <em>Moon Horizontal Coordinates</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSky()
 * @model
 * @generated
 */
public interface EarthSky extends Sky
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSky_Moon()
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSky_MoonHorizontalCoordinates()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EarthSky#getMoonHorizontalCoordinates <em>Moon Horizontal Coordinates</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
