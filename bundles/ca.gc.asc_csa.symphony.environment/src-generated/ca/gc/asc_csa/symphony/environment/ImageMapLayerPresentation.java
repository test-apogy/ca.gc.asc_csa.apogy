 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation#getAlpha <em>Alpha</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getImageMapLayerPresentation()
 * @model
 * @generated
 */
public interface ImageMapLayerPresentation extends MapLayerPresentation, RectangularRegionImage {
	 ...
	 * @see #setAlpha(float)
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getImageMapLayerPresentation_Alpha()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation#getAlpha <em>Alpha</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
