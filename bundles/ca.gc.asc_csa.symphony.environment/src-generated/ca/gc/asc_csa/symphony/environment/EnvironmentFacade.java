 ...
 *
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEnvironmentFacade()
 * @model
 * @generated
 */
public interface EnvironmentFacade extends EObject
{
	
	public static EnvironmentFacade INSTANCE = EnvironmentFacadeImpl.getInstance();
   ...
   * <!-- end-user-doc -->
	 ...
	 * origin.
	 * <!-- end-model-doc -->
	 * @model unique="false" rectangularRegionImagesDataType="ca.gc.asc_csa.symphony.environment.List<? extends ca.gc.asc_csa.symphony.environment.RectangularRegionImage>" rectangularRegionImagesUnique="false" rectangularRegionImagesMany="false"
	 * @generated
	 */
  ...
  /**
	 ...
	 * @param upperRightCorner The Tuple3d were to put the upper right coordinates.
	 * <!-- end-model-doc -->
	 * @model rectangularRegionProvidersDataType="ca.gc.asc_csa.symphony.environment.List<? extends ca.gc.asc_csa.symphony.environment.RectangularRegionProvider>" rectangularRegionProvidersUnique="false" rectangularRegionProvidersMany="false" lowerLeftCornerUnique="false" upperRightCornerUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * TODO DEPRECATE - REMOVE
	 * <!-- end-model-doc -->
	 * @model rectangularRegionImagesDataType="ca.gc.asc_csa.symphony.environment.List<? extends ca.gc.asc_csa.symphony.environment.RectangularRegionImage>" rectangularRegionImagesUnique="false" rectangularRegionImagesMany="false" lowerLeftCornerUnique="false" upperRightCornerUnique="false"
	 * @generated
	 */
  ...
  boolean fitsInside(RectangularRegion rectangularRegionA, RectangularRegion rectangularRegionB);
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model imageMapLayerPresentationsDataType="ca.gc.asc_csa.symphony.environment.List<ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation>" imageMapLayerPresentationsUnique="false" imageMapLayerPresentationsMany="false" lowerLeftCornerUnique="false" upperRightCornerUnique="false"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" imageMapLayerPresentationsDataType="ca.gc.asc_csa.symphony.environment.List<ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation>" imageMapLayerPresentationsUnique="false" imageMapLayerPresentationsMany="false"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.List<ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation>" unique="false" many="false" imageMapLayerPresentationsDataType="ca.gc.asc_csa.symphony.environment.List<ca.gc.asc_csa.symphony.environment.ImageMapLayerPresentation>" imageMapLayerPresentationsUnique="false" imageMapLayerPresentationsMany="false"
	 * @generated
	 */
