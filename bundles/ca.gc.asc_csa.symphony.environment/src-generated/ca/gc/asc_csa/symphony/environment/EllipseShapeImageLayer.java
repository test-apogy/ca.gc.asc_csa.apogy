 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#getEllipseWidth <em>Ellipse Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#getEllipseHeight <em>Ellipse Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEllipseShapeImageLayer()
 * @model
 * @generated
 */
public interface EllipseShapeImageLayer extends AbstractShapeImageLayer {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEllipseShapeImageLayer_EllipseWidth()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#getEllipseWidth <em>Ellipse Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEllipseShapeImageLayer_EllipseHeight()
	 * @model default="1.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Editable' propertyCategory='ELLIPSE_SETTINGS' csa_units='m'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#getEllipseHeight <em>Ellipse Height</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEllipseShapeImageLayer_ShowCenterLines()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EllipseShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
