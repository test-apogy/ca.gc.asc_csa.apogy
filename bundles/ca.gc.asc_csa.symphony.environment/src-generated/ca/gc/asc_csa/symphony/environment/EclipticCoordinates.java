 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getLongitude <em>Longitude</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getRadius <em>Radius</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEclipticCoordinates()
 * @model
 * @generated
 */
public interface EclipticCoordinates extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEclipticCoordinates_Longitude()
	 * @model unique="false"
	 * @generated
	 */
  double getLongitude();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getLongitude <em>Longitude</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEclipticCoordinates_Latitude()
	 * @model unique="false"
	 * @generated
	 */
  double getLatitude();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getLatitude <em>Latitude</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEclipticCoordinates_Radius()
	 * @model unique="false"
	 * @generated
	 */
  double getRadius();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EclipticCoordinates#getRadius <em>Radius</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
