 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getTime <em>Time</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getSurfaceWorksite <em>Surface Worksite</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getSkyNode <em>Sky Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getSun <em>Sun</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getSunHorizontalCoordinates <em>Sun Horizontal Coordinates</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.SkyImpl#getStarField <em>Star Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
