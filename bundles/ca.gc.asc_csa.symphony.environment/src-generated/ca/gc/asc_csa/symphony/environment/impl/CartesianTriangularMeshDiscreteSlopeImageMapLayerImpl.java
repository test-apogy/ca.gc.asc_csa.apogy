 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.CartesianTriangularMeshDiscreteSlopeImageMapLayerImpl#getSlopeRanges <em>Slope Ranges</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CartesianTriangularMeshDiscreteSlopeImageMapLayerImpl extends CartesianTriangularMeshSlopeImageMapLayerImpl implements CartesianTriangularMeshDiscreteSlopeImageMapLayer {
	...
	protected EClass eStaticClass() {
		return SymphonyEnvironmentPackage.Literals.CARTESIAN_TRIANGULAR_MESH_DISCRETE_SLOPE_IMAGE_MAP_LAYER;
	}
	...
	public EList<SlopeRange> getSlopeRanges() {
		if (slopeRanges == null) {
			slopeRanges = new EObjectContainmentEList<SlopeRange>(SlopeRange.class, this, SymphonyEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_DISCRETE_SLOPE_IMAGE_MAP_LAYER__SLOPE_RANGES);
		}
		return slopeRanges;
	}
