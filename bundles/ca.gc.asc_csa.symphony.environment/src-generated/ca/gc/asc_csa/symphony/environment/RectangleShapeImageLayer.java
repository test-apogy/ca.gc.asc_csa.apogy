 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#getRectangleWidth <em>Rectangle Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#getRectangleHeight <em>Rectangle Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangleShapeImageLayer()
 * @model
 * @generated
 */
public interface RectangleShapeImageLayer extends AbstractShapeImageLayer {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangleShapeImageLayer_RectangleWidth()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#getRectangleWidth <em>Rectangle Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangleShapeImageLayer_RectangleHeight()
	 * @model default="1.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Editable' propertyCategory='RECTANGLE_SETTINGS' csa_units='m'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#getRectangleHeight <em>Rectangle Height</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangleShapeImageLayer_ShowCenterLines()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.RectangleShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
