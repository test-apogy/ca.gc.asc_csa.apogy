 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.CartesianTriangularMeshHeightImageMapLayerImpl#isAutoScale <em>Auto Scale</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.CartesianTriangularMeshHeightImageMapLayerImpl#getMinimumHeight <em>Minimum Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.CartesianTriangularMeshHeightImageMapLayerImpl#getMaximumHeight <em>Maximum Height</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CartesianTriangularMeshHeightImageMapLayerImpl extends CartesianTriangularMeshDerivedImageMapLayerImpl implements CartesianTriangularMeshHeightImageMapLayer 
{
	...
	protected EClass eStaticClass() {
		return SymphonyEnvironmentPackage.Literals.CARTESIAN_TRIANGULAR_MESH_HEIGHT_IMAGE_MAP_LAYER;
	}
	...
	public void setAutoScale(boolean newAutoScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_HEIGHT_IMAGE_MAP_LAYER__AUTO_SCALE, oldAutoScale, autoScale));
	}
	...
	public void setMinimumHeight(double newMinimumHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_HEIGHT_IMAGE_MAP_LAYER__MINIMUM_HEIGHT, oldMinimumHeight, minimumHeight));
	}
	...
	public void setMaximumHeight(double newMaximumHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_HEIGHT_IMAGE_MAP_LAYER__MAXIMUM_HEIGHT, oldMaximumHeight, maximumHeight));
	}
