 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangularVolumeRegion#getZMin <em>ZMin</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangularVolumeRegion#getZMax <em>ZMax</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.RectangularVolumeRegion#getZDimension <em>ZDimension</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangularVolumeRegion()
 * @model
 * @generated
 */
public interface RectangularVolumeRegion extends RectangularRegion {
	 ...
	 * @see #setZMin(double)
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangularVolumeRegion_ZMin()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.RectangularVolumeRegion#getZMin <em>ZMin</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setZMax(double)
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangularVolumeRegion_ZMax()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Readonly' propertyCategory='EXTENT_COORDINATES' csa_units='m'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.RectangularVolumeRegion#getZMax <em>ZMax</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getRectangularVolumeRegion_ZDimension()
