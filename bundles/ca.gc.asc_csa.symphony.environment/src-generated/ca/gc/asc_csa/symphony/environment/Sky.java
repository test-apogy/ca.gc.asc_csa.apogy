 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.Sky#getSurfaceWorksite <em>Surface Worksite</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.Sky#getSkyNode <em>Sky Node</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.Sky#getSun <em>Sun</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.Sky#getSunHorizontalCoordinates <em>Sun Horizontal Coordinates</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.Sky#getStarField <em>Star Field</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky()
 * @model
 * @generated
 */
public interface Sky extends Timed
{
  ...
  /**
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.environment.SurfaceWorksite#getSky <em>Sky</em>}'.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky_SurfaceWorksite()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.Sky#getSurfaceWorksite <em>Surface Worksite</em>}' container reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky_SkyNode()
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky_Sun()
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky_SunHorizontalCoordinates()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.Sky#getSunHorizontalCoordinates <em>Sun Horizontal Coordinates</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSky_StarField()
	 * @model transient="true" changeable="false" derived="true"
