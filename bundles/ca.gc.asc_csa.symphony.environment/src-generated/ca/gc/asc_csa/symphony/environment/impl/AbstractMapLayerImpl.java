 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.AbstractMapLayerImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.AbstractMapLayerImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.AbstractMapLayerImpl#getMap <em>Map</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.impl.AbstractMapLayerImpl#getAbstractMapLayerNode <em>Abstract Map Layer Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
		if (baseClass == Described.class) {
			switch (derivedFeatureID) {
				case SymphonyEnvironmentPackage.ABSTRACT_MAP_LAYER__DESCRIPTION: return EMFEcorePackage.DESCRIBED__DESCRIPTION;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
		if (baseClass == Described.class) {
			switch (baseFeatureID) {
				case EMFEcorePackage.DESCRIBED__DESCRIPTION: return SymphonyEnvironmentPackage.ABSTRACT_MAP_LAYER__DESCRIPTION;
				default: return -1;
			}
		}
