 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getGeographicalCoordinates <em>Geographical Coordinates</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getXAxisAzimuth <em>XAxis Azimuth</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getEarthSky <em>Earth Sky</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSurfaceWorksite()
 * @model
 * @generated
 */
public interface EarthSurfaceWorksite extends SurfaceWorksite
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSurfaceWorksite_GeographicalCoordinates()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getGeographicalCoordinates <em>Geographical Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSurfaceWorksite_XAxisAzimuth()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getXAxisAzimuth <em>XAxis Azimuth</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getEarthSurfaceWorksite_EarthSky()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.EarthSurfaceWorksite#getEarthSky <em>Earth Sky</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
