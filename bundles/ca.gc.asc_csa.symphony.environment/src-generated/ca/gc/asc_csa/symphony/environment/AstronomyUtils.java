...
import ca.gc.asc_csa.symphony.environment.impl.AstronomyUtilsImpl;
 ...
 *
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getAstronomyUtils()
 * @model
 * @generated
 */
public interface AstronomyUtils extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" dateDataType="ca.gc.asc_csa.symphony.environment.Date" dateUnique="false" observerLongitudeUnique="false" observerLatitudeUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Computes the Moon's equatorial coordinates for a given Julian date for an observer a the center of the Earth. See doc/tutorial.html for more details.
	 * <!-- end-model-doc -->
	 * @model unique="false" julianDayUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Computes the Moon's equatorial coordinates for a date and location on the surface of the Earth. This position take into account the radius of the Earth.
	 * @param observerLongitude The observer longitude, in radians. Longitude East of Greenwich are positive, West of Greenwich are negative.
	 * @param observerLatitude The observer latitude, in radians. Latitude North of the equator are positive, Southe of the equator are negative.
	 * <!-- end-model-doc -->
	 * @model unique="false" dateDataType="ca.gc.asc_csa.symphony.environment.Date" dateUnique="false" observerLongitudeUnique="false" observerLatitudeUnique="false"
   ...
   * <!-- end-user-doc -->
	 ...
	 * @param observerLongitude The observer longitude, in radians. Longitude East of Greenwich are positive, West of Greenwich are negative.
	 * <!-- end-model-doc -->
	 * @model unique="false" dateDataType="ca.gc.asc_csa.symphony.environment.Date" dateUnique="false" observerLongitudeUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * @param observerLatitude The observer latitude, in radians. Latitude North of the equator are positive, Southe of the equator are negative.
	 * <!-- end-model-doc -->
	 * @model unique="false" equatorialCoordinatesUnique="false" observerLongitudeUnique="false" observerLatitudeUnique="false" dateDataType="ca.gc.asc_csa.symphony.environment.Date" dateUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Converts Rectangular (x,y,z) Equatorial Coordinates to Equatorial Coordinates (Right Ascension and Declination).
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.Point3d" unique="false" equatorialRectangularCoordinatesDataType="ca.gc.asc_csa.symphony.environment.Point3d" equatorialRectangularCoordinatesUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.Point3d" unique="false" eclipticCoordinatesDataType="ca.gc.asc_csa.symphony.environment.Point3d" eclipticCoordinatesUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" eclipticCoordinatesDataType="ca.gc.asc_csa.symphony.environment.Point3d" eclipticCoordinatesUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" equatorialCoordinatesDataType="ca.gc.asc_csa.symphony.environment.Point3d" equatorialCoordinatesUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Converts HorizontalCoordinates () to Rectangular Horizontal  (x,y,z)  coordinates. Rectangular Horizontal  coordinates are defined as followed: X point to True North. Y points West Z point toward nadir (up);
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.Point3d" unique="false" horizontalCoordinatesUnique="false"
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * 
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.Point3d" unique="false" equatorialCoordinatesUnique="false"
	 * @generated
	 */
  ...
  String convertToHHmmssString(double sideralTime);
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.symphony.environment.Date" unique="false" dayDataType="ca.gc.asc_csa.symphony.environment.Date" dayUnique="false" observerLongitudeUnique="false" observerLatitudeUnique="false"
	 * @generated
	 */
