 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getSlopeLowerBound <em>Slope Lower Bound</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getSlopeUpperBound <em>Slope Upper Bound</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getColor <em>Color</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSlopeRange()
 * @model
 * @generated
 */
public interface SlopeRange extends Named, Described {
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSlopeRange_SlopeLowerBound()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getSlopeLowerBound <em>Slope Lower Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSlopeRange_SlopeUpperBound()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getSlopeUpperBound <em>Slope Upper Bound</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getSlopeRange_Color()
	 * @model default="1.0,1.0,1.0" unique="false" dataType="ca.gc.asc_csa.symphony.environment.Color3f"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.SlopeRange#getColor <em>Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
