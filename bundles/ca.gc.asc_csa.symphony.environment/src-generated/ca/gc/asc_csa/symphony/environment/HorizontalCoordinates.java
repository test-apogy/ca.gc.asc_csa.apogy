 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getAltitude <em>Altitude</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getAzimuth <em>Azimuth</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getRadius <em>Radius</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getHorizontalCoordinates()
 * @model
 * @generated
 */
public interface HorizontalCoordinates extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getHorizontalCoordinates_Altitude()
	 * @model unique="false"
	 * @generated
	 */
  double getAltitude();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getAltitude <em>Altitude</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getHorizontalCoordinates_Azimuth()
	 * @model unique="false"
	 * @generated
	 */
  double getAzimuth();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getAzimuth <em>Azimuth</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.environment.SymphonyEnvironmentPackage#getHorizontalCoordinates_Radius()
	 * @model unique="false"
	 * @generated
	 */
  double getRadius();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.environment.HorizontalCoordinates#getRadius <em>Radius</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
