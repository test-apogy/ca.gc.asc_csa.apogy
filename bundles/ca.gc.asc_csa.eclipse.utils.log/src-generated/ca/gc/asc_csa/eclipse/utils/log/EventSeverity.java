 ...
 * <!-- end-model-doc -->
 * @see ca.gc.asc_csa.eclipse.utils.log.UtilsLogPackage#getEventSeverity()
 * @model
 * @generated
 */
public enum EventSeverity implements Enumerator {
	/**
...
/**
	...
	/**
	 * An array of all the '<em><b>Event Severity</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EventSeverity[] VALUES_ARRAY =
		new EventSeverity[] {
			OK,
			INFO,
			WARNING,
	...
	/**
	 * A public read-only list of all the '<em><b>Event Severity</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<EventSeverity> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static EventSeverity get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EventSeverity result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private EventSeverity(int value, String name, String literal) {
		this.value = value;
		this.name = name;
