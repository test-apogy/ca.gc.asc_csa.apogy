 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.eclipse.utils.log.UtilsLogFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='UtilsLog' childCreationExtenders='true' extensibleProviderFactory='true' copyrightText='Agence spatiale canadienne / Canadian Space Agency 2015 Copyrights (c)' modelName='UtilsLog' modelDirectory='/ca.gc.asc_csa.eclipse.utils.log/src-generated' editDirectory='/ca.gc.asc_csa.eclipse.utils.log.edit/src-generated' basePackage='ca.gc.asc_csa.eclipse.utils'"
 * @generated
 */
public interface UtilsLogPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "ca.gc.asc_csa.eclipse.utils.log";
	 ...
	 * @generated
	 */
	UtilsLogPackage eINSTANCE = ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl.init();

	/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.utils.log.impl.LoggerImpl <em>Logger</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.LoggerImpl
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getLogger()
	 * @generated
	 */
	int LOGGER = 0;
	...
	/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.utils.log.EventSeverity <em>Event Severity</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.utils.log.EventSeverity
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getEventSeverity()
	 * @generated
	 */
	 ...
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getThrowable()
	 * @generated
	 */
	int THROWABLE = 2;
	 ...
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getBundle()
	 * @generated
	 */
	int BUNDLE = 3;
	 ...
	 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getFrameworkLog()
	 * @generated
	 */
	int FRAMEWORK_LOG = 4;
	...
	/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.utils.log.Logger <em>Logger</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Logger</em>'.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger
	 * @generated
	 */
	EClass getLogger();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity) <em>Log</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Log</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity)
	 * @generated
	 */
	EOperation getLogger__Log__String_String_EventSeverity();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.Object, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity) <em>Log</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Log</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.Object, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity)
	 * @generated
	 */
	EOperation getLogger__Log__String_Object_String_EventSeverity();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity, java.lang.Throwable) <em>Log</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Log</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity, java.lang.Throwable)
	 * @generated
	 */
	EOperation getLogger__Log__String_String_EventSeverity_Throwable();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.Object, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity, java.lang.Throwable) <em>Log</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Log</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger#log(java.lang.String, java.lang.Object, java.lang.String, ca.gc.asc_csa.eclipse.utils.log.EventSeverity, java.lang.Throwable)
	 * @generated
	 */
	EOperation getLogger__Log__String_Object_String_EventSeverity_Throwable();

	/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.utils.log.Logger#getLog() <em>Get Log</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Log</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.utils.log.Logger#getLog()
	 * @generated
	 */
	EOperation getLogger__GetLog();

	/**
	 * Returns the meta object for enum '{@link ca.gc.asc_csa.eclipse.utils.log.EventSeverity <em>Event Severity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.utils.log.impl.LoggerImpl <em>Logger</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.utils.log.impl.LoggerImpl
		 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getLogger()
		...
		/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.utils.log.EventSeverity <em>Event Severity</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.utils.log.EventSeverity
		 * @see ca.gc.asc_csa.eclipse.utils.log.impl.UtilsLogPackageImpl#getEventSeverity()
