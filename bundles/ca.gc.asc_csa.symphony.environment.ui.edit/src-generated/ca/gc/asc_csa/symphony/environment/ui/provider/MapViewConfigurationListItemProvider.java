...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.symphony.environment.ui.MapViewConfigurationList} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapViewConfigurationListItemProvider
  extends AbstractToolsListContainerItemProvider
{
  ...
  {
	  MapViewConfigurationList mapViewConfigurationList = (MapViewConfigurationList) object;
	  
	  String label = getString("_UI_MapViewConfigurationList_type");
	  
	  if(mapViewConfigurationList.getMapViewConfigurations().size() > 0)
	  {
		  label += " [" +  mapViewConfigurationList.getMapViewConfigurations().size() + "]";
	  }
