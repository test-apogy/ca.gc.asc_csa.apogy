...
import ca.gc.space.mrt.sensors.gps.state.GPSState;
import ca.gc.space.mrt.sensors.gps.state.GPSStateFactory;
 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getDataInterpreter <em>Data Interpreter</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getReading <em>Reading</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getUpdateRate <em>Update Rate</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getLastFailure <em>Last Failure</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getMaxReconnectTime <em>Max Reconnect Time</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getSpeedKnots <em>Speed Knots</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSImpl#getSpeedKmh <em>Speed Kmh</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
