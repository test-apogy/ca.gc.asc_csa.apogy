...
import ca.gc.space.mrt.sensors.gps.GPSRepository;
...
public class GpsPackageImpl extends EPackageImpl implements GpsPackage {
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(gpsEClass, ca.gc.space.mrt.sensors.gps.GPS.class, "GPS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGPS_Connection(), this.getGPSConnection(), null, "connection", null, 1, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGPS_DataInterpreter(), this.getGPSDataInterpreter(), this.getGPSDataInterpreter_Gps(), "dataInterpreter", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGPS_Reading(), this.getGPSReading(), null, "reading", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_Status(), this.getGPS_STATUS(), "status", "STOPPED", 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_UpdateRate(), theEcorePackage.getELong(), "updateRate", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_LastFailure(), theMathPackage.getException(), "lastFailure", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_MaxReconnectTime(), theEcorePackage.getEInt(), "maxReconnectTime", "10000", 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_SpeedKnots(), theEcorePackage.getEDouble(), "speedKnots", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGPS_SpeedKmh(), theEcorePackage.getEDouble(), "speedKmh", null, 0, 1, ca.gc.space.mrt.sensors.gps.GPS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.class, "GPS_QUALITY");
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.GPS_FIX);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.INVALID);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.DGPS_FIX);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.PPS_FIX);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.RTK);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.FLOAT_RTK);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.ESTIMATED);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.MANUAL_INPUT);
		addEEnumLiteral(gpS_QUALITYEEnum, ca.gc.space.mrt.sensors.gps.GPS_QUALITY.SIMULATION);

		initEEnum(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.class, "GPS_STATUS");
		addEEnumLiteral(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.RUNNING);
		addEEnumLiteral(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.STOPPED);
		addEEnumLiteral(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.FAILED);
		addEEnumLiteral(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.RECONNECTING);
		addEEnumLiteral(gpS_STATUSEEnum, ca.gc.space.mrt.sensors.gps.GPS_STATUS.CONNECTING);
