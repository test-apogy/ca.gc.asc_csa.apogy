 ...
 */
package ca.gc.space.mrt.sensors.gps.util;
 ...
 * end-user-doc -->
 * @see ca.gc.space.mrt.sensors.gps.GpsPackage
 * @generated
 */
public class GpsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * {@link ca.gc.space.mrt.sensors.gps.GPS <em>GPS</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.sensors.gps.GPSReading <em>GPS Reading</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor <em>GPS Pose Sensor</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link ca.gc.space.mrt.sensors.gps.GPSFacade <em>GPS Facade</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link ca.gc.space.mrt.sensors.gps.MarkedGPS <em>Marked GPS</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link ca.gc.space.mrt.sensors.gps.GPSRepository <em>GPS Repository</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link ca.gc.space.mrt.sensors.sensors.Sensor <em>Sensor</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * 
