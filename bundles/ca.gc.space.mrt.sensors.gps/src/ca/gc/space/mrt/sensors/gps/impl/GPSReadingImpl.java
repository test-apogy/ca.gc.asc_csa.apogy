 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getLongitude <em>Longitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getElevation <em>Elevation</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getQuality <em>Quality</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getTimeStamp <em>Time Stamp</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getNumberOfSatellites <em>Number Of Satellites</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getHorizontalDilutionPos <em>Horizontal Dilution Pos</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getMeanSeaLevel <em>Mean Sea Level</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSReadingImpl#getCheckSum <em>Check Sum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GPSReadingImpl extends EObjectImpl implements GPSReading {
	/**
	 ...
	 * @ordered
	 */
	protected static final GPS_QUALITY QUALITY_EDEFAULT = GPS_QUALITY.GPS_FIX;
