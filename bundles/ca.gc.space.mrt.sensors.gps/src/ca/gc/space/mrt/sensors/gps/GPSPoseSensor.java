 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getGps <em>Gps</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginLatitude <em>Origin Latitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginLongitude <em>Origin Longitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getNeAngle <em>Ne Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginElevation <em>Origin Elevation</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getMaxInitTime <em>Max Init Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor()
 * @model
 * @generated
 */
public interface GPSPoseSensor extends PoseSensor, Server {
	 ...
	 * The list contents are of type {@link ca.gc.space.mrt.sensors.gps.MarkedGPS}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_Gps()
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_OriginLatitude()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginLatitude <em>Origin Latitude</em>}' attribute.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_OriginLongitude()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginLongitude <em>Origin Longitude</em>}' attribute.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_NeAngle()
	 ...
	 * {@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getNeAngle
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_OriginElevation()
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getOriginElevation <em>Origin Elevation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.sensors.gps.GpsPackage#getGPSPoseSensor_MaxInitTime()
	 * @model default="10000"
	 * @generated
	 */
	long getMaxInitTime();
	...
	/**
	 * Sets the value of the '{@link ca.gc.space.mrt.sensors.gps.GPSPoseSensor#getMaxInitTime <em>Max Init Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
