 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#isStarted <em>Started</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getServerJob <em>Server Job</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getGps <em>Gps</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getOriginLatitude <em>Origin Latitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getOriginLongitude <em>Origin Longitude</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getNeAngle <em>Ne Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getOriginElevation <em>Origin Elevation</em>}</li>
 *   <li>{@link ca.gc.space.mrt.sensors.gps.impl.GPSPoseSensorImpl#getMaxInitTime <em>Max Init Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
