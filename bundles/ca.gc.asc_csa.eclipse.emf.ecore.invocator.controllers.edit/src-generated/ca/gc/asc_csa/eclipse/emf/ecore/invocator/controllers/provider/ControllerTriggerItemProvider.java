...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.controllers.ControllerTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControllerTriggerItemProvider
  extends TriggerItemProvider
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ControllerTriggerItemProvider(AdapterFactory adapterFactory)
  {
  ...
  {
		String label = ((ControllerTrigger)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ControllerTrigger_type") :
			getString("_UI_ControllerTrigger_type") + " " + label;
	}
