 ...
 * <ul>
 *   <li>{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCurrentPanAngle <em>Current Pan Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCurrentTiltAngle <em>Current Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCommandedPanAngle <em>Commanded Pan Angle</em>}</li>
 *   <li>{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCommandedTiltAngle <em>Commanded Tilt Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.space.mrt.actuators.MRTActuatorsPackage#getPanTiltUnit()
 * @model abstract="true"
 * @generated
 */
public interface PanTiltUnit extends AbstractActuator
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.actuators.MRTActuatorsPackage#getPanTiltUnit_CurrentPanAngle()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCurrentPanAngle <em>Current Pan Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.actuators.MRTActuatorsPackage#getPanTiltUnit_CurrentTiltAngle()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='ACTUATOR_INFORMATION' csa_units='rad'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCurrentTiltAngle <em>Current Tilt Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.actuators.MRTActuatorsPackage#getPanTiltUnit_CommandedPanAngle()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='ACTUATOR_INFORMATION' csa_units='rad'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCommandedPanAngle <em>Commanded Pan Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.space.mrt.actuators.MRTActuatorsPackage#getPanTiltUnit_CommandedTiltAngle()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='ACTUATOR_INFORMATION' csa_units='rad'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.space.mrt.actuators.PanTiltUnit#getCommandedTiltAngle <em>Commanded Tilt Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
