...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.ros.RosTopicLauncher} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RosTopicLauncherItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RosPackage.Literals.ROS_TOPIC_LAUNCHER__RUNNING,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RosPackage.Literals.ROS_TOPIC_LAUNCHER__NODE);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RosPackage.Literals.ROS_TOPIC_LAUNCHER__LISTENER_LIST,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RosPackage.Literals.ROS_TOPIC_LAUNCHER__NODE,
				 false,
				 false,
				 true,
				 null,
