 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getLineOfSightAvailableColor <em>Line Of Sight Available Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getLineOfSightNotAvailableColor <em>Line Of Sight Not Available Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getObserverPose <em>Observer Pose</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getTargetHeightAboveGround <em>Target Height Above Ground</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#isUseHeightPerpendicularToGround <em>Use Height Perpendicular To Ground</em>}</li>
 * </ul>
 *
 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer()
 * @model
 * @generated
 */
public interface LineOfSightImageMapLayer extends CartesianTriangularMeshDerivedImageMapLayer {
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer_LineOfSightAvailableColor()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getLineOfSightAvailableColor <em>Line Of Sight Available Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer_LineOfSightNotAvailableColor()
	 * @model default="1.0,0.0,0.0" unique="false" dataType="ca.gc.asc_csa.apogy.core.environment.surface.Color3f"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Editable' propertyCategory='IMAGE_GENERATION_SETTINGS'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getLineOfSightNotAvailableColor <em>Line Of Sight Not Available Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer_ObserverPose()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getObserverPose <em>Observer Pose</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer_TargetHeightAboveGround()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#getTargetHeightAboveGround <em>Target Height Above Ground</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getLineOfSightImageMapLayer_UseHeightPerpendicularToGround()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.LineOfSightImageMapLayer#isUseHeightPerpendicularToGround <em>Use Height Perpendicular To Ground</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
