 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.LineOfSightImageMapLayerImpl#getLineOfSightAvailableColor <em>Line Of Sight Available Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.LineOfSightImageMapLayerImpl#getLineOfSightNotAvailableColor <em>Line Of Sight Not Available Color</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.LineOfSightImageMapLayerImpl#getObserverPose <em>Observer Pose</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.LineOfSightImageMapLayerImpl#getTargetHeightAboveGround <em>Target Height Above Ground</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.LineOfSightImageMapLayerImpl#isUseHeightPerpendicularToGround <em>Use Height Perpendicular To Ground</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineOfSightImageMapLayerImpl extends CartesianTriangularMeshDerivedImageMapLayerImpl implements LineOfSightImageMapLayer 
{
	...
	protected EClass eStaticClass() {
		return ApogySurfaceEnvironmentPackage.Literals.LINE_OF_SIGHT_IMAGE_MAP_LAYER;
	}
	...
	public void setLineOfSightAvailableColor(Color3f newLineOfSightAvailableColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__LINE_OF_SIGHT_AVAILABLE_COLOR, oldLineOfSightAvailableColor, lineOfSightAvailableColor));
	}
	...
	public void setLineOfSightNotAvailableColor(Color3f newLineOfSightNotAvailableColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__LINE_OF_SIGHT_NOT_AVAILABLE_COLOR, oldLineOfSightNotAvailableColor, lineOfSightNotAvailableColor));
	}
	...
	public NotificationChain basicSetObserverPose(Matrix4x4 newObserverPose, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE, oldObserverPose, newObserverPose);
	...
	public void setObserverPose(Matrix4x4 newObserverPose) {
		if (newObserverPose != observerPose) {
			...
			if (observerPose != null)
				msgs = ((InternalEObject)observerPose).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE, null, msgs);
			if (newObserverPose != null)
				msgs = ((InternalEObject)newObserverPose).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE, null, msgs);
			msgs = basicSetObserverPose(newObserverPose, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE, newObserverPose, newObserverPose));
	}
	...
	public void setTargetHeightAboveGround(double newTargetHeightAboveGround) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__TARGET_HEIGHT_ABOVE_GROUND, oldTargetHeightAboveGround, targetHeightAboveGround));
	}
	...
	public void setUseHeightPerpendicularToGround(boolean newUseHeightPerpendicularToGround) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__USE_HEIGHT_PERPENDICULAR_TO_GROUND, oldUseHeightPerpendicularToGround, useHeightPerpendicularToGround));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__LINE_OF_SIGHT_AVAILABLE_COLOR:
				return getLineOfSightAvailableColor();
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__LINE_OF_SIGHT_NOT_AVAILABLE_COLOR:
				return getLineOfSightNotAvailableColor();
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__OBSERVER_POSE:
				return getObserverPose();
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__TARGET_HEIGHT_ABOVE_GROUND:
				return getTargetHeightAboveGround();
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER__USE_HEIGHT_PERPENDICULAR_TO_GROUND:
