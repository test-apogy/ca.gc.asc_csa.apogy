 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#getEllipseWidth <em>Ellipse Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#getEllipseHeight <em>Ellipse Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}</li>
 * </ul>
 *
 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getEllipseShapeImageLayer()
 * @model
 * @generated
 */
public interface EllipseShapeImageLayer extends AbstractShapeImageLayer {
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getEllipseShapeImageLayer_EllipseWidth()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#getEllipseWidth <em>Ellipse Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getEllipseShapeImageLayer_EllipseHeight()
	 * @model default="1.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel property='Editable' propertyCategory='ELLIPSE_SETTINGS' apogy_units='m'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#getEllipseHeight <em>Ellipse Height</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.apogy.core.environment.surface.ApogySurfaceEnvironmentPackage#getEllipseShapeImageLayer_ShowCenterLines()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.apogy.core.environment.surface.EllipseShapeImageLayer#isShowCenterLines <em>Show Center Lines</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
