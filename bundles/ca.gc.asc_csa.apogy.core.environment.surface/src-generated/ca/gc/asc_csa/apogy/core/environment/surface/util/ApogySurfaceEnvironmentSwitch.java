...
public class ApogySurfaceEnvironmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApogySurfaceEnvironmentPackage.SURFACE_WORKSITE: {
			...
			case ApogySurfaceEnvironmentPackage.MAP: {
			...
			case ApogySurfaceEnvironmentPackage.MAPS_LIST: {
				MapsList mapsList = (MapsList)theEObject;
				T result = caseMapsList(mapsList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApogySurfaceEnvironmentPackage.ABSTRACT_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.MAP_LAYER_PRESENTATION: {
			...
			case ApogySurfaceEnvironmentPackage.URL_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.REGION: {
				Region region = (Region)theEObject;
				T result = caseRegion(region);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION: {
			...
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_VOLUME_REGION: {
			...
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION_PROVIDER: {
			...
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION_IMAGE: {
			...
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION: {
			...
			case ApogySurfaceEnvironmentPackage.URL_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.TOPOLOGY_TREE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.TOPOLOGY_TREE_MAP_LAYER_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_SLOPE_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_DISCRETE_SLOPE_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_HEIGHT_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.SLOPE_RANGE: {
			...
			case ApogySurfaceEnvironmentPackage.LINE_OF_SIGHT_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.ABSTRACT_SHAPE_IMAGE_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.ELLIPSE_SHAPE_IMAGE_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.POLYGON_SHAPE_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_COORDINATES_POLYGON_SHAPE_IMAGE_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.BASIC_CARTESIAN_TRIANGULAR_MESH_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_URL_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.FEATURES_OF_INTEREST_MAP_LAYER: {
			...
			case ApogySurfaceEnvironmentPackage.SURFACE_WORKSITE_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.MAPS_LIST_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.MAP_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.ABSTRACT_MAP_LAYER_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.CARTESIAN_TRIANGULAR_MESH_MAP_LAYER_NODE: {
			...
			case ApogySurfaceEnvironmentPackage.SURFACE_ENVIRONMENT_UTILITIES: {
				SurfaceEnvironmentUtilities surfaceEnvironmentUtilities = (SurfaceEnvironmentUtilities)theEObject;
				T result = caseSurfaceEnvironmentUtilities(surfaceEnvironmentUtilities);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApogySurfaceEnvironmentPackage.APOGY_SURFACE_ENVIRONMENT_FACADE: {
				ApogySurfaceEnvironmentFacade apogySurfaceEnvironmentFacade = (ApogySurfaceEnvironmentFacade)theEObject;
				T result = caseApogySurfaceEnvironmentFacade(apogySurfaceEnvironmentFacade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Surface Environment Utilities</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Surface Environment Utilities</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSurfaceEnvironmentUtilities(SurfaceEnvironmentUtilities object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseApogySurfaceEnvironmentFacade(ApogySurfaceEnvironmentFacade object) {
		return null;
	}
