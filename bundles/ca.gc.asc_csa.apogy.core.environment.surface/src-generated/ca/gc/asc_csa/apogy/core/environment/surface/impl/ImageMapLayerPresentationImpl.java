 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.ImageMapLayerPresentationImpl#getAlpha <em>Alpha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageMapLayerPresentationImpl extends MapLayerPresentationImpl implements ImageMapLayerPresentation {
	...
	public void setAlphaGen(float newAlpha) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION__ALPHA, oldAlpha, alpha));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION__ALPHA:
				return getAlpha();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == RectangularRegionProvider.class) {
			switch (baseOperationID) {
				case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION_PROVIDER___GET_REGION: return ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_REGION;
				default: return -1;
			}
		}
		if (baseClass == RectangularRegionImage.class) {
			switch (baseOperationID) {
				case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION_IMAGE___GET_REGION_IMAGE: return ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_REGION_IMAGE;
				case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION_IMAGE___GET_RESOLUTION: return ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_RESOLUTION;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_IMAGE_MAP_LAYER:
				return getImageMapLayer();
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_REGION_IMAGE:
				return getRegionImage();
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_RESOLUTION:
				return getResolution();
			case ApogySurfaceEnvironmentPackage.IMAGE_MAP_LAYER_PRESENTATION___GET_REGION:
				return getRegion();
		}
