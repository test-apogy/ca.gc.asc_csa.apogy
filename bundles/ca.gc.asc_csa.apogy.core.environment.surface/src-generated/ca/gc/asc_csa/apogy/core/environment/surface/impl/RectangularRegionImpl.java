 ...
 * '<em><b>Rectangular Region</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getXMin <em>XMin</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getXMax <em>XMax</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getYMin <em>YMin</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getYMax <em>YMax</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getXDimension <em>XDimension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getYDimension <em>YDimension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getLowerLeftCorner <em>Lower Left Corner</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getUpperLeftCorner <em>Upper Left Corner</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getLowerRightCorner <em>Lower Right Corner</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangularRegionImpl#getUpperRightCorner <em>Upper Right Corner</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RectangularRegionImpl extends RegionImpl implements RectangularRegion {
	...
	public void setXMin(double newXMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__XMIN, oldXMin, xMin));
	}
	...
	public void setXMax(double newXMax) {
		...
		xMax = newXMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__XMAX, oldXMax, xMax));
	}
	...
	public void setYMin(double newYMin) {
		...
		yMin = newYMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__YMIN, oldYMin, yMin));
	}
	...
	public void setYMax(double newYMax) {
		...
		yMax = newYMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__YMAX, oldYMax, yMax));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__XMIN:
				return getXMin();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__XMAX:
				return getXMax();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__YMIN:
				return getYMin();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__YMAX:
				return getYMax();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__XDIMENSION:
				return getXDimension();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__YDIMENSION:
				return getYDimension();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__LOWER_LEFT_CORNER:
				if (resolve) return getLowerLeftCorner();
				return basicGetLowerLeftCorner();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__UPPER_LEFT_CORNER:
				if (resolve) return getUpperLeftCorner();
				return basicGetUpperLeftCorner();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__LOWER_RIGHT_CORNER:
				if (resolve) return getLowerRightCorner();
				return basicGetLowerRightCorner();
			case ApogySurfaceEnvironmentPackage.RECTANGULAR_REGION__UPPER_RIGHT_CORNER:
