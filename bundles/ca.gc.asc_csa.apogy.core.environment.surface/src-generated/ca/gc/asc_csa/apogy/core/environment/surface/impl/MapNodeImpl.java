...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Map
 * Node</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.MapNodeImpl#getMap <em>Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapNodeImpl extends TransformNodeImpl implements MapNode {
		...
		if (map != null && map.eIsProxy()) {
			...
			if (map != oldMap) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApogySurfaceEnvironmentPackage.MAP_NODE__MAP, oldMap, map));
			}
		}
		return map;
	}
	...
	public void setMap(Map newMap) {
		...
		map = newMap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.MAP_NODE__MAP, oldMap, map));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.MAP_NODE__MAP:
