 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangleShapeImageLayerImpl#getRectangleWidth <em>Rectangle Width</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangleShapeImageLayerImpl#getRectangleHeight <em>Rectangle Height</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.core.environment.surface.impl.RectangleShapeImageLayerImpl#isShowCenterLines <em>Show Center Lines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RectangleShapeImageLayerImpl extends AbstractShapeImageLayerImpl implements RectangleShapeImageLayer {
	...
	protected EClass eStaticClass() {
		return ApogySurfaceEnvironmentPackage.Literals.RECTANGLE_SHAPE_IMAGE_LAYER;
	}
	...
	public void setRectangleWidth(double newRectangleWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__RECTANGLE_WIDTH, oldRectangleWidth, rectangleWidth));
	}
	...
	public void setRectangleHeight(double newRectangleHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__RECTANGLE_HEIGHT, oldRectangleHeight, rectangleHeight));
	}
	...
	public void setShowCenterLines(boolean newShowCenterLines) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__SHOW_CENTER_LINES, oldShowCenterLines, showCenterLines));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__RECTANGLE_WIDTH:
				return getRectangleWidth();
			case ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__RECTANGLE_HEIGHT:
				return getRectangleHeight();
			case ApogySurfaceEnvironmentPackage.RECTANGLE_SHAPE_IMAGE_LAYER__SHOW_CENTER_LINES:
