 ...
 *
 * $Id: CsvColumnItemProvider.java,v 1.2.4.2 2015/05/21 15:49:48 pallard Exp $
 */
...
/**
 * This is the item provider adapter for a {@link ca.gc.space.mrt.common.csv.CsvColumn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CsvColumnItemProvider
	 ...
	 * @generated
	 */
	public CsvColumnItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CsvColumn"));
	}
	...
	public String getText(Object object) {
		String label = ((CsvColumn)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CsvColumn_type") :
			getString("_UI_CsvColumn_type") + " " + label;
	}
