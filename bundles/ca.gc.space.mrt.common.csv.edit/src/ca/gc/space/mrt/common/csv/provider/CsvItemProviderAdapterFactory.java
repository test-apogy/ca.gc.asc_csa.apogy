 ...
 *
 * $Id: CsvItemProviderAdapterFactory.java,v 1.3.4.2 2015/05/21 15:49:48 pallard Exp $
 */
...
public class CsvItemProviderAdapterFactory extends CsvAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link ca.gc.space.mrt.common.csv.CsvColumsSet} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected CsvColumsSetItemProvider csvColumsSetItemProvider;

	/**
	 * This creates an adapter for a {@link ca.gc.space.mrt.common.csv.CsvColumsSet}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createCsvColumsSetAdapter() {
		if (csvColumsSetItemProvider == null) {
			csvColumsSetItemProvider = new CsvColumsSetItemProvider(this);
		}

		return csvColumsSetItemProvider;
	}
	...
	public void dispose() {
		...
		if (csvColumsSetItemProvider != null) csvColumsSetItemProvider.dispose();
	}
