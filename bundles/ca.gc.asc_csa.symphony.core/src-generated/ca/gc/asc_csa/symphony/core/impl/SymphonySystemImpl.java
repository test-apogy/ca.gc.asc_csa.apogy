 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getTopologyRoot <em>Topology Root</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getBindingSet <em>Binding Set</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getConnectionPointsList <em>Connection Points List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getAssemblyLinksList <em>Assembly Links List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getPoseProvider <em>Pose Provider</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.SymphonySystemImpl#getPoseProviderInstance <em>Pose Provider Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
