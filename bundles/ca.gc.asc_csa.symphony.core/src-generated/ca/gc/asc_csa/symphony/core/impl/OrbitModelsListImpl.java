 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.OrbitModelsListImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.OrbitModelsListImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.impl.OrbitModelsListImpl#getOrbitModels <em>Orbit Models</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (derivedFeatureID) {
				case SymphonyCorePackage.ORBIT_MODELS_LIST__DESCRIPTION: return EMFEcorePackage.DESCRIBED__DESCRIPTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Described.class) {
			switch (baseFeatureID) {
				case EMFEcorePackage.DESCRIBED__DESCRIPTION: return SymphonyCorePackage.ORBIT_MODELS_LIST__DESCRIPTION;
				default: return -1;
			}
		}
