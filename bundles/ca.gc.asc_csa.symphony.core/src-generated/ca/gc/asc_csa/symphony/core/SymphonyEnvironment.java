 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getWorksitesList <em>Worksites List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getActiveWorksite <em>Active Worksite</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getSymphonyTopology <em>Symphony Topology</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getTimeSourcesList <em>Time Sources List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getActiveTimeSource <em>Active Time Source</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment()
 * @model
 * @generated
 */
public interface SymphonyEnvironment extends Environment, Timed {
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment_WorksitesList()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getWorksitesList <em>Worksites List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment_ActiveWorksite()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getActiveWorksite <em>Active Worksite</em>}' reference.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment_SymphonyTopology()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getSymphonyTopology <em>Symphony Topology</em>}' reference.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment_TimeSourcesList()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getTimeSourcesList <em>Time Sources List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonyEnvironment_ActiveTimeSource()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonyEnvironment#getActiveTimeSource <em>Active Time Source</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
