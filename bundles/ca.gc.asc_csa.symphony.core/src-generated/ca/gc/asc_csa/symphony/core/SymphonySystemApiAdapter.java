 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonySystemApiAdapter#getPoseCorrector <em>Pose Corrector</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.SymphonySystemApiAdapter#getSymphonySystem <em>Symphony System</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonySystemApiAdapter()
 * @model
 * @generated
 */
public interface SymphonySystemApiAdapter extends TypeApiAdapter, PoseProvider
{
  ...
  /**
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.core.PoseCorrector#getSymphonySystemApiAdapter <em>Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonySystemApiAdapter_PoseCorrector()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonySystemApiAdapter#getPoseCorrector <em>Pose Corrector</em>}' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getSymphonySystemApiAdapter_SymphonySystem()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.SymphonySystemApiAdapter#getSymphonySystem <em>Symphony System</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
