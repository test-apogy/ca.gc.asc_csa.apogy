 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.core.ConnectionPointsList#getSymphonySystem <em>Symphony System</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.core.ConnectionPointsList#getConnectionPoints <em>Connection Points</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getConnectionPointsList()
 * @model
 * @generated
 */
public interface ConnectionPointsList extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.core.SymphonySystem#getConnectionPointsList <em>Connection Points List</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getConnectionPointsList_SymphonySystem()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.core.ConnectionPointsList#getSymphonySystem <em>Symphony System</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.symphony.core.ConnectionPoint}.
	 * It is bidirectional and its opposite is '{@link ca.gc.asc_csa.symphony.core.ConnectionPoint#getPointsList <em>Points List</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.symphony.core.SymphonyCorePackage#getConnectionPointsList_ConnectionPoints()
