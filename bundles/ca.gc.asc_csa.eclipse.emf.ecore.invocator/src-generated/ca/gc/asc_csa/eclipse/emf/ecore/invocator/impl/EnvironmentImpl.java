 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getInvocatorSession <em>Invocator Session</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getTypesList <em>Types List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getVariablesList <em>Variables List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getContextsList <em>Contexts List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.EnvironmentImpl#getActiveContext <em>Active Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
