 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getWatchesList <em>Watches List</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getTypeMemberReferenceTreeElement <em>Type Member Reference Tree Element</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.WatchImpl#getTreeRootNode <em>Tree Root Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
