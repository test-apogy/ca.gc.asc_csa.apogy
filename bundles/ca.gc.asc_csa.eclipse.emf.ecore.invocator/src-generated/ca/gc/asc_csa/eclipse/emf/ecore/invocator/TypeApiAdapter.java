 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getEnvironment <em>Environment</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getInstance <em>Instance</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getElementType <em>Element Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.invocator.EMFEcoreInvocatorPackage#getTypeApiAdapter()
 * @model
 * @generated
 */
public interface TypeApiAdapter extends EObject
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.invocator.EMFEcoreInvocatorPackage#getTypeApiAdapter_Environment()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getEnvironment <em>Environment</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.invocator.EMFEcoreInvocatorPackage#getTypeApiAdapter_Instance()
	 * @model transient="true"
	 * @generated
	 */
  EObject getInstance();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getInstance <em>Instance</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.invocator.EMFEcoreInvocatorPackage#getTypeApiAdapter_ElementType()
	 * @model transient="true"
	 * @generated
	 */
  Type getElementType();
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.TypeApiAdapter#getElementType <em>Element Type</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
