 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#getChild <em>Child</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#isRoot <em>Root</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#getLeafElement <em>Leaf Element</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#isLeaf <em>Leaf</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.invocator.impl.TypeMemberReferenceListElementImpl#getSubSegmentsCount <em>Sub Segments Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
