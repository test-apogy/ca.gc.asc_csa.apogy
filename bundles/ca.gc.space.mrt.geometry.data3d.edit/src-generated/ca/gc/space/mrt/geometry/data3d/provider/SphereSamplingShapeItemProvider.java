...
/**
 * This is the item provider adapter for a {@link ca.gc.space.mrt.geometry.data3d.SphereSamplingShape} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SphereSamplingShapeItemProvider
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public SphereSamplingShapeItemProvider(AdapterFactory adapterFactory)
	{
	...
	/**
	 * This returns SphereSamplingShape.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SphereSamplingShape"));
	}
	...
	{
		SphereSamplingShape<?> sphereSamplingShape = (SphereSamplingShape<?>)object;
		return getString("_UI_SphereSamplingShape_type") + " " + sphereSamplingShape.getRadius();
	}
