 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.impl.AntennaImpl#isInitialized <em>Initialized</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AntennaImpl extends MinimalEObjectImpl.Container implements Antenna
{
	 ...
	 */
  	...
  	{
		return EMFEcoreExampleAntennaPackage.Literals.ANTENNA;
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFEcoreExampleAntennaPackage.ANTENNA__INITIALIZED, oldInitialized, initialized));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EMFEcoreExampleAntennaPackage.ANTENNA___INIT:
				return init();
		}
