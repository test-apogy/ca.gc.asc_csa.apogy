 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#getPanAngle <em>Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#getTiltAngle <em>Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#isTrackingSun <em>Tracking Sun</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.EMFEcoreExampleAntennaPackage#getPTUDishAntenna()
 * @model abstract="true"
 * @generated
 */
public interface PTUDishAntenna extends DishAntenna
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.EMFEcoreExampleAntennaPackage#getPTUDishAntenna_PanAngle()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#getPanAngle <em>Pan Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.EMFEcoreExampleAntennaPackage#getPTUDishAntenna_TiltAngle()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' csa_units='rad' property='Readonly' propertyCategory='PTU Angles'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#getTiltAngle <em>Tilt Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.EMFEcoreExampleAntennaPackage#getPTUDishAntenna_TrackingSun()
	...
	boolean isTrackingSun();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.PTUDishAntenna#isTrackingSun <em>Tracking Sun</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
