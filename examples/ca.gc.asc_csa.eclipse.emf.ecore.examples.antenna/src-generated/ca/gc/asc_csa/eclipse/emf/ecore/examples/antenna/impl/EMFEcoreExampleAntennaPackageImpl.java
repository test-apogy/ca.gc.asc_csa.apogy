...
import ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.Antenna;
 ...
 * @generated
 */
public class EMFEcoreExampleAntennaPackageImpl extends EPackageImpl implements EMFEcoreExampleAntennaPackage
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.EMFEcoreExampleAntennaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  private EMFEcoreExampleAntennaPackageImpl()
  {
		super(eNS_URI, EMFEcoreExampleAntennaFactory.eINSTANCE);
	}
  ...
  /**
	 ...
	 * 
	 * <p>This method is used to initialize {@link EMFEcoreExampleAntennaPackage#eINSTANCE} when that field is accessed.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static EMFEcoreExampleAntennaPackage init()
  {
		if (isInited) return (EMFEcoreExampleAntennaPackage)EPackage.Registry.INSTANCE.getEPackage(EMFEcoreExampleAntennaPackage.eNS_URI);

		// Obtain or create and register package
		EMFEcoreExampleAntennaPackageImpl theEMFEcoreExampleAntennaPackage = (EMFEcoreExampleAntennaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EMFEcoreExampleAntennaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EMFEcoreExampleAntennaPackageImpl());
		...
		theEMFEcoreExampleAntennaPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEMFEcoreExampleAntennaPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EMFEcoreExampleAntennaPackage.eNS_URI, theEMFEcoreExampleAntennaPackage);
		return theEMFEcoreExampleAntennaPackage;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreExampleAntennaFactory getEMFEcoreExampleAntennaFactory()
  {
		return (EMFEcoreExampleAntennaFactory)getEFactoryInstance();
	}
  ...
  protected void createGenModelAnnotations()
  {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "EMFEcoreExampleAntenna",
			 "copyrightText", "Canadian Space Agency / Agence spatiale canadienne - Copyright (c) 2015",
			 "modelName", "EMFEcoreExampleAntenna",
			 "childCreationExtenders", "true",
			 "extensibleProviderFactory", "true",
			 "suppressGenModelAnnotations", "false",
			 "modelDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna/src-generated",
			 "editDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.antenna.edit/src-generated",
...
} //EMFEcoreExampleAntennaPackageImpl
