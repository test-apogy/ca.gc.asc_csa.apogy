 ...
 * @generated
 */
public class ApogyExamplesLanderApogySwitch<T> extends Switch<T>
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public ApogyExamplesLanderApogySwitch()
  {
  ...
  {
		switch (classifierID) {
			case ApogyExamplesLanderApogyPackage.LANDER_APOGY_SYSTEM_API_ADAPTER: {
				LanderApogySystemApiAdapter landerApogySystemApiAdapter = (LanderApogySystemApiAdapter)theEObject;
				T result = caseLanderApogySystemApiAdapter(landerApogySystemApiAdapter);
				if (result == null) result = caseApogySystemApiAdapter(landerApogySystemApiAdapter);
				if (result == null) result = caseTypeApiAdapter(landerApogySystemApiAdapter);
				if (result == null) result = casePoseProvider(landerApogySystemApiAdapter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ApogyExamplesLanderApogyPackage.LANDER_DATA: {
				LanderData landerData = (LanderData)theEObject;
				T result = caseLanderData(landerData);
				if (result == null) result = caseApogyInitializationData(landerData);
  ...
  /**
	 * Returns the result of interpreting the object as an instance of '<em>Lander Apogy System Api Adapter</em>'.
	 * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lander Apogy System Api Adapter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
  public T caseLanderApogySystemApiAdapter(LanderApogySystemApiAdapter object)
  {
		return null;
	}
...
} //ApogyExamplesLanderApogySwitch
