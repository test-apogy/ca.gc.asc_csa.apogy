 ...
 * </p>
 * <ul>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#getTurretAngle <em>Turret Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#getShoulderAngle <em>Shoulder Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#getElbowAngle <em>Elbow Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#getWristAngle <em>Wrist Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#isArmMoving <em>Arm Moving</em>}</li>
 *   <li>{@link ca.gc.asc_csa.apogy.examples.robotic_arm.impl.RoboticArmImpl#getSpeed <em>Speed</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RoboticArmImpl extends MinimalEObjectImpl.Container
	...
	public void setSpeed(MoveSpeedLevel newSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__SPEED, oldSpeed, speed));
	}
	...
	public void setTurretAngle(double newTurretAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__TURRET_ANGLE, oldTurretAngle, turretAngle));
	}
	...
	public void setShoulderAngle(double newShoulderAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__SHOULDER_ANGLE, oldShoulderAngle, shoulderAngle));
	}
	...
	public void setElbowAngle(double newElbowAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__ELBOW_ANGLE, oldElbowAngle, elbowAngle));
	}
	...
	public void setWristAngle(double newWristAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__WRIST_ANGLE, oldWristAngle, wristAngle));
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__INITIALIZED, oldInitialized, initialized));
	}
	...
	public void setArmMoving(boolean newArmMoving) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApogyExamplesRoboticArmPackage.ROBOTIC_ARM__ARM_MOVING, oldArmMoving, armMoving));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
			case ApogyExamplesRoboticArmPackage.ROBOTIC_ARM___INIT:
				return init();
			case ApogyExamplesRoboticArmPackage.ROBOTIC_ARM___CMD_MOVE_SPEED_LEVEL__MOVESPEEDLEVEL:
				cmdMoveSpeedLevel((MoveSpeedLevel)arguments.get(0));
				return null;
			case ApogyExamplesRoboticArmPackage.ROBOTIC_ARM___MOVE_TO__DOUBLE_DOUBLE_DOUBLE_DOUBLE:
				moveTo((Double)arguments.get(0), (Double)arguments.get(1), (Double)arguments.get(2), (Double)arguments.get(3));
				return null;
			case ApogyExamplesRoboticArmPackage.ROBOTIC_ARM___STOW:
				stow();
				return null;
		}
