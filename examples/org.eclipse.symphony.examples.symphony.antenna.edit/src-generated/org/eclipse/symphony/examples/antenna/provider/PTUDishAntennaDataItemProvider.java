...
/**
 * This is the item provider adapter for a {@link org.eclipse.symphony.examples.antenna.PTUDishAntennaData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PTUDishAntennaDataItemProvider extends SymphonyInitializationDataItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__FOV,
				 true,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__PAN_ANGLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__TILT_ANGLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__TRACKING_SUN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__INITIALIZED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SymphonyExampleAntennaSymphonyPackage.Literals.PTU_DISH_ANTENNA_DATA__FOV);
		}
