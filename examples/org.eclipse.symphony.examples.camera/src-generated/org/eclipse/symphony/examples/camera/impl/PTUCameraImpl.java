...
public abstract class PTUCameraImpl extends CameraImpl implements PTUCamera
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
		...
		if (baseClass == AbstractActuator.class) {
			switch (derivedFeatureID) {
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__MOVING: return MRTActuatorsPackage.ABSTRACT_ACTUATOR__MOVING;
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__ACTUATOR_STATUS: return MRTActuatorsPackage.ABSTRACT_ACTUATOR__ACTUATOR_STATUS;
				default: return -1;
			}
		}
		if (baseClass == PanTiltUnit.class) {
			switch (derivedFeatureID) {
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__CURRENT_PAN_ANGLE: return MRTActuatorsPackage.PAN_TILT_UNIT__CURRENT_PAN_ANGLE;
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__CURRENT_TILT_ANGLE: return MRTActuatorsPackage.PAN_TILT_UNIT__CURRENT_TILT_ANGLE;
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__COMMANDED_PAN_ANGLE: return MRTActuatorsPackage.PAN_TILT_UNIT__COMMANDED_PAN_ANGLE;
				case EMFEcoreExampleCameraPackage.PTU_CAMERA__COMMANDED_TILT_ANGLE: return MRTActuatorsPackage.PAN_TILT_UNIT__COMMANDED_TILT_ANGLE;
				default: return -1;
			}
		}
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
		...
		if (baseClass == AbstractActuator.class) {
			switch (baseFeatureID) {
				case MRTActuatorsPackage.ABSTRACT_ACTUATOR__MOVING: return EMFEcoreExampleCameraPackage.PTU_CAMERA__MOVING;
				case MRTActuatorsPackage.ABSTRACT_ACTUATOR__ACTUATOR_STATUS: return EMFEcoreExampleCameraPackage.PTU_CAMERA__ACTUATOR_STATUS;
				default: return -1;
			}
		}
		if (baseClass == PanTiltUnit.class) {
			switch (baseFeatureID) {
				case MRTActuatorsPackage.PAN_TILT_UNIT__CURRENT_PAN_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA__CURRENT_PAN_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT__CURRENT_TILT_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA__CURRENT_TILT_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT__COMMANDED_PAN_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA__COMMANDED_PAN_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT__COMMANDED_TILT_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA__COMMANDED_TILT_ANGLE;
				default: return -1;
			}
		}
  ...
  public int eDerivedOperationID(int baseOperationID, Class<?> baseClass)
  {
		if (baseClass == EObject.class) {
			switch (baseOperationID) {
				case EcorePackage.EOBJECT___ECLASS: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECLASS;
				case EcorePackage.EOBJECT___EIS_PROXY: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EIS_PROXY;
				case EcorePackage.EOBJECT___ERESOURCE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ERESOURCE;
				case EcorePackage.EOBJECT___ECONTAINER: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECONTAINER;
				case EcorePackage.EOBJECT___ECONTAINING_FEATURE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECONTAINING_FEATURE;
				case EcorePackage.EOBJECT___ECONTAINMENT_FEATURE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECONTAINMENT_FEATURE;
				case EcorePackage.EOBJECT___ECONTENTS: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECONTENTS;
				case EcorePackage.EOBJECT___EALL_CONTENTS: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EALL_CONTENTS;
				case EcorePackage.EOBJECT___ECROSS_REFERENCES: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ECROSS_REFERENCES;
				case EcorePackage.EOBJECT___EGET__ESTRUCTURALFEATURE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EGET__ESTRUCTURALFEATURE;
				case EcorePackage.EOBJECT___EGET__ESTRUCTURALFEATURE_BOOLEAN: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EGET__ESTRUCTURALFEATURE_BOOLEAN;
				case EcorePackage.EOBJECT___ESET__ESTRUCTURALFEATURE_OBJECT: return EMFEcoreExampleCameraPackage.PTU_CAMERA___ESET__ESTRUCTURALFEATURE_OBJECT;
				case EcorePackage.EOBJECT___EIS_SET__ESTRUCTURALFEATURE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EIS_SET__ESTRUCTURALFEATURE;
				case EcorePackage.EOBJECT___EUNSET__ESTRUCTURALFEATURE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EUNSET__ESTRUCTURALFEATURE;
				case EcorePackage.EOBJECT___EINVOKE__EOPERATION_ELIST: return EMFEcoreExampleCameraPackage.PTU_CAMERA___EINVOKE__EOPERATION_ELIST;
				default: return -1;
			}
		}
		if (baseClass == AbstractActuator.class) {
		...
		if (baseClass == PanTiltUnit.class) {
			switch (baseOperationID) {
				case MRTActuatorsPackage.PAN_TILT_UNIT___GET_MAXIMUM_PAN_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___GET_MAXIMUM_PAN_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___GET_MINIMUM_PAN_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___GET_MINIMUM_PAN_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___GET_MAXIMUM_TILT_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___GET_MAXIMUM_TILT_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___GET_MINIMUM_TILT_ANGLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___GET_MINIMUM_TILT_ANGLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_TO_PAN_TILT__DOUBLE_DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_TO_PAN_TILT__DOUBLE_DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_TO_PAN__DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_TO_PAN__DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_TO_TILT__DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_TO_TILT__DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_BY_PAN_TILT__DOUBLE_DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_BY_PAN_TILT__DOUBLE_DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_BY_PAN__DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_BY_PAN__DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___MOVE_BY_TILT__DOUBLE: return EMFEcoreExampleCameraPackage.PTU_CAMERA___MOVE_BY_TILT__DOUBLE;
				case MRTActuatorsPackage.PAN_TILT_UNIT___STOP_MOTION: return EMFEcoreExampleCameraPackage.PTU_CAMERA___STOP_MOTION;
				default: return -1;
			}
		}
