 ...
 * @generated
 */
public class EMFEcoreExampleLidarSwitch<T> extends Switch<T>
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreExampleLidarSwitch()
  {
  ...
  {
		switch (classifierID) {
			case EMFEcoreExampleLidarPackage.LIDAR: {
				Lidar lidar = (Lidar)theEObject;
				T result = caseLidar(lidar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EMFEcoreExampleLidarPackage.LIDAR_STUB: {
			...
			case EMFEcoreExampleLidarPackage.LIDAR_SIMULATED: {
