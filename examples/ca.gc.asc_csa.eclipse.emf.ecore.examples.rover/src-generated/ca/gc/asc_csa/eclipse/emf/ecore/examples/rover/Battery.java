 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#isActive <em>Active</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getVoltage <em>Voltage</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getCurrent <em>Current</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getBattery()
 * @model
 * @generated
 */
public interface Battery extends EObject {
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getBattery_Active()
	 * @model unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#isActive <em>Active</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getBattery_Voltage()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getVoltage <em>Voltage</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getBattery_Current()
	 * @model default="0.0" unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getCurrent <em>Current</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
