 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='EMFEcoreExampleRover' copyrightText='Canadian Space Agency / Agence spatiale canadienne - Copyright (c) 2015' modelName='EMFEcoreExampleRover' childCreationExtenders='true' extensibleProviderFactory='true' suppressGenModelAnnotations='false' modelDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.rover/src-generated' editDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.edit/src-generated' basePackage='ca.gc.asc_csa.eclipse.emf.ecore.examples'"
 * @generated
 */
public interface EMFEcoreExampleRoverPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.eclipse.emf.ecore.examples.rover";
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  EMFEcoreExampleRoverPackage eINSTANCE = ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl.init();

  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.BatteryImpl <em>Battery</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.BatteryImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getBattery()
	 * @generated
	 */
	int BATTERY = 0;
	...
	int BATTERY_OPERATION_COUNT = 2;
		...
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.PowerSystemImpl <em>Power System</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.PowerSystemImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getPowerSystem()
	 * @generated
	 */
	int POWER_SYSTEM = 1;
	...
	int POWER_SYSTEM_OPERATION_COUNT = 1;
		...
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverImpl <em>Rover</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRover()
	 * @generated
	 */
  int ROVER = 2;
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverStubImpl <em>Rover Stub</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverStubImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRoverStub()
	 * @generated
	 */
  int ROVER_STUB = 3;
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverSimulatedImpl <em>Rover Simulated</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverSimulatedImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRoverSimulated()
	 * @generated
	 */
	...
	int ROVER_SIMULATED_OPERATION_COUNT = ROVER_OPERATION_COUNT + 0;
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery <em>Battery</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Battery</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery
	 * @generated
	 */
	EClass getBattery();

		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#isActive <em>Active</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Active</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#isActive()
	 * @see #getBattery()
	 * @generated
	 */
	EAttribute getBattery_Active();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getVoltage <em>Voltage</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Voltage</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getVoltage()
	 * @see #getBattery()
	 * @generated
	 */
	EAttribute getBattery_Voltage();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getCurrent <em>Current</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Current</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#getCurrent()
	 * @see #getBattery()
	 * @generated
	 */
	EAttribute getBattery_Current();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#activate() <em>Activate</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Activate</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#activate()
	 * @generated
	 */
	EOperation getBattery__Activate();

		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#deactivate() <em>Deactivate</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Deactivate</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery#deactivate()
	 * @generated
	 */
	EOperation getBattery__Deactivate();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem <em>Power System</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Power System</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem
	 * @generated
	 */
	EClass getPowerSystem();

		/**
	 * Returns the meta object for the containment reference list '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getBatteries <em>Batteries</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Batteries</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getBatteries()
	 * @see #getPowerSystem()
	 * @generated
	 */
	EReference getPowerSystem_Batteries();
		...
		/**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getActiveBattery <em>Active Battery</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Active Battery</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getActiveBattery()
	 * @see #getPowerSystem()
	 * @generated
	 */
	EReference getPowerSystem_ActiveBattery();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentVoltage <em>Current Voltage</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Current Voltage</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentVoltage()
	 * @see #getPowerSystem()
	 * @generated
	 */
	EAttribute getPowerSystem_CurrentVoltage();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentCurrent <em>Current Current</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Current Current</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentCurrent()
	 * @see #getPowerSystem()
	 * @generated
	 */
	EAttribute getPowerSystem_CurrentCurrent();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#changeActiveBatteryTo(int) <em>Change Active Battery To</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Change Active Battery To</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#changeActiveBatteryTo(int)
	 * @generated
	 */
	EOperation getPowerSystem__ChangeActiveBatteryTo__int();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover <em>Rover</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Rover</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover
	 * @generated
	 */
  EClass getRover();

  /**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getRoboticArm <em>Robotic Arm</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Robotic Arm</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getRoboticArm()
	 * @see #getRover()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getMobilePlatform <em>Mobile Platform</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Mobile Platform</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getMobilePlatform()
	 * @see #getRover()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getArmCamera <em>Arm Camera</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Arm Camera</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getArmCamera()
	 * @see #getRover()
	 * @generated
	 */
	EReference getRover_ArmCamera();
		...
		/**
	 * Returns the meta object for the reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getCenterCamera <em>Center Camera</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Center Camera</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getCenterCamera()
	 * @see #getRover()
	 * @generated
	 */
	EReference getRover_CenterCamera();
		...
		/**
	 * Returns the meta object for the containment reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getPowerSystem <em>Power System</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Power System</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getPowerSystem()
	 * @see #getRover()
	 * @generated
	 */
	EReference getRover_PowerSystem();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getLinearVelocity <em>Linear Velocity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Linear Velocity</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getLinearVelocity()
	 * @see #getRover()
	 * @generated
	 */
	EAttribute getRover_LinearVelocity();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getAngularVelocity <em>Angular Velocity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Angular Velocity</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getAngularVelocity()
	 * @see #getRover()
	 * @generated
	 */
	EAttribute getRover_AngularVelocity();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isInitialized()
	 * @see #getRover()
	 * @generated
	 */
	EAttribute getRover_Initialized();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isDisposed <em>Disposed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Disposed</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isDisposed()
	 * @see #getRover()
	 * @generated
	 */
	EAttribute getRover_Disposed();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#init() <em>Init</em>}' operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Init</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#init()
	 * @generated
	 */
  EOperation getRover__Init();

  /**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdLinearVelocity(double) <em>Cmd Linear Velocity</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Cmd Linear Velocity</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdLinearVelocity(double)
	 * @generated
	 */
	EOperation getRover__CmdLinearVelocity__double();

		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdAngularVelocity(double) <em>Cmd Angular Velocity</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Cmd Angular Velocity</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdAngularVelocity(double)
	 * @generated
	 */
	EOperation getRover__CmdAngularVelocity__double();

		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdVelocities(double, double) <em>Cmd Velocities</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Cmd Velocities</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#cmdVelocities(double, double)
	 * @generated
	 */
	EOperation getRover__CmdVelocities__double_double();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.RoverStub <em>Rover Stub</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Rover Stub</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.RoverStub
	 * @generated
	 */
  EClass getRoverStub();

  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.RoverSimulated <em>Rover Simulated</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Rover Simulated</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.RoverSimulated
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EMFEcoreExampleRoverFactory getEMFEcoreExampleRoverFactory();
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.BatteryImpl <em>Battery</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.BatteryImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getBattery()
		...
		EOperation BATTERY___DEACTIVATE = eINSTANCE.getBattery__Deactivate();
			...
			/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.PowerSystemImpl <em>Power System</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.PowerSystemImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getPowerSystem()
		...
		EOperation POWER_SYSTEM___CHANGE_ACTIVE_BATTERY_TO__INT = eINSTANCE.getPowerSystem__ChangeActiveBatteryTo__int();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverImpl <em>Rover</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRover()
    ...
    /**
		...
		EOperation ROVER___CMD_VELOCITIES__DOUBLE_DOUBLE = eINSTANCE.getRover__CmdVelocities__double_double();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverStubImpl <em>Rover Stub</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverStubImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRoverStub()
    ...
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverSimulatedImpl <em>Rover Simulated</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.RoverSimulatedImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.impl.EMFEcoreExampleRoverPackageImpl#getRoverSimulated()
