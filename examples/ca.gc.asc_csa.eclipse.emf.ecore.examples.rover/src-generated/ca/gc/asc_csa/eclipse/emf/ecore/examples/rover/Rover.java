 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getRoboticArm <em>Robotic Arm</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getMobilePlatform <em>Mobile Platform</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getArmCamera <em>Arm Camera</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getCenterCamera <em>Center Camera</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getPowerSystem <em>Power System</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getLinearVelocity <em>Linear Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getAngularVelocity <em>Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isDisposed <em>Disposed</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover()
 * @model abstract="true"
 * @generated
 */
public interface Rover extends Disposable
{
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_RoboticArm()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getRoboticArm <em>Robotic Arm</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_MobilePlatform()
	 * @model required="true" transient="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' propertyCategory='Subcomponents' children='true'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getMobilePlatform <em>Mobile Platform</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_ArmCamera()
	 * @model required="true" transient="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' propertyCategory='Subcomponents' children='true'"
	 * @generated
	 */
	PTUCamera getArmCamera();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getArmCamera <em>Arm Camera</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_CenterCamera()
	 * @model required="true" transient="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' propertyCategory='Subcomponents' children='true'"
	 * @generated
	 */
	PTUCamera getCenterCamera();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getCenterCamera <em>Center Camera</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_PowerSystem()
	...
	PowerSystem getPowerSystem();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#getPowerSystem <em>Power System</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_Initialized()
	...
	boolean isInitialized();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getRover_Disposed()
	 * @model default="false" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='Status'"
	 * @generated
	 */
	boolean isDisposed();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Rover#isDisposed <em>Disposed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
