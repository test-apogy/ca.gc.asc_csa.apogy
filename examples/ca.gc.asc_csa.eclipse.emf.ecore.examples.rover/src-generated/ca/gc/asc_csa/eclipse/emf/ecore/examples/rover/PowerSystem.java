 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getBatteries <em>Batteries</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getActiveBattery <em>Active Battery</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentVoltage <em>Current Voltage</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getCurrentCurrent <em>Current Current</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getPowerSystem()
 * @model
 * @generated
 */
public interface PowerSystem extends EObject {
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getPowerSystem_Batteries()
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getPowerSystem_ActiveBattery()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.PowerSystem#getActiveBattery <em>Active Battery</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getPowerSystem_CurrentVoltage()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' csa_units='V' get='<%ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery%> _activeBattery = this.getActiveBattery();\nboolean _notEquals = (!<%com.google.common.base.Objects%>.equal(_activeBattery, null));\nif (_notEquals)\n{\n\t<%ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery%> _activeBattery_1 = this.getActiveBattery();\n\treturn _activeBattery_1.getVoltage();\n}\nelse\n{\n\treturn 0.0;\n}'"
	 * @generated
	 */
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.EMFEcoreExampleRoverPackage#getPowerSystem_CurrentCurrent()
	 * @model unique="false" transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' csa_units='A' get='<%ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery%> _activeBattery = this.getActiveBattery();\nboolean _notEquals = (!<%com.google.common.base.Objects%>.equal(_activeBattery, null));\nif (_notEquals)\n{\n\t<%ca.gc.asc_csa.eclipse.emf.ecore.examples.rover.Battery%> _activeBattery_1 = this.getActiveBattery();\n\treturn _activeBattery_1.getCurrent();\n}\nelse\n{\n\treturn 0.0;\n}'"
	 * @generated
	 */
