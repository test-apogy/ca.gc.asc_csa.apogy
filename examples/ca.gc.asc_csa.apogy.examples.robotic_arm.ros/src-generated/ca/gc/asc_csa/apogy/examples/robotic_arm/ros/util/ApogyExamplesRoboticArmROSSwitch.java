 ...
 * @generated
 */
public class ApogyExamplesRoboticArmROSSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ApogyExamplesRoboticArmROSSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ApogyExamplesRoboticArmROSPackage.ROBOTIC_ARM_ROS: {
				RoboticArmROS roboticArmROS = (RoboticArmROS)theEObject;
				T result = caseRoboticArmROS(roboticArmROS);
				if (result == null) result = caseRoboticArm(roboticArmROS);
				if (result == null) result = caseROSInterface(roboticArmROS);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Robotic Arm ROS</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Robotic Arm ROS</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRoboticArmROS(RoboticArmROS object) {
		return null;
	}
...
} //ApogyExamplesRoboticArmROSSwitch
