 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.SymphonyExampleMobilePlatformFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='SymphonyExampleMobilePlatform' childCreationExtenders='true' extensibleProviderFactory='true' multipleEditorPages='false' copyrightText='Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015' modelName='SymphonyExampleMobilePlatform' modelDirectory='/ca.gc.asc_csa.symphony.examples.mobile_platform/src-generated' editDirectory='/ca.gc.asc_csa.symphony.examples.mobile_platform.edit/src-generated' basePackage='ca.gc.asc_csa.symphony.examples'"
 * @generated
 */
public interface SymphonyExampleMobilePlatformPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.symphony.examples.mobile_platform";
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  SymphonyExampleMobilePlatformPackage eINSTANCE = ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl.init();

  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemApiAdapterImpl <em>Mobile Platform Symphony System Api Adapter</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemApiAdapterImpl
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformSymphonySystemApiAdapter()
	 * @generated
	 */
	...
	int MOBILE_PLATFORM_SYMPHONY_SYSTEM_API_ADAPTER_OPERATION_COUNT = SymphonyCorePackage.SYMPHONY_SYSTEM_API_ADAPTER_OPERATION_COUNT + 0;
		...
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl <em>Mobile Platform Data</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformData()
	 * @generated
	 */
	...
	int MOBILE_PLATFORM_DATA_OPERATION_COUNT = SymphonyCorePackage.SYMPHONY_INITIALIZATION_DATA_OPERATION_COUNT + 0;
		...
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemAnnotationImpl <em>Mobile Platform Symphony System Annotation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemAnnotationImpl
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformSymphonySystemAnnotation()
	 * @generated
	 */
	...
	int MOBILE_PLATFORM_SYMPHONY_SYSTEM_ANNOTATION_OPERATION_COUNT = SymphonyEnvironmentUIPackage.POSE_VARIABLE_ANNOTATION_OPERATION_COUNT + 0;
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformSymphonySystemApiAdapter <em>Mobile Platform Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Mobile Platform Symphony System Api Adapter</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformSymphonySystemApiAdapter
	 * @generated
	 */
	EClass getMobilePlatformSymphonySystemApiAdapter();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData <em>Mobile Platform Data</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Mobile Platform Data</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData
	 * @generated
	 */
	EClass getMobilePlatformData();

		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#isInitialized()
	...
	EAttribute getMobilePlatformData_Initialized();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#isDisposed <em>Disposed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Disposed</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#isDisposed()
	 * @see #getMobilePlatformData()
	 * @generated
	 */
	EAttribute getMobilePlatformData_Disposed();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#getLinearVelocity <em>Linear Velocity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Linear Velocity</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#getLinearVelocity()
	 * @see #getMobilePlatformData()
	 * @generated
	 */
	EAttribute getMobilePlatformData_LinearVelocity();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#getAngularVelocity <em>Angular Velocity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Angular Velocity</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData#getAngularVelocity()
	 * @see #getMobilePlatformData()
	 * @generated
	 */
	EAttribute getMobilePlatformData_AngularVelocity();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformSymphonySystemAnnotation <em>Mobile Platform Symphony System Annotation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Mobile Platform Symphony System Annotation</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformSymphonySystemAnnotation
	 * @generated
	 */
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemApiAdapterImpl <em>Mobile Platform Symphony System Api Adapter</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemApiAdapterImpl
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformSymphonySystemApiAdapter()
		...
		EClass MOBILE_PLATFORM_SYMPHONY_SYSTEM_API_ADAPTER = eINSTANCE.getMobilePlatformSymphonySystemApiAdapter();
			/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl <em>Mobile Platform Data</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformData()
		...
		EAttribute MOBILE_PLATFORM_DATA__ANGULAR_VELOCITY = eINSTANCE.getMobilePlatformData_AngularVelocity();
			/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemAnnotationImpl <em>Mobile Platform Symphony System Annotation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformSymphonySystemAnnotationImpl
		 * @see ca.gc.asc_csa.symphony.examples.mobile_platform.impl.SymphonyExampleMobilePlatformPackageImpl#getMobilePlatformSymphonySystemAnnotation()
