...
import ca.gc.asc_csa.symphony.examples.mobile_platform.MobilePlatformData;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl#isDisposed <em>Disposed</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl#getLinearVelocity <em>Linear Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.mobile_platform.impl.MobilePlatformDataImpl#getAngularVelocity <em>Angular Velocity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MobilePlatformDataImpl extends SymphonyInitializationDataImpl implements MobilePlatformData {
	...
	protected EClass eStaticClass() {
		return SymphonyExampleMobilePlatformPackage.Literals.MOBILE_PLATFORM_DATA;
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleMobilePlatformPackage.MOBILE_PLATFORM_DATA__INITIALIZED, oldInitialized, initialized));
	}
	...
	public void setDisposed(boolean newDisposed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleMobilePlatformPackage.MOBILE_PLATFORM_DATA__DISPOSED, oldDisposed, disposed));
	}
	...
	public void setLinearVelocity(double newLinearVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleMobilePlatformPackage.MOBILE_PLATFORM_DATA__LINEAR_VELOCITY, oldLinearVelocity, linearVelocity));
	}
	...
	public void setAngularVelocity(double newAngularVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleMobilePlatformPackage.MOBILE_PLATFORM_DATA__ANGULAR_VELOCITY, oldAngularVelocity, angularVelocity));
	}
