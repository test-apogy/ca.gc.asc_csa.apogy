 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getTurretAngle <em>Turret Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getShoulderAngle <em>Shoulder Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getElbowAngle <em>Elbow Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getWristAngle <em>Wrist Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isArmMoving <em>Arm Moving</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getSpeed <em>Speed</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm()
 * @model abstract="true"
 * @generated
 */
public interface RoboticArm extends EObject
{
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_Speed()
	 * @model unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getSpeed <em>Speed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_TurretAngle()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getTurretAngle <em>Turret Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_ShoulderAngle()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getShoulderAngle <em>Shoulder Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_ElbowAngle()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getElbowAngle <em>Elbow Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_WristAngle()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='Joint Angles' csa_units='\260'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getWristAngle <em>Wrist Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_Initialized()
	...
	boolean isInitialized();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmPackage#getRoboticArm_ArmMoving()
	 * @model default="false" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='Status'"
	 * @generated
	 */
	boolean isArmMoving();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isArmMoving <em>Arm Moving</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
