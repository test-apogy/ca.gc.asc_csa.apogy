 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#getTurretAngle <em>Turret Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#getShoulderAngle <em>Shoulder Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#getElbowAngle <em>Elbow Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#getWristAngle <em>Wrist Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#isArmMoving <em>Arm Moving</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl#getSpeed <em>Speed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
