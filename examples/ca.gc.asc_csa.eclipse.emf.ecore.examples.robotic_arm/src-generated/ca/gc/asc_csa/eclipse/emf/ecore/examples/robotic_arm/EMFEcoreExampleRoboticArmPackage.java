 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.EMFEcoreExampleRoboticArmFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='EMFEcoreExampleRoboticArm' copyrightText='Canadian Space Agency / Agence spatiale canadienne - Copyright (c) 2015' modelName='EMFEcoreExampleRoboticArm' childCreationExtenders='true' extensibleProviderFactory='true' suppressGenModelAnnotations='false' modelDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm/src-generated' editDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.edit/src-generated' basePackage='ca.gc.asc_csa.eclipse.emf.ecore.examples'"
 * @generated
 */
public interface EMFEcoreExampleRoboticArmPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm";
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  EMFEcoreExampleRoboticArmPackage eINSTANCE = ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl.init();

  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl <em>Robotic Arm</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArm()
	 * @generated
	 */
  int ROBOTIC_ARM = 0;
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmStubImpl <em>Robotic Arm Stub</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmStubImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArmStub()
	 * @generated
	 */
	...
	int ROBOTIC_ARM_STUB_OPERATION_COUNT = ROBOTIC_ARM_OPERATION_COUNT + 0;
		...
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmSimulatedImpl <em>Robotic Arm Simulated</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmSimulatedImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArmSimulated()
	 * @generated
	 */
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel <em>Move Speed Level</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getMoveSpeedLevel()
	 * @generated
	 */
	int MOVE_SPEED_LEVEL = 3;

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm <em>Robotic Arm</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getSpeed <em>Speed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Speed</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getSpeed()
	 * @see #getRoboticArm()
	 * @generated
	 */
	EAttribute getRoboticArm_Speed();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#init() <em>Init</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Init</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#init()
	 * @generated
	 */
	EOperation getRoboticArm__Init();

		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getTurretAngle <em>Turret Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Turret Angle</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getTurretAngle()
	 * @see #getRoboticArm()
	 * @generated
	 */
	EAttribute getRoboticArm_TurretAngle();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getShoulderAngle <em>Shoulder Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Shoulder Angle</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getShoulderAngle()
	 * @see #getRoboticArm()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getElbowAngle <em>Elbow Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Elbow Angle</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getElbowAngle()
	 * @see #getRoboticArm()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getWristAngle <em>Wrist Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Wrist Angle</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#getWristAngle()
	 * @see #getRoboticArm()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isInitialized()
	 * @see #getRoboticArm()
	 * @generated
	 */
	EAttribute getRoboticArm_Initialized();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isArmMoving <em>Arm Moving</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Arm Moving</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#isArmMoving()
	 * @see #getRoboticArm()
	 * @generated
	 */
	EAttribute getRoboticArm_ArmMoving();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#moveTo(double, double, double, double) <em>Move To</em>}' operation.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Move To</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#moveTo(double, double, double, double)
	 * @generated
	 */
  EOperation getRoboticArm__MoveTo__double_double_double_double();

  /**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#stow() <em>Stow</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Stow</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#stow()
	 * @generated
	 */
	EOperation getRoboticArm__Stow();

		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#cmdMoveSpeedLevel(ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel) <em>Cmd Move Speed Level</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Cmd Move Speed Level</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArm#cmdMoveSpeedLevel(ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel)
	 * @generated
	 */
	EOperation getRoboticArm__CmdMoveSpeedLevel__MoveSpeedLevel();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArmStub <em>Robotic Arm Stub</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getRoboticArmStub();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.RoboticArmSimulated <em>Robotic Arm Simulated</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for enum '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel <em>Move Speed Level</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl <em>Robotic Arm</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArm()
    ...
    /**
		...
		EOperation ROBOTIC_ARM___CMD_MOVE_SPEED_LEVEL__MOVESPEEDLEVEL = eINSTANCE.getRoboticArm__CmdMoveSpeedLevel__MoveSpeedLevel();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmStubImpl <em>Robotic Arm Stub</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmStubImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArmStub()
		...
		EClass ROBOTIC_ARM_STUB = eINSTANCE.getRoboticArmStub();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmSimulatedImpl <em>Robotic Arm Simulated</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.RoboticArmSimulatedImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getRoboticArmSimulated()
    ...
    EClass ROBOTIC_ARM_SIMULATED = eINSTANCE.getRoboticArmSimulated();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel <em>Move Speed Level</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.MoveSpeedLevel
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.robotic_arm.impl.EMFEcoreExampleRoboticArmPackageImpl#getMoveSpeedLevel()
