 ...
 * @generated
 */
public class EMFEcoreExampleLanderPackageImpl extends EPackageImpl implements EMFEcoreExampleLanderPackage
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.EMFEcoreExampleLanderPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  private EMFEcoreExampleLanderPackageImpl()
  {
		super(eNS_URI, EMFEcoreExampleLanderFactory.eINSTANCE);
	}
  ...
  /**
	 ...
	 * 
	 * <p>This method is used to initialize {@link EMFEcoreExampleLanderPackage#eINSTANCE} when that field is accessed.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static EMFEcoreExampleLanderPackage init()
  {
		if (isInited) return (EMFEcoreExampleLanderPackage)EPackage.Registry.INSTANCE.getEPackage(EMFEcoreExampleLanderPackage.eNS_URI);

		// Obtain or create and register package
		EMFEcoreExampleLanderPackageImpl theEMFEcoreExampleLanderPackage = (EMFEcoreExampleLanderPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EMFEcoreExampleLanderPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EMFEcoreExampleLanderPackageImpl());
		...
		theEMFEcoreExampleLanderPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEMFEcoreExampleLanderPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EMFEcoreExampleLanderPackage.eNS_URI, theEMFEcoreExampleLanderPackage);
		return theEMFEcoreExampleLanderPackage;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreExampleLanderFactory getEMFEcoreExampleLanderFactory()
  {
		return (EMFEcoreExampleLanderFactory)getEFactoryInstance();
	}
  ...
  protected void createGenModelAnnotations()
  {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "EMFEcoreExampleLander",
			 "copyrightText", "Canadian Space Agency / Agence spatiale canadienne - Copyright (c) 2015",
			 "modelName", "EMFEcoreExampleLander",
			 "childCreationExtenders", "true",
			 "extensibleProviderFactory", "true",
			 "suppressGenModelAnnotations", "false",
			 "modelDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.lander/src-generated",
			 "editDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.edit/src-generated",
...
} //EMFEcoreExampleLanderPackageImpl
