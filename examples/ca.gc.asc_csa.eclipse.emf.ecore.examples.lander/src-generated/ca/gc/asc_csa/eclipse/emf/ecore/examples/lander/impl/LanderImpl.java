 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getThruster <em>Thruster</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegAExtension <em>Leg AExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegBExtension <em>Leg BExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegCExtension <em>Leg CExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegAPosition <em>Leg APosition</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegBPosition <em>Leg BPosition</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getLegCPosition <em>Leg CPosition</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getXAngularVelocity <em>XAngular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getYAngularVelocity <em>YAngular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getMass <em>Mass</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#getGravitationalPull <em>Gravitational Pull</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isChangingLegs <em>Changing Legs</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isChangingAttitude <em>Changing Attitude</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isChangingLocation <em>Changing Location</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isFlyingEnabled <em>Flying Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.lander.impl.LanderImpl#isDisposed <em>Disposed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
