...
/**
 * This is the activator for the Lander Sample.
 * It is used when performing the required
 * OSGi operations as well as when logging.
 */
public class Activator implements BundleActivator
{
	public static final String ID = "ca.gc.asc_csa.eclipse.emf.ecore.examples.lander";
