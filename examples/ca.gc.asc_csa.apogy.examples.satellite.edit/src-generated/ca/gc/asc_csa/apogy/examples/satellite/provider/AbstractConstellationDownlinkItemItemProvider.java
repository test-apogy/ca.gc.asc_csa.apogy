 ...
 * @generated
 */
public class AbstractConstellationDownlinkItemItemProvider 
	 ...
	 * @generated
	 */
	public AbstractConstellationDownlinkItemItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractConstellationDownlinkItem_request_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractConstellationDownlinkItem_request_feature", "_UI_AbstractConstellationDownlinkItem_type"),
				 ApogyExamplesSatellitePackage.Literals.ABSTRACT_CONSTELLATION_DOWNLINK_ITEM__REQUEST,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApogyExamplesSatellitePackage.Literals.ABSTRACT_CONSTELLATION_DOWNLINK_ITEM__REQUEST_UID);
		}
	...
	public String getText(Object object) {
		return getString("_UI_AbstractConstellationDownlinkItem_type");
	}
