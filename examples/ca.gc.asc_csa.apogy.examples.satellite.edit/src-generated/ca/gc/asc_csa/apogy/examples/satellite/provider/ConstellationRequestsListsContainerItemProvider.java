		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstellationRequestsListsContainer_constellationState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstellationRequestsListsContainer_constellationState_feature", "_UI_ConstellationRequestsListsContainer_type"),
				 ApogyExamplesSatellitePackage.Literals.CONSTELLATION_REQUESTS_LISTS_CONTAINER__CONSTELLATION_STATE,
				 true,
				 false,
				 true,
				 null,
