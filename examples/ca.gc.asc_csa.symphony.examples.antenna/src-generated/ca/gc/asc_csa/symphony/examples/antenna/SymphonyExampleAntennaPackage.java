 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='SymphonyExampleAntenna' copyrightText='Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015' modelName='SymphonyExampleAntenna' childCreationExtenders='true' extensibleProviderFactory='true' suppressGenModelAnnotations='false' modelDirectory='/ca.gc.asc_csa.symphony.examples.antenna/src-generated' editDirectory='/ca.gc.asc_csa.symphony.examples.antenna.edit/src-generated' basePackage='ca.gc.asc_csa.symphony.examples'"
 * @generated
 */
public interface SymphonyExampleAntennaPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "ca.gc.asc_csa.symphony.examples.antenna";
	 ...
	 * @generated
	 */
	SymphonyExampleAntennaPackage eINSTANCE = ca.gc.asc_csa.symphony.examples.antenna.impl.SymphonyExampleAntennaPackageImpl.init();

	/**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaSymphonySystemApiAdapterImpl <em>PTU Dish Antenna Symphony System Api Adapter</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaSymphonySystemApiAdapterImpl
	 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.SymphonyExampleAntennaPackageImpl#getPTUDishAntennaSymphonySystemApiAdapter()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl <em>PTU Dish Antenna Data</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl
	 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.SymphonyExampleAntennaPackageImpl#getPTUDishAntennaData()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaSymphonySystemApiAdapter <em>PTU Dish Antenna Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>PTU Dish Antenna Symphony System Api Adapter</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaSymphonySystemApiAdapter
	 * @generated
	 */
	EClass getPTUDishAntennaSymphonySystemApiAdapter();

	/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData <em>PTU Dish Antenna Data</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>PTU Dish Antenna Data</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData
	 * @generated
	 */
	EClass getPTUDishAntennaData();

	/**
	 * Returns the meta object for the containment reference '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getFov <em>Fov</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Fov</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getFov()
	...
	/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getPanAngle <em>Pan Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Pan Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getPanAngle()
	 * @see #getPTUDishAntennaData()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getTiltAngle <em>Tilt Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Tilt Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getTiltAngle()
	 * @see #getPTUDishAntennaData()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isTrackingSun <em>Tracking Sun</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Tracking Sun</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isTrackingSun()
	 * @see #getPTUDishAntennaData()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isInitialized()
	 * @see #getPTUDishAntennaData()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaSymphonySystemApiAdapterImpl <em>PTU Dish Antenna Symphony System Api Adapter</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaSymphonySystemApiAdapterImpl
		 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.SymphonyExampleAntennaPackageImpl#getPTUDishAntennaSymphonySystemApiAdapter()
		...
		/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl <em>PTU Dish Antenna Data</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl
		 * @see ca.gc.asc_csa.symphony.examples.antenna.impl.SymphonyExampleAntennaPackageImpl#getPTUDishAntennaData()
