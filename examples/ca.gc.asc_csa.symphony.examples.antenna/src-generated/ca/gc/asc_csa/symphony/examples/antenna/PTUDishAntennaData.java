 ...
 * {ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaSymphonySystemApiAdapter})
 * <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getFov <em>Fov</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getPanAngle <em>Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getTiltAngle <em>Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isTrackingSun <em>Tracking Sun</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isInitialized <em>Initialized</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData()
 * @model
 * @generated
 */
public interface PTUDishAntennaData extends SymphonyInitializationData
{
  /**
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData_Fov()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getFov <em>Fov</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData_PanAngle()
	 * @model unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getPanAngle <em>Pan Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData_TiltAngle()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel csa_units='rad' notify='true' property='Editable' propertyCategory='Pan-Tilt Unit'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#getTiltAngle <em>Tilt Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  void setTiltAngle(double value);
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData_TrackingSun()
	...
	boolean isTrackingSun();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isTrackingSun <em>Tracking Sun</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage#getPTUDishAntennaData_Initialized()
	 * @model default="false" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel notify='true' property='Editable' propertyCategory='Status'"
	 * @generated
	 */
	boolean isInitialized();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
