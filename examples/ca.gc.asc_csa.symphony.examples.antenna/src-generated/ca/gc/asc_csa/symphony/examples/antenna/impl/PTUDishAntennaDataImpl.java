 ...
 */
package ca.gc.asc_csa.symphony.examples.antenna.impl;

import ca.gc.asc_csa.symphony.core.impl.SymphonyInitializationDataImpl;
import ca.gc.asc_csa.symphony.examples.antenna.PTUDishAntennaData;
import ca.gc.asc_csa.symphony.examples.antenna.SymphonyExampleAntennaPackage;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl#getFov <em>Fov</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl#getPanAngle <em>Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl#getTiltAngle <em>Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl#isTrackingSun <em>Tracking Sun</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.antenna.impl.PTUDishAntennaDataImpl#isInitialized <em>Initialized</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PTUDishAntennaDataImpl extends SymphonyInitializationDataImpl implements PTUDishAntennaData
{
	...
	{
		return SymphonyExampleAntennaPackage.Literals.PTU_DISH_ANTENNA_DATA;
	}
	...
	public NotificationChain basicSetFov(ConicalFieldOfView newFov, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__FOV, oldFov, newFov);
	...
	public void setFov(ConicalFieldOfView newFov) {
		if (newFov != fov) {
			...
			if (fov != null)
				msgs = ((InternalEObject)fov).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__FOV, null, msgs);
			if (newFov != null)
				msgs = ((InternalEObject)newFov).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__FOV, null, msgs);
			msgs = basicSetFov(newFov, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__FOV, newFov, newFov));
	}
	...
	public void setPanAngle(double newPanAngle)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__PAN_ANGLE, oldPanAngle, panAngle));
	}
	...
	public void setTiltAngle(double newTiltAngle)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__TILT_ANGLE, oldTiltAngle, tiltAngle));
	}
	...
	public void setTrackingSun(boolean newTrackingSun) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__TRACKING_SUN, oldTrackingSun, trackingSun));
	}
	...
	public void setInitialized(boolean newInitialized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleAntennaPackage.PTU_DISH_ANTENNA_DATA__INITIALIZED, oldInitialized, initialized));
	}
