 ...
 * @generated
 */
public class SymphonyExampleAntennaSymphonySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SymphonyExampleAntennaSymphonySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SymphonyExampleAntennaSymphonyPackage.PTU_DISH_ANTENNA_SYMPHONY_SYSTEM_API_ADAPTER: {
			...
			case SymphonyExampleAntennaSymphonyPackage.PTU_DISH_ANTENNA_DATA: {
...
} //SymphonyExampleAntennaSymphonySwitch
