...
import org.eclipse.symphony.examples.antenna.PTUDishAntennaSymphonySystemApiAdapter;
import org.eclipse.symphony.examples.antenna.SymphonyExampleAntennaSymphonyFactory;
 ...
 * @generated
 */
public class SymphonyExampleAntennaSymphonyPackageImpl extends EPackageImpl implements SymphonyExampleAntennaSymphonyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.symphony.examples.antenna.SymphonyExampleAntennaSymphonyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SymphonyExampleAntennaSymphonyPackageImpl() {
		super(eNS_URI, SymphonyExampleAntennaSymphonyFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SymphonyExampleAntennaSymphonyPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SymphonyExampleAntennaSymphonyPackage init() {
		if (isInited) return (SymphonyExampleAntennaSymphonyPackage)EPackage.Registry.INSTANCE.getEPackage(SymphonyExampleAntennaSymphonyPackage.eNS_URI);

		// Obtain or create and register package
		SymphonyExampleAntennaSymphonyPackageImpl theSymphonyExampleAntennaSymphonyPackage = (SymphonyExampleAntennaSymphonyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SymphonyExampleAntennaSymphonyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SymphonyExampleAntennaSymphonyPackageImpl());
		...
		theSymphonyExampleAntennaSymphonyPackage.createPackageContents();

		// Initialize created meta-data
		theSymphonyExampleAntennaSymphonyPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSymphonyExampleAntennaSymphonyPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SymphonyExampleAntennaSymphonyPackage.eNS_URI, theSymphonyExampleAntennaSymphonyPackage);
		return theSymphonyExampleAntennaSymphonyPackage;
	}
	 ...
	 * @generated
	 */
	public SymphonyExampleAntennaSymphonyFactory getSymphonyExampleAntennaSymphonyFactory() {
		return (SymphonyExampleAntennaSymphonyFactory)getEFactoryInstance();
	}
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "SymphonyExampleAntennaSymphony",
			 "copyrightText", "Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015",
			 "modelName", "SymphonyExampleAntennaSymphony",
			 "childCreationExtenders", "true",
			 "extensibleProviderFactory", "true",
			 "suppressGenModelAnnotations", "false",
			 "modelDirectory", "/org.eclipse.symphony.examples.symphony.antenna/src-generated",
			 "editDirectory", "/org.eclipse.symphony.examples.symphony.antenna.edit/src-generated",
...
} //SymphonyExampleAntennaSymphonyPackageImpl
