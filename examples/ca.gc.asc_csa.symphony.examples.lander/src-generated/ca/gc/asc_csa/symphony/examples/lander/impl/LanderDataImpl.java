 ...
 */
package ca.gc.asc_csa.symphony.examples.lander.impl;
...
import ca.gc.asc_csa.symphony.examples.lander.LanderData;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#isDisposed <em>Disposed</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#isFlyingEnabled <em>Flying Enabled</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getLegAExtension <em>Leg AExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getLegBExtension <em>Leg BExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getLegCExtension <em>Leg CExtension</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getCurrThrustLevel <em>Curr Thrust Level</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getMinThrustLevel <em>Min Thrust Level</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getMaxThrustLevel <em>Max Thrust Level</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getXAngularVelocity <em>XAngular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lander.impl.LanderDataImpl#getYAngularVelocity <em>YAngular Velocity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
