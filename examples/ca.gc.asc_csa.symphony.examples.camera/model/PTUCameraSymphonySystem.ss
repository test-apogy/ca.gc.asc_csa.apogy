...
<core:SymphonySystem xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bindings="ca.gc.asc_csa.topology.bindings" xmlns:bindings_1="ca.gc.space.mrt.sensors.fov.bindings" xmlns:ca.gc.space.mrt.sensors.fov="http:///ca/gc/space/mrt/sensors/fov/model/fov.ecore" xmlns:ca.gc.space.topology="http:///ca/gc/space/topology.ecore" xmlns:core="ca.gc.asc_csa.symphony.core" xmlns:ecore="ca.gc.asc_csa.eclipse.emf.ecore" xmlns:ecore_1="http://www.eclipse.org/emf/2002/Ecore" xmi:id="_1LPEwArOEeW4-_ONWXXiAw" name="PTUCameraSymphonySystem">
  <interfaceClass href="ca.gc.asc_csa.eclipse.emf.ecore.examples.camera#//PTUCamera"/>
  <typeApiAdapterClass href="ca.gc.asc_csa.symphony.examples.camera#//PTUCameraSymphonySystemApiAdapter"/>
  <topologyRoot xmi:id="_1LPEwQrOEeW4-_ONWXXiAw">
    <originNode xsi:type="ca.gc.space.topology:AggregateGroupNode" xmi:id="_1LPEwgrOEeW4-_ONWXXiAw" description="The root node of the PTU Camera's topology" nodeId="PTU_CAMERA_SYM_SYS_ROOT">
      <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_1LPEwwrOEeW4-_ONWXXiAw" parent="_1LPEwgrOEeW4-_ONWXXiAw" description="The CAD of the camera base" nodeId="PTU_CAMERA_SYM_SYS_BASE_CAD" url="platform:/plugin/ca.gc.asc_csa.symphony.examples.camera/vrml/base.wrl"/>
      <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LPExArOEeW4-_ONWXXiAw" parent="_1LPEwgrOEeW4-_ONWXXiAw" description="The transform from the camera base to the pan joint" nodeId="PTU_CAMERA_SYM_SYS_BASE_TO_PAN_JOINT">
        <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LPExQrOEeW4-_ONWXXiAw" parent="_1LPExArOEeW4-_ONWXXiAw" description="The rotation of the pan joint" nodeId="PTU_CAMERA_SYM_SYS_PAN_JOINT">
          <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_1LPExgrOEeW4-_ONWXXiAw" parent="_1LPExQrOEeW4-_ONWXXiAw" description="The CAD of the pan joint" nodeId="PTU_CAMERA_SYM_SYS_PAN_JOINT_CAD" url="platform:/plugin/ca.gc.asc_csa.symphony.examples.camera/vrml/pan.wrl"/>
          <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LPExwrOEeW4-_ONWXXiAw" parent="_1LPExQrOEeW4-_ONWXXiAw" description="The transform from the pan joint to the tilt joint" nodeId="PTU_CAMERA_SYM_SYS_PAN_TO_TILT_JOINT">
            <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LPEyArOEeW4-_ONWXXiAw" parent="_1LPExwrOEeW4-_ONWXXiAw" description="The tilt joint rotation" nodeId="PTU_CAMERA_SYM_SYS_TILT_JOINT">
              <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_1LPEyQrOEeW4-_ONWXXiAw" parent="_1LPEyArOEeW4-_ONWXXiAw" description="The CAD of the tilt joint" nodeId="PTU_CAMERA_SYM_SYS_TILT_JOINT_CAD" url="platform:/plugin/ca.gc.asc_csa.symphony.examples.camera/vrml/tilt.wrl"/>
              <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LQS4ArOEeW4-_ONWXXiAw" parent="_1LPEyArOEeW4-_ONWXXiAw" description="The transform from the tilt joint to the camera" nodeId="PTU_CAMERA_SYM_SYS_TILT_JOINT_TO_CAMERA">
                <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_1LQS4QrOEeW4-_ONWXXiAw" parent="_1LQS4ArOEeW4-_ONWXXiAw" description="The CAD of the camera body" nodeId="PTU_CAMERA_SYM_SYS_CAMERA_CAD" url="platform:/plugin/ca.gc.asc_csa.symphony.examples.camera/vrml/camera.wrl"/>
                <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_1LQS4grOEeW4-_ONWXXiAw" parent="_1LQS4ArOEeW4-_ONWXXiAw" description="The transform from the camera proper to the lens (implicitly FOV)" nodeId="PTU_CAMERA_SYM_SYS_LENS">
                  <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_1LQ58ArOEeW4-_ONWXXiAw" parent="_1LQS4grOEeW4-_ONWXXiAw" description="The CAD for the camera lens" nodeId="PTU_CAMERA_SYM_SYS_LENS_CAD" url="platform:/plugin/ca.gc.asc_csa.symphony.examples.camera/vrml/lens.wrl"/>
  ...
  <bindingSet xmi:id="_1LQ6AArOEeW4-_ONWXXiAw">
    <featureRootsList xmi:id="_1LQ6AQrOEeW4-_ONWXXiAw">
      <featureRoots xmi:id="_1LQ6AgrOEeW4-_ONWXXiAw">
        ...
        <sourceClass href="ca.gc.asc_csa.eclipse.emf.ecore.examples.camera#//PTUCamera"/>
      </featureRoots>
    </featureRootsList>
