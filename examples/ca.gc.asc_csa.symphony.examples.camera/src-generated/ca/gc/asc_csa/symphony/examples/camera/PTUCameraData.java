 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getPanAngle <em>Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getTiltAngle <em>Tilt Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.examples.camera.SymphonyExampleCameraPackage#getPTUCameraData()
 * @model
 * @generated
 */
public interface PTUCameraData extends CameraData
{
  /**
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.camera.SymphonyExampleCameraPackage#getPTUCameraData_PanAngle()
	 * @model unique="false"
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getPanAngle <em>Pan Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.camera.SymphonyExampleCameraPackage#getPTUCameraData_TiltAngle()
	 * @model unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel csa_units='\ufffd' notify='true' property='Editable' propertyCategory='PTU Angles'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getTiltAngle <em>Tilt Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
