 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.symphony.examples.camera.SymphonyExampleCameraFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='SymphonyExampleCamera' copyrightText='Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015' modelName='SymphonyExampleCamera' modelDirectory='/ca.gc.asc_csa.symphony.examples.camera/src-generated' editDirectory='/ca.gc.asc_csa.symphony.examples.camera.edit/src-generated' basePackage='ca.gc.asc_csa.symphony.examples'"
 * @generated
 */
public interface SymphonyExampleCameraPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.symphony.examples.camera";
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  SymphonyExampleCameraPackage eINSTANCE = ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl.init();

  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.CameraSymphonySystemApiAdapterImpl <em>Camera Symphony System Api Adapter</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.CameraSymphonySystemApiAdapterImpl
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getCameraSymphonySystemApiAdapter()
	 * @generated
	 */
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.CameraDataImpl <em>Camera Data</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.CameraDataImpl
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getCameraData()
	 * @generated
	 */
  int CAMERA_DATA = 1;
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraSymphonySystemApiAdapterImpl <em>PTU Camera Symphony System Api Adapter</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraSymphonySystemApiAdapterImpl
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getPTUCameraSymphonySystemApiAdapter()
	 * @generated
	 */
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl <em>PTU Camera Data</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl
	 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getPTUCameraData()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.camera.CameraSymphonySystemApiAdapter <em>Camera Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.camera.CameraData <em>Camera Data</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for the containment reference '{@link ca.gc.asc_csa.symphony.examples.camera.CameraData#getFov <em>Fov</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Fov</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.camera.CameraData#getFov()
	 * @see #getCameraData()
	 * @generated
	 */
	EReference getCameraData_Fov();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.camera.CameraData#getZoom <em>Zoom</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Zoom</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.camera.CameraData#getZoom()
	 * @see #getCameraData()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.camera.CameraData#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.camera.CameraData#isInitialized()
	 * @see #getCameraData()
	 * @generated
	 */
	EAttribute getCameraData_Initialized();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraSymphonySystemApiAdapter <em>PTU Camera Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData <em>PTU Camera Data</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getPanAngle <em>Pan Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Pan Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getPanAngle()
	...
	EAttribute getPTUCameraData_PanAngle();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getTiltAngle <em>Tilt Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Tilt Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.camera.PTUCameraData#getTiltAngle()
	 * @see #getPTUCameraData()
	 * @generated
	 */
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.CameraSymphonySystemApiAdapterImpl <em>Camera Symphony System Api Adapter</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.CameraSymphonySystemApiAdapterImpl
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getCameraSymphonySystemApiAdapter()
    ...
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.CameraDataImpl <em>Camera Data</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.CameraDataImpl
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getCameraData()
    ...
    /**
		...
		EAttribute CAMERA_DATA__INITIALIZED = eINSTANCE.getCameraData_Initialized();
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraSymphonySystemApiAdapterImpl <em>PTU Camera Symphony System Api Adapter</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraSymphonySystemApiAdapterImpl
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getPTUCameraSymphonySystemApiAdapter()
    ...
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl <em>PTU Camera Data</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl
		 * @see ca.gc.asc_csa.symphony.examples.camera.impl.SymphonyExampleCameraPackageImpl#getPTUCameraData()
