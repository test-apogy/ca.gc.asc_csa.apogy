 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl#getPanAngle <em>Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.camera.impl.PTUCameraDataImpl#getTiltAngle <em>Tilt Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PTUCameraDataImpl extends CameraDataImpl implements PTUCameraData
{
	...
	{
		return SymphonyExampleCameraPackage.Literals.PTU_CAMERA_DATA;
	}
	...
	public void setPanAngle(double newPanAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleCameraPackage.PTU_CAMERA_DATA__PAN_ANGLE, oldPanAngle, panAngle));
	}
	...
	public void setTiltAngle(double newTiltAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SymphonyExampleCameraPackage.PTU_CAMERA_DATA__TILT_ANGLE, oldTiltAngle, tiltAngle));
	}
