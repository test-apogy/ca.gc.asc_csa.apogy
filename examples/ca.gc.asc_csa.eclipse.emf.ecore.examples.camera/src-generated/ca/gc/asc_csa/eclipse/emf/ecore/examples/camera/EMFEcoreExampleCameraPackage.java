 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.EMFEcoreExampleCameraFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='EMFEcoreExampleCamera' copyrightText='Canadian Space Agency / Agence spatiale canadienne - Copyright (c) 2015' modelName='EMFEcoreExampleCamera' childCreationExtenders='true' extensibleProviderFactory='true' suppressGenModelAnnotations='false' modelDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.camera/src-generated' editDirectory='/ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.edit/src-generated' basePackage='ca.gc.asc_csa.eclipse.emf.ecore.examples'"
 * @generated
 */
public interface EMFEcoreExampleCameraPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.eclipse.emf.ecore.examples.camera";
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  EMFEcoreExampleCameraPackage eINSTANCE = ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl.init();
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl <em>Camera</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCamera()
	 * @generated
	 */
  int CAMERA = 0;
  /**
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraStubImpl <em>Camera Stub</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraStubImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCameraStub()
	 * @generated
	 */
	int CAMERA_STUB = 1;
		/**
	...
	int CAMERA_STUB_OPERATION_COUNT = CAMERA_OPERATION_COUNT + 0;
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraSimulatedImpl <em>Camera Simulated</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraSimulatedImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCameraSimulated()
	 * @generated
	 */
	...
	int CAMERA_SIMULATED_OPERATION_COUNT = CAMERA_OPERATION_COUNT + 0;
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl <em>PTU Camera</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCamera()
	 * @generated
	 */
  int PTU_CAMERA = 3;
  /**
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl <em>PTU Camera Stub</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCameraStub()
	 * @generated
	 */
	...
	int PTU_CAMERA_STUB_OPERATION_COUNT = CAMERA_STUB_OPERATION_COUNT + 11;
		/**
	 * The meta object id for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraSimulatedImpl <em>PTU Camera Simulated</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraSimulatedImpl
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCameraSimulated()
	 * @generated
	 */
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getThrowable()
	 * @generated
	 */
  int THROWABLE = 6;

  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera <em>Camera</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for the containment reference '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#getFov <em>Fov</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Fov</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#getFov()
	 * @see #getCamera()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#isInitialized()
	 * @see #getCamera()
	 * @generated
	 */
	EAttribute getCamera_Initialized();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#isStreamingEnabled <em>Streaming Enabled</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Streaming Enabled</em>'.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#isStreamingEnabled()
	 * @see #getCamera()
	 * @generated
	 */
	EAttribute getCamera_StreamingEnabled();
		...
		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#init() <em>Init</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Init</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#init()
	 * @generated
	 */
	EOperation getCamera__Init();

		/**
	 * Returns the meta object for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#commandStreaming(boolean) <em>Command Streaming</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Command Streaming</em>' operation.
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.Camera#commandStreaming(boolean)
	 * @generated
	 */
	EOperation getCamera__CommandStreaming__boolean();

		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.CameraStub <em>Camera Stub</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getCameraStub();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.CameraSimulated <em>Camera Simulated</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getCameraSimulated();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.PTUCamera <em>PTU Camera</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.PTUCameraStub <em>PTU Camera Stub</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getPTUCameraStub();
		...
		/**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.PTUCameraSimulated <em>PTU Camera Simulated</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl <em>Camera</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCamera()
    ...
    /**
		...
		EOperation CAMERA___COMMAND_STREAMING__BOOLEAN = eINSTANCE.getCamera__CommandStreaming__boolean();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraStubImpl <em>Camera Stub</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraStubImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCameraStub()
		...
		EClass CAMERA_STUB = eINSTANCE.getCameraStub();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraSimulatedImpl <em>Camera Simulated</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraSimulatedImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getCameraSimulated()
		...
		EClass CAMERA_SIMULATED = eINSTANCE.getCameraSimulated();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl <em>PTU Camera</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCamera()
    ...
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl <em>PTU Camera Stub</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCameraStub()
		...
		EClass PTU_CAMERA_STUB = eINSTANCE.getPTUCameraStub();
				...
				/**
		 * The meta object literal for the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraSimulatedImpl <em>PTU Camera Simulated</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraSimulatedImpl
		 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.EMFEcoreExampleCameraPackageImpl#getPTUCameraSimulated()
