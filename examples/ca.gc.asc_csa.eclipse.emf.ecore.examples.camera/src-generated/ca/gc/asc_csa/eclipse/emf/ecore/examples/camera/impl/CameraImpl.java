 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl#getCurrentZoom <em>Current Zoom</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl#getCommandedZoom <em>Commanded Zoom</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl#getFov <em>Fov</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.CameraImpl#isStreamingEnabled <em>Streaming Enabled</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
