...
import ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.PTUCameraStub;
 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#isMoving <em>Moving</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#getActuatorStatus <em>Actuator Status</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#getCurrentPanAngle <em>Current Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#getCurrentTiltAngle <em>Current Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#getCommandedPanAngle <em>Commanded Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraStubImpl#getCommandedTiltAngle <em>Commanded Tilt Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
