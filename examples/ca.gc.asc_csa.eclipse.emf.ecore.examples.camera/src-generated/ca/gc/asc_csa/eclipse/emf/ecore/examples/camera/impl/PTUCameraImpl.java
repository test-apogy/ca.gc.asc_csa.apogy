 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#isMoving <em>Moving</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#getActuatorStatus <em>Actuator Status</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#getCurrentPanAngle <em>Current Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#getCurrentTiltAngle <em>Current Tilt Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#getCommandedPanAngle <em>Commanded Pan Angle</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.camera.impl.PTUCameraImpl#getCommandedTiltAngle <em>Commanded Tilt Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
