...
<core:SymphonySystem xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bindings="org.eclipse.symphony.common.topology.bindings" xmlns:org.eclipse.symphony.common.topology="http:///ca/gc/space/topology.ecore" xmlns:core="org.eclipse.symphony.core" xmlns:ecore="org.eclipse.symphony.common.emf" xmlns:ecore_1="http://www.eclipse.org/emf/2002/Ecore" xmlns:vehicle="org.eclipse.symphony.addons.vehicle" xmi:id="_aD78wArNEeW4-_ONWXXiAw" name="MobilePlatformSymphonySystem">
  ...
  <topologyRoot xmi:id="_aD78wQrNEeW4-_ONWXXiAw">
    <originNode xsi:type="org.eclipse.symphony.common.topology:AggregateGroupNode" xmi:id="_aD78wgrNEeW4-_ONWXXiAw" description="The root node of the mobile platform's topology" nodeId="MOBILE_PLATFORM_SYM_SYS_ROOT">
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD78wwrNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transform to get from the root to the right front wheel axle" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_FRONT_WHEEL_AXLE">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD78xArNEeW4-_ONWXXiAw" parent="_aD78wwrNEeW4-_ONWXXiAw" description="The required transformation to get from the mobile platform's front right wheel axle to its respective wheel joint" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_FRONT_WHEEL_JOINT">
          <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD78xQrNEeW4-_ONWXXiAw" parent="_aD78xArNEeW4-_ONWXXiAw" description="The required transformation to get from the right front wheel joint to the its respective CAD" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_FRONT_WHEEL_CAD_TRANSFORM">
            <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_aD78xgrNEeW4-_ONWXXiAw" parent="_aD78xQrNEeW4-_ONWXXiAw" description="The CAD for the right front wheel" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_FRONT_WHEEL_CAD" url="platform:/plugin/org.eclipse.symphony.examples.mobile_platform.symphony/vrml/CSA_Wheel_Symphony_Scaled.wrl"/>
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j1wrNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the mobile platform's left front wheel axle" nodeId="MOBILE_PLATFORM_SYM_SYS_LEFT_FRONT_WHEEL_AXLE">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j2ArNEeW4-_ONWXXiAw" parent="_aD8j1wrNEeW4-_ONWXXiAw" description="The required transformation to get from the mobile platform's left front wheel axle to its respective wheel joint" nodeId="MOBILE_PLATFORM_SYM_SYS_LEFT_FRONT_WHEEL_JOINT">
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j4wrNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the right rear wheel axle" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_REAR_WHEEL_AXLE">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j5ArNEeW4-_ONWXXiAw" parent="_aD8j4wrNEeW4-_ONWXXiAw" description="The required transformation to get from the right rear wheel's axle to its respective wheel joint" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_REAR_WHEEL_JOINT">
          <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j5QrNEeW4-_ONWXXiAw" parent="_aD8j5ArNEeW4-_ONWXXiAw" description="The required transformation to get from the right rear wheel joint to its respective CAD" nodeId="MOBILE_PLATFORM_SYM_SYS_RIGHT_REAR_WHEEL_CAD_TRANSFORM">
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j8grNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to go from the root to the left rear wheel axle" nodeId="MOBILE_PLATFORM_SYM_SYS_LEFT_REAR_WHEEL_AXLE">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j8wrNEeW4-_ONWXXiAw" parent="_aD8j8grNEeW4-_ONWXXiAw" description="The required transformation to go from the left rear wheel axle to its respective wheel joint" nodeId="MOBILE_PLATFORM_SYM_SYS_LEFT_REAR_WHEEL_JOINT">
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD8j_grNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The transformation required to go from the root node to the body's CAD" nodeId="MOBILE_PLATFORM_SYM_SYS_BODY_CAD_TRANSFORM">
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD9K4wrNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the arm mounting position" nodeId="MOBILE_PLATFORM_SYM_SYS_ARM_MOUNT">
        <position xmi:id="_aD9K5ArNEeW4-_ONWXXiAw" x="0.85" y="0.3" z="0.7"/>
        <rotationMatrix xmi:id="_aD9K5QrNEeW4-_ONWXXiAw"/>
      </aggregatedChildren>
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD9K5grNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the mast centre plate location" nodeId="MOBILE_PLATFORM_SYM_SYS_MAST_CENTRE_PLATE">
        <position xmi:id="_aD9K5wrNEeW4-_ONWXXiAw" x="-0.5" z="1.625"/>
        <rotationMatrix xmi:id="_aD9K6ArNEeW4-_ONWXXiAw"/>
      </aggregatedChildren>
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD9K6QrNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the mast left flat location" nodeId="MOBILE_PLATFORM_SYM_SYS_MAST_LEFT_FLAT">
        <position xmi:id="_aD9K6grNEeW4-_ONWXXiAw" x="-0.5" y="0.6" z="1.6"/>
        <rotationMatrix xmi:id="_aD9K6wrNEeW4-_ONWXXiAw"/>
      </aggregatedChildren>
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_aD9K7ArNEeW4-_ONWXXiAw" parent="_aD78wgrNEeW4-_ONWXXiAw" description="The required transformation to get from the root to the mast right flat location" nodeId="MOBILE_PLATFORM_SYM_SYS_MAST_RIGHT_FLAT">
