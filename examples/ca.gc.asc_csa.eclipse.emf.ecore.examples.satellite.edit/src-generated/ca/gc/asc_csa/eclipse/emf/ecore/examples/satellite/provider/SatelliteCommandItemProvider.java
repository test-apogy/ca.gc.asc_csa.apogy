...
/**
 * This is the item provider adapter for a {@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteCommand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SatelliteCommandItemProvider 
	 ...
	 * @generated
	 */
	public SatelliteCommandItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCommandStartTimePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Command Start Time feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCommandStartTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	/**
	 * This returns SatelliteCommand.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SatelliteCommand"));
	}
	...
	public String getText(Object object) {
		Date labelValue = ((SatelliteCommand)object).getCommandStartTime();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_SatelliteCommand_type") :
			getString("_UI_SatelliteCommand_type") + " " + label;
	}
