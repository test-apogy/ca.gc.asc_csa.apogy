 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.eclipse.symphony.examples.lander.symphony.Symphony__ExamplesLanderSymphonyFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='Symphony__ExamplesLanderSymphony' copyrightText='Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015' modelName='Symphony__ExamplesLanderSymphony' modelDirectory='/org.eclipse.symphony.examples.lander.symphony/src-generated' editDirectory='/org.eclipse.symphony.examples.lander.symphony.edit/src-generated' basePackage='org.eclipse.symphony.examples.lander'"
 * @generated
 */
public interface Symphony__ExamplesLanderSymphonyPackage extends EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	Symphony__ExamplesLanderSymphonyPackage eINSTANCE = org.eclipse.symphony.examples.lander.symphony.impl.Symphony__ExamplesLanderSymphonyPackageImpl.init();
	 ...
	 * @see org.eclipse.symphony.examples.lander.symphony.impl.Symphony__ExamplesLanderSymphonyPackageImpl#getLanderSymphonySystemApiAdapter()
	 * @generated
	 */
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__ENVIRONMENT = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__ENVIRONMENT;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__INSTANCE = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__INSTANCE;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__ELEMENT_TYPE = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__ELEMENT_TYPE;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__POSE_TRANSFORM = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__POSE_TRANSFORM;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__POSE_CORRECTOR = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__POSE_CORRECTOR;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER__SYMPHONY_SYSTEM = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER__SYMPHONY_SYSTEM;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER_FEATURE_COUNT = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___INIT__ENVIRONMENT_TYPE_EOBJECT = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___INIT__ENVIRONMENT_TYPE_EOBJECT;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___APPLY__ABSTRACTINITIALIZATIONDATA = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___APPLY__ABSTRACTINITIALIZATIONDATA;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___CREATE_INITIALIZATION_DATA = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___CREATE_INITIALIZATION_DATA;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___COLLECT__ABSTRACTINITIALIZATIONDATA = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___COLLECT__ABSTRACTINITIALIZATIONDATA;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL_LONG_OBJECT_EXCEPTION = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL_LONG_OBJECT_EXCEPTION;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___INVOKE__EOBJECT_OPERATIONCALL_BOOLEAN = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___INVOKE__EOBJECT_OPERATIONCALL_BOOLEAN;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___DISPOSE = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___DISPOSE;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT_MATRIX__OPERATIONCALL = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT_MATRIX__OPERATIONCALL;
	 ...
	 * @ordered
	 */
	int LANDER_SYMPHONY_SYSTEM_API_ADAPTER_OPERATION_COUNT = Symphony__CorePackage.SYMPHONY_SYSTEM_API_ADAPTER_OPERATION_COUNT + 0;
	 ...
	 * @see org.eclipse.symphony.examples.lander.symphony.impl.Symphony__ExamplesLanderSymphonyPackageImpl#getLanderData()
	 * @generated
	 */
	int LANDER_DATA = 1;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__INITIAL_POSE_TRANSFORM = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA__INITIAL_POSE_TRANSFORM;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__INITIALIZED = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__DISPOSED = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__FLYING_ENABLED = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__LEG_AEXTENSION = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__LEG_BEXTENSION = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__LEG_CEXTENSION = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__CURR_THRUST_LEVEL = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__MIN_THRUST_LEVEL = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__MAX_THRUST_LEVEL = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__XANGULAR_VELOCITY = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int LANDER_DATA__YANGULAR_VELOCITY = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int LANDER_DATA_FEATURE_COUNT = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int LANDER_DATA_OPERATION_COUNT = Symphony__CorePackage.SYMPHONY_INITIALIZATION_DATA_OPERATION_COUNT + 0;
	 ...
	 * @generated
	 */
	Symphony__ExamplesLanderSymphonyFactory getSymphony__ExamplesLanderSymphonyFactory();
...
} //Symphony__ExamplesLanderSymphonyPackage
