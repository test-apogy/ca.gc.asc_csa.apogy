 ...
 * {@link ca.gc.asc_csa.symphony.examples.lidar.LidarSymphonySystemApiAdapter})
 * <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lidar.LidarData#getFov <em>Fov</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.lidar.LidarData#isInitialized <em>Initialized</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.examples.lidar.SymphonyExampleLidarPackage#getLidarData()
 * @model
 * @generated
 */
public interface LidarData extends SymphonyInitializationData {
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.lidar.SymphonyExampleLidarPackage#getLidarData_Fov()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.lidar.LidarData#getFov <em>Fov</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.lidar.SymphonyExampleLidarPackage#getLidarData_Initialized()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.lidar.LidarData#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
