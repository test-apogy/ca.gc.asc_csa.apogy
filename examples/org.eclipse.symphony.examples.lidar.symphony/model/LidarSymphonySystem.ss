...
<core:SymphonySystem xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bindings="ca.gc.space.mrt.sensors.fov.bindings" xmlns:ca.gc.space.mrt.sensors.fov="http:///ca/gc/space/mrt/sensors/fov/model/fov.ecore" xmlns:ca.gc.space.topology="http:///ca/gc/space/topology.ecore" xmlns:core="org.eclipse.symphony.core" xmlns:ecore="ca.gc.asc_csa.eclipse.emf.ecore" xmlns:ecore_1="http://www.eclipse.org/emf/2002/Ecore" xmi:id="_9z1SQArOEeW4-_ONWXXiAw" name="LidarSymphonySystem">
  ...
  <topologyRoot xmi:id="_9z1SQQrOEeW4-_ONWXXiAw">
    <originNode xsi:type="ca.gc.space.topology:AggregateGroupNode" xmi:id="_9z1SQgrOEeW4-_ONWXXiAw" description="The root node of the topology for the Lidar unit" nodeId="LIDAR_SYM_SYS_ROOT">
      <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_9z1SQwrOEeW4-_ONWXXiAw" parent="_9z1SQgrOEeW4-_ONWXXiAw" description="The transformation required to change from the root to the one suitable for the lidar's CAD" nodeId="LIDAR_SYM_SYS_CAD_TRANSFORM">
        <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_9z1SRArOEeW4-_ONWXXiAw" parent="_9z1SQwrOEeW4-_ONWXXiAw" description="The CAD for the root of the Lidar unit" nodeId="LIDAR_SYM_SYS_CAD" url="platform:/plugin/org.eclipse.symphony.examples.lidar.symphony/vrml/lidar.wrl"/>
        <aggregatedChildren xsi:type="ca.gc.space.topology:TransformNode" xmi:id="_9z1SRQrOEeW4-_ONWXXiAw" parent="_9z1SQwrOEeW4-_ONWXXiAw" description="The transformation required to " nodeId="LIDAR_SYM_SYS_LENS_CAD_TRANSFORM">
          ...
          <aggregatedChildren xsi:type="ca.gc.space.topology:URLNode" xmi:id="_9z1SSQrOEeW4-_ONWXXiAw" parent="_9z1SRQrOEeW4-_ONWXXiAw" nodeId="LIDAR_LENS_CAD" url="platform:/plugin/org.eclipse.symphony.examples.lidar.symphony/vrml/lens.wrl"/>
