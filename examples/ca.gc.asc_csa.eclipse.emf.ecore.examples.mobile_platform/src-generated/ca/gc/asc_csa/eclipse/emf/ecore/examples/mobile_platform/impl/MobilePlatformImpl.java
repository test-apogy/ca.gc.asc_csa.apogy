 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#isDisposed <em>Disposed</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getPositionError <em>Position Error</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getLinearVelocity <em>Linear Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getAngularVelocity <em>Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getLeftWheelPosition <em>Left Wheel Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getRightWheelPosition <em>Right Wheel Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.impl.MobilePlatformImpl#getPosition <em>Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
