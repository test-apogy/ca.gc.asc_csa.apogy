...
import ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatformSimulated;
import ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatformStub;
import ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.NamedPosition;
 ...
 * @generated
 */
public class EMFEcoreExampleMobilePlatformPackageImpl extends EPackageImpl implements EMFEcoreExampleMobilePlatformPackage
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
  private EMFEcoreExampleMobilePlatformPackageImpl()
  {
		super(eNS_URI, EMFEcoreExampleMobilePlatformFactory.eINSTANCE);
	}
  ...
  /**
	 ...
	 * 
	 * <p>This method is used to initialize {@link EMFEcoreExampleMobilePlatformPackage#eINSTANCE} when that field is accessed.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static EMFEcoreExampleMobilePlatformPackage init()
  {
		if (isInited) return (EMFEcoreExampleMobilePlatformPackage)EPackage.Registry.INSTANCE.getEPackage(EMFEcoreExampleMobilePlatformPackage.eNS_URI);

		// Obtain or create and register package
		EMFEcoreExampleMobilePlatformPackageImpl theEMFEcoreExampleMobilePlatformPackage = (EMFEcoreExampleMobilePlatformPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EMFEcoreExampleMobilePlatformPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EMFEcoreExampleMobilePlatformPackageImpl());
		...
		theEMFEcoreExampleMobilePlatformPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEMFEcoreExampleMobilePlatformPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EMFEcoreExampleMobilePlatformPackage.eNS_URI, theEMFEcoreExampleMobilePlatformPackage);
		return theEMFEcoreExampleMobilePlatformPackage;
	}
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreExampleMobilePlatformFactory getEMFEcoreExampleMobilePlatformFactory()
  {
		return (EMFEcoreExampleMobilePlatformFactory)getEFactoryInstance();
	}
  ...
  protected void createGenModelAnnotations()
  {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "prefix", "EMFEcoreExampleMobilePlatform",
			 ...
			 "modelDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform/src-generated",
			 "editDirectory", "/ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.edit/src-generated",
...
} //EMFEcoreExampleMobilePlatformPackageImpl
