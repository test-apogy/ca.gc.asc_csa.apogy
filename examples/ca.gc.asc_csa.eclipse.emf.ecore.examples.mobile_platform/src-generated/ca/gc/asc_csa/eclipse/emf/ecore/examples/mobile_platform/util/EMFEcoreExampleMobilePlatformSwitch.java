 ...
 * @generated
 */
public class EMFEcoreExampleMobilePlatformSwitch<T> extends Switch<T>
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EMFEcoreExampleMobilePlatformSwitch()
  {
  ...
  {
		switch (classifierID) {
			case EMFEcoreExampleMobilePlatformPackage.POSITION: {
				Position position = (Position)theEObject;
				T result = casePosition(position);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EMFEcoreExampleMobilePlatformPackage.NAMED_POSITION: {
			...
			case EMFEcoreExampleMobilePlatformPackage.MOBILE_PLATFORM: {
			...
			case EMFEcoreExampleMobilePlatformPackage.MOBILE_PLATFORM_STUB: {
			...
			case EMFEcoreExampleMobilePlatformPackage.MOBILE_PLATFORM_SIMULATED: {
...
} //EMFEcoreExampleMobilePlatformSwitch
