 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#isDisposed <em>Disposed</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getPositionError <em>Position Error</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getLinearVelocity <em>Linear Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getAngularVelocity <em>Angular Velocity</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getLeftWheelPosition <em>Left Wheel Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getRightWheelPosition <em>Right Wheel Position</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getPosition <em>Position</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform()
 * @model abstract="true"
 * @generated
 */
public interface MobilePlatform extends Disposable
{
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_Initialized()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_Disposed()
	 * @model default="false" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' property='Readonly' propertyCategory='Status'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#isDisposed <em>Disposed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_Position()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getPosition <em>Position</em>}' reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_PositionError()
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getPositionError <em>Position Error</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_LinearVelocity()
	 * @model default="0.0" unique="false"
	...
	double getLinearVelocity();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getLinearVelocity <em>Linear Velocity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_AngularVelocity()
	 * @model default="0.0" unique="false"
	...
	double getAngularVelocity();
		...
		/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getAngularVelocity <em>Angular Velocity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_LeftWheelPosition()
	 * @model default="0.0" unique="false"
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getLeftWheelPosition <em>Left Wheel Position</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.EMFEcoreExampleMobilePlatformPackage#getMobilePlatform_RightWheelPosition()
	 * @model default="0.0" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Readonly' propertyCategory='Position' csa_units='rad'"
	 * @generated
	 */
  ...
  /**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.mobile_platform.MobilePlatform#getRightWheelPosition <em>Right Wheel Position</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
