 ...
 */
package ca.gc.asc_csa.symphony.examples.robotic_arm.util;
 ...
 * @generated
 */
public class SymphonyExampleRoboticArmAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public SymphonyExampleRoboticArmAdapterFactory()
  {
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected SymphonyExampleRoboticArmSwitch<Adapter> modelSwitch =
    new SymphonyExampleRoboticArmSwitch<Adapter>() {
			@Override
			public Adapter caseRoboticArmSymphonySystemApiAdapter(RoboticArmSymphonySystemApiAdapter object) {
				return createRoboticArmSymphonySystemApiAdapterAdapter();
			}
			@Override
			public Adapter caseRoboticArmData(RoboticArmData object) {
				return createRoboticArmDataAdapter();
			}
			@Override
  ...
  /**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmSymphonySystemApiAdapter <em>Robotic Arm Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
  ...
  /**
	 * Creates a new adapter for an object of class '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData <em>Robotic Arm Data</em>}'.
	 * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public Adapter createRoboticArmDataAdapter()
  {
		return null;
	}
...
} //SymphonyExampleRoboticArmAdapterFactory
