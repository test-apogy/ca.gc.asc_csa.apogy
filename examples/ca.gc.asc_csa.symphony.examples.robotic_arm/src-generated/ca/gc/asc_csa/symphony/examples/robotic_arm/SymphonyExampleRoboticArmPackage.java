 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.SymphonyExampleRoboticArmFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel prefix='SymphonyExampleRoboticArm' copyrightText='Canadian Space Agency / Agence spatiale canadienne Copyright (c) 2015' modelName='SymphonyExampleRoboticArm' modelDirectory='/ca.gc.asc_csa.symphony.examples.robotic_arm/src-generated' editDirectory='/ca.gc.asc_csa.symphony.examples.robotic_arm.edit/src-generated' basePackage='ca.gc.asc_csa.symphony.examples'"
 * @generated
 */
public interface SymphonyExampleRoboticArmPackage extends EPackage
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  String eNS_URI = "ca.gc.asc_csa.symphony.examples.robotic_arm";
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  SymphonyExampleRoboticArmPackage eINSTANCE = ca.gc.asc_csa.symphony.examples.robotic_arm.impl.SymphonyExampleRoboticArmPackageImpl.init();

  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmSymphonySystemApiAdapterImpl <em>Robotic Arm Symphony System Api Adapter</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmSymphonySystemApiAdapterImpl
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.SymphonyExampleRoboticArmPackageImpl#getRoboticArmSymphonySystemApiAdapter()
	 * @generated
	 */
  ...
  /**
	 ...
	 * @ordered
	 */
	int ROBOTIC_ARM_SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL_LONG_OBJECT_EXCEPTION = SymphonyCorePackage.SYMPHONY_SYSTEM_API_ADAPTER___CREATE_RESULT__OPERATIONCALL_LONG_OBJECT_EXCEPTION;
  ...
  /**
	 * The meta object id for the '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmDataImpl <em>Robotic Arm Data</em>}' class.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmDataImpl
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.SymphonyExampleRoboticArmPackageImpl#getRoboticArmData()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmSymphonySystemApiAdapter <em>Robotic Arm Symphony System Api Adapter</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Robotic Arm Symphony System Api Adapter</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmSymphonySystemApiAdapter
	 * @generated
	 */
  EClass getRoboticArmSymphonySystemApiAdapter();

  /**
	 * Returns the meta object for class '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData <em>Robotic Arm Data</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Robotic Arm Data</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData
	 * @generated
	 */
  EClass getRoboticArmData();

  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#isInitialized <em>Initialized</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Initialized</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#isInitialized()
	...
	EAttribute getRoboticArmData_Initialized();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getSpeed <em>Speed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Speed</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getSpeed()
	 * @see #getRoboticArmData()
	 * @generated
	 */
	EAttribute getRoboticArmData_Speed();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getTurretAngle <em>Turret Angle</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Turret Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getTurretAngle()
	 * @see #getRoboticArmData()
	 * @generated
	 */
	EAttribute getRoboticArmData_TurretAngle();
		...
		/**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getShoulderAngle <em>Shoulder Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Shoulder Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getShoulderAngle()
	 * @see #getRoboticArmData()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getElbowAngle <em>Elbow Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Elbow Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getElbowAngle()
	 * @see #getRoboticArmData()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the attribute '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getWristAngle <em>Wrist Angle</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Wrist Angle</em>'.
	 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.RoboticArmData#getWristAngle()
	 * @see #getRoboticArmData()
	 * @generated
	 */
  ...
  {
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmSymphonySystemApiAdapterImpl <em>Robotic Arm Symphony System Api Adapter</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmSymphonySystemApiAdapterImpl
		 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.SymphonyExampleRoboticArmPackageImpl#getRoboticArmSymphonySystemApiAdapter()
    ...
    /**
		 * The meta object literal for the '{@link ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmDataImpl <em>Robotic Arm Data</em>}' class.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.RoboticArmDataImpl
		 * @see ca.gc.asc_csa.symphony.examples.robotic_arm.impl.SymphonyExampleRoboticArmPackageImpl#getRoboticArmData()
