 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getSatellites <em>Satellites</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getGroundStations <em>Ground Stations</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getPendingImageOrders <em>Pending Image Orders</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getEndDate <em>End Date</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation()
 * @model
 * @generated
 */
public interface SatelliteConstellation extends EObject {
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.Satellite}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation_Satellites()
	 * @model required="true"
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation_GroundStations()
	 * @model required="true"
	 ...
	 * The list contents are of type {@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.ImageOrder}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation_PendingImageOrders()
	 ...
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation_StartDate()
	 * @model unique="false"
	 * @generated
	 */
	Date getStartDate();
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getStartDate <em>Start Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEndDate(Date)
	 * @see ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.EMFEcoreExampleSatellitePackage#getSatelliteConstellation_EndDate()
	 * @model unique="false"
	 * @generated
	 */
	Date getEndDate();
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SatelliteConstellation#getEndDate <em>End Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SortedSet<ca.gc.asc_csa.symphony.environment.orbit.earth.VisibilityPass>" unique="false" exceptions="ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.Exception" imageOrderUnique="false" startDateUnique="false" endDateUnique="false" elevationMaskUnique="false"
	 * @generated
	 */
	 ...
	 * @return The list of Visibility passes, ordered by start time.
	 * <!-- end-model-doc -->
	 * @model dataType="ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.SortedSet<ca.gc.asc_csa.symphony.environment.orbit.earth.VisibilityPass>" unique="false" exceptions="ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.Exception" satelliteUnique="false" startDateUnique="false" endDateUnique="false" elevationMaskUnique="false"
	 * @generated
	 */
	 ...
	 * <!-- end-model-doc -->
	 * @model unique="false" imageOrdersDataType="ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.List<ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.ImageOrder>" imageOrdersUnique="false" imageOrdersMany="false" startDateUnique="false" endDateUnique="false"
	 * @generated
	 */
