 ...
 * <ul>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.impl.SatelliteConstellationImpl#getSatellites <em>Satellites</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.impl.SatelliteConstellationImpl#getGroundStations <em>Ground Stations</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.impl.SatelliteConstellationImpl#getPendingImageOrders <em>Pending Image Orders</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.impl.SatelliteConstellationImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link ca.gc.asc_csa.eclipse.emf.ecore.examples.satellite.impl.SatelliteConstellationImpl#getEndDate <em>End Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
