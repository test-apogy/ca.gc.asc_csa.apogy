 ...
 * API adapter,
 * which is {@link ca.gc.asc_csa.symphony.examples.rover.RoverSymphonySystemApiAdapter}.
 * <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.rover.RoverData#isInitialized <em>Initialized</em>}</li>
 *   <li>{@link ca.gc.asc_csa.symphony.examples.rover.RoverData#isDisposed <em>Disposed</em>}</li>
 * </ul>
 * </p>
 *
 * @see ca.gc.asc_csa.symphony.examples.rover.SymphonyExampleRoverPackage#getRoverData()
 * @model
 * @generated
 */
public interface RoverData extends SymphonyInitializationData {
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.rover.SymphonyExampleRoverPackage#getRoverData_Initialized()
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.rover.RoverData#isInitialized <em>Initialized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.gc.asc_csa.symphony.examples.rover.SymphonyExampleRoverPackage#getRoverData_Disposed()
	 * @model default="false" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel children='false' notify='true' property='Editable' propertyCategory='Status'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.gc.asc_csa.symphony.examples.rover.RoverData#isDisposed <em>Disposed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
