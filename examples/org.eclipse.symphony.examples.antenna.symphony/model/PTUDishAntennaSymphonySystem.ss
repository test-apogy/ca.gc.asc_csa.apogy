...
<core:SymphonySystem xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bindings="org.eclipse.symphony.common.topology.bindings" xmlns:org.eclipse.symphony.addons.sensors.fov="http:///ca/gc/space/mrt/sensors/fov/model/fov.ecore" xmlns:org.eclipse.symphony.common.topology="http:///ca/gc/space/topology.ecore" xmlns:core="org.eclipse.symphony.core" xmlns:ecore="org.eclipse.symphony.common.emf" xmlns:ecore_1="http://www.eclipse.org/emf/2002/Ecore" xmi:id="_sUcqQArOEeW4-_ONWXXiAw" name="PTUDishAntennaSymphonySystem">
  ...
  <topologyRoot xmi:id="_sUcqQQrOEeW4-_ONWXXiAw">
    <originNode xsi:type="org.eclipse.symphony.common.topology:AggregateGroupNode" xmi:id="_sUcqQgrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_ROOT">
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_sUcqQwrOEeW4-_ONWXXiAw" parent="_sUcqQgrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_BASE_TO_PAN">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_sUcqRArOEeW4-_ONWXXiAw" parent="_sUcqQwrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_PAN_JOINT">
          <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_sUcqRQrOEeW4-_ONWXXiAw" parent="_sUcqRArOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_PAN_TO_TILT">
            <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_sUcqRgrOEeW4-_ONWXXiAw" parent="_sUcqRQrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_TILT_JOINT">
              ...
              <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_sUdRVQrOEeW4-_ONWXXiAw" parent="_sUcqRgrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_PAN_TILT_CAD" url="platform:/plugin/org.eclipse.symphony.examples.antenna.symphony/vrml/Gimbal_middle_Scaled.wrl"/>
              <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_sUdRVgrOEeW4-_ONWXXiAw" parent="_sUcqRgrOEeW4-_ONWXXiAw" description="" nodeId="PTU_DISH_ANTENNA_SYM_SYS_CAD_TRANSFORM">
                <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_sUdRVwrOEeW4-_ONWXXiAw" parent="_sUdRVgrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_DISH_CAD" url="platform:/plugin/org.eclipse.symphony.examples.antenna.symphony/vrml/Dish12in_Scaled.wrl"/>
          ...
          <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_sUdRXgrOEeW4-_ONWXXiAw" parent="_sUcqRArOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_BASE_CAD" url="platform:/plugin/org.eclipse.symphony.examples.antenna.symphony/vrml/Gimbal_Base_Scaled.wrl"/>
      ...
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_sUdRYwrOEeW4-_ONWXXiAw" parent="_sUcqQgrOEeW4-_ONWXXiAw" nodeId="PTU_DISH_ANTENNA_SYM_SYS_BASE_PLATE_CAD" url="platform:/plugin/org.eclipse.symphony.examples.antenna.symphony/vrml/Gimbal_Base_Plate_Scaled.wrl"/>
    </originNode>
  </topologyRoot>
    ...
    <featureRootsList xmi:id="_sUdRZQrOEeW4-_ONWXXiAw">
      <featureRoots xmi:id="_sUdRZgrOEeW4-_ONWXXiAw">
        <children xsi:type="ecore:TreeFeatureNode" xmi:id="_sUdRZwrOEeW4-_ONWXXiAw">
          <structuralFeature xsi:type="ecore_1:EAttribute" href="org.eclipse.symphony.examples.antenna#//PTUDishAntenna/panAngle"/>
        </children>
        <children xsi:type="ecore:TreeFeatureNode" xmi:id="_sUdRaArOEeW4-_ONWXXiAw">
          <structuralFeature xsi:type="ecore_1:EAttribute" href="org.eclipse.symphony.examples.antenna#//PTUDishAntenna/tiltAngle"/>
        </children>
        <sourceClass href="org.eclipse.symphony.examples.antenna#//PTUDishAntenna"/>
      </featureRoots>
    </featureRootsList>
