...
<core:SymphonySystem xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:bindings="ca.gc.space.mrt.sensors.fov.bindings" xmlns:ca.gc.space.mrt.sensors.fov="http:///ca/gc/space/mrt/sensors/fov/model/fov.ecore" xmlns:org.eclipse.symphony.common.topology="http:///ca/gc/space/topology.ecore" xmlns:core="org.eclipse.symphony.core" xmlns:ecore="ca.gc.asc_csa.eclipse.emf.ecore" xmlns:ecore_1="http://www.eclipse.org/emf/2002/Ecore" xmi:id="_0AJKoArOEeW4-_ONWXXiAw" name="CameraSymphonySystem">
  ...
  <topologyRoot xmi:id="_0AJKoQrOEeW4-_ONWXXiAw">
    <originNode xsi:type="org.eclipse.symphony.common.topology:AggregateGroupNode" xmi:id="_0AJKogrOEeW4-_ONWXXiAw" description="The root node of the Camera's topology" nodeId="CAMERA_SYM_SYS_ROOT">
      <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_0AJKowrOEeW4-_ONWXXiAw" parent="_0AJKogrOEeW4-_ONWXXiAw" description="The required transformation from the camera root to the body" nodeId="CAMERA_SYM_SYS_ROOT_TO_BODY">
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_0AJKpArOEeW4-_ONWXXiAw" parent="_0AJKowrOEeW4-_ONWXXiAw" description="The CAD of the camera's body" nodeId="CAMERA_SYM_SYS_CAMERA_CAD" url="platform:/plugin/org.eclipse.symphony.examples.camera.symphony/vrml/camera.wrl"/>
        <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:TransformNode" xmi:id="_0AJKpQrOEeW4-_ONWXXiAw" parent="_0AJKowrOEeW4-_ONWXXiAw" description="The required transformation from the camera body to its lens" nodeId="CAMERA_SYM_SYS_BODY_TO_LENS">
          <aggregatedChildren xsi:type="org.eclipse.symphony.common.topology:URLNode" xmi:id="_0AJKpgrOEeW4-_ONWXXiAw" parent="_0AJKpQrOEeW4-_ONWXXiAw" description="The CAD of the camera lens" nodeId="CAMERA_SYM_SYS_LENS_CAD" url="platform:/plugin/org.eclipse.symphony.examples.camera.symphony/vrml/lens.wrl"/>
