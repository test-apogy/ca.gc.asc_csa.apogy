 ...
 * @generated
 */
public class Symphony__ExamplesCameraSymphonySwitch<T> extends Switch<T>
{
  /**
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public Symphony__ExamplesCameraSymphonySwitch()
  {
  ...
  {
		switch (classifierID) {
			case Symphony__ExamplesCameraSymphonyPackage.CAMERA_SYMPHONY_SYSTEM_API_ADAPTER: {
			...
			case Symphony__ExamplesCameraSymphonyPackage.CAMERA_DATA: {
			...
			case Symphony__ExamplesCameraSymphonyPackage.PTU_CAMERA_SYMPHONY_SYSTEM_API_ADAPTER: {
			...
			case Symphony__ExamplesCameraSymphonyPackage.PTU_CAMERA_DATA: {
...
} //Symphony__ExamplesCameraSymphonySwitch
